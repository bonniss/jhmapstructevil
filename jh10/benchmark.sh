...
# Measure build time for 'no-dto'
no_dto_avg_time=$(measure_build_time "no-dto" "$RUNS")
echo "Average build time for 'no-dto': $no_dto_avg_time seconds"

# Measure build time for 'with-dto'
with_dto_avg_time=$(measure_build_time "with-dto" "$RUNS")
echo "Average build time for 'with-dto': $with_dto_avg_time seconds"
