...
/**
 * Criteria class for the {@link ai.realworld.domain.AlApple} entity. This class is used
 * in {@link ai.realworld.web.rest.AlAppleResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /al-apples?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlAppleCriteria implements Serializable, Criteria {
    ...
    public AlAppleCriteria() {}

    public AlAppleCriteria(AlAppleCriteria other) {
    ...
    @Override
    public AlAppleCriteria copy() {
        return new AlAppleCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final AlAppleCriteria that = (AlAppleCriteria) o;
        return (
