...
/**
 * Criteria class for the {@link ai.realworld.domain.AppZnsTemplate} entity. This class is used
 * in {@link ai.realworld.web.rest.AppZnsTemplateResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /app-zns-templates?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AppZnsTemplateCriteria implements Serializable, Criteria {
    ...
    private KnsIctionFilter znsAction;
    ...
    public AppZnsTemplateCriteria() {}

    public AppZnsTemplateCriteria(AppZnsTemplateCriteria other) {
        this.id = other.optionalId().map(LongFilter::copy).orElse(null);
        this.znsAction = other.optionalZnsAction().map(KnsIctionFilter::copy).orElse(null);
    ...
    @Override
    public AppZnsTemplateCriteria copy() {
        return new AppZnsTemplateCriteria(this);
    }
    ...
    public KnsIctionFilter getZnsAction() {
        return znsAction;
    }

    public Optional<KnsIctionFilter> optionalZnsAction() {
        return Optional.ofNullable(znsAction);
    }

    public KnsIctionFilter znsAction() {
        if (znsAction == null) {
            setZnsAction(new KnsIctionFilter());
        }
        return znsAction;
    }

    public void setZnsAction(KnsIctionFilter znsAction) {
    ...
    public boolean equals(Object o) {
        ...
        final AppZnsTemplateCriteria that = (AppZnsTemplateCriteria) o;
        return (
            Objects.equals(id, that.id) &&
            Objects.equals(znsAction, that.znsAction) &&
    ...
    public String toString() {
        return "AppZnsTemplateCriteria{" +
            optionalId().map(f -> "id=" + f + ", ").orElse("") +
            optionalZnsAction().map(f -> "znsAction=" + f + ", ").orElse("") +
