...
class AlLeandroResourceIT {
    ...
    void createAlLeandro() throws Exception {
        ...
        var returnedAlLeandro = om.readValue(
            restAlLeandroMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alLeandro)))
    ...
    void putExistingAlLeandro() throws Exception {
        ...
        restAlLeandroMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedAlLeandro.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedAlLeandro))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingAlLeandro() throws Exception {
        ...
        restAlLeandroMockMvc
            .perform(
                put(ENTITY_API_URL_ID, alLeandro.getId()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alLeandro))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithIdMismatchAlLeandro() throws Exception {
        ...
        restAlLeandroMockMvc
            .perform(
                put(ENTITY_API_URL_ID, UUID.randomUUID()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alLeandro))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamAlLeandro() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlLeandroMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alLeandro)))
    ...
    void patchNonExistingAlLeandro() throws Exception {
        ...
        restAlLeandroMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, alLeandro.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(alLeandro))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamAlLeandro() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlLeandroMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(alLeandro)))
            .andExpect(status().isMethodNotAllowed());
