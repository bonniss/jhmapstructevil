...
class OlAlmantinoMiloResourceIT {
    ...
    void createOlAlmantinoMilo() throws Exception {
        ...
        var returnedOlAlmantinoMilo = om.readValue(
            restOlAlmantinoMiloMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(olAlmantinoMilo)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            OlAlmantinoMilo.class
        );
    ...
    void putExistingOlAlmantinoMilo() throws Exception {
        ...
        restOlAlmantinoMiloMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedOlAlmantinoMilo.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedOlAlmantinoMilo))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingOlAlmantinoMilo() throws Exception {
        ...
        restOlAlmantinoMiloMockMvc
            .perform(
                put(ENTITY_API_URL_ID, olAlmantinoMilo.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(olAlmantinoMilo))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamOlAlmantinoMilo() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restOlAlmantinoMiloMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(olAlmantinoMilo)))
    ...
    void patchNonExistingOlAlmantinoMilo() throws Exception {
        ...
        restOlAlmantinoMiloMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, olAlmantinoMilo.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(olAlmantinoMilo))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamOlAlmantinoMilo() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restOlAlmantinoMiloMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(olAlmantinoMilo)))
            .andExpect(status().isMethodNotAllowed());
