...
class AlLadyGagaResourceIT {
    ...
    void createAlLadyGaga() throws Exception {
        ...
        var returnedAlLadyGaga = om.readValue(
            restAlLadyGagaMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alLadyGaga)))
    ...
    void putExistingAlLadyGaga() throws Exception {
        ...
        restAlLadyGagaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedAlLadyGaga.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedAlLadyGaga))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingAlLadyGaga() throws Exception {
        ...
        restAlLadyGagaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, alLadyGaga.getId()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alLadyGaga))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithIdMismatchAlLadyGaga() throws Exception {
        ...
        restAlLadyGagaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, UUID.randomUUID()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alLadyGaga))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamAlLadyGaga() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlLadyGagaMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alLadyGaga)))
    ...
    void patchNonExistingAlLadyGaga() throws Exception {
        ...
        restAlLadyGagaMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, alLadyGaga.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(alLadyGaga))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamAlLadyGaga() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlLadyGagaMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(alLadyGaga)))
            .andExpect(status().isMethodNotAllowed());
