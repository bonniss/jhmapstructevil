...
class AlAppleResourceIT {
    ...
    void createAlApple() throws Exception {
        ...
        // Create the AlApple
        var returnedAlApple = om.readValue(
            restAlAppleMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alApple)))
    ...
    void putExistingAlApple() throws Exception {
        ...
        restAlAppleMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedAlApple.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedAlApple))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingAlApple() throws Exception {
        ...
        restAlAppleMockMvc
            .perform(put(ENTITY_API_URL_ID, alApple.getId()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alApple)))
            .andExpect(status().isBadRequest());
    ...
    void putWithIdMismatchAlApple() throws Exception {
        ...
        restAlAppleMockMvc
            .perform(
                put(ENTITY_API_URL_ID, UUID.randomUUID()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alApple))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamAlApple() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlAppleMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alApple)))
    ...
    void patchNonExistingAlApple() throws Exception {
        ...
        restAlAppleMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, alApple.getId()).contentType("application/merge-patch+json").content(om.writeValueAsBytes(alApple))
            )
            .andExpect(status().isBadRequest());
        ...
        restAlAppleMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, UUID.randomUUID())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(alApple))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamAlApple() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlAppleMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(alApple)))
            .andExpect(status().isMethodNotAllowed());
