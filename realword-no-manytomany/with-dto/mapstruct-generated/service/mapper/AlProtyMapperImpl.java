...
public class AlProtyMapperImpl implements AlProtyMapper {
    ...
    @Override
    public AlProty toEntity(AlProtyDTO dto) {
        if ( dto == null ) {
            return null;
        }
        ...
        alProty.setId( dto.getId() );
        alProty.setName( dto.getName() );
        alProty.setDescriptionHeitiga( dto.getDescriptionHeitiga() );
        alProty.setCoordinate( dto.getCoordinate() );
        alProty.setCode( dto.getCode() );
        alProty.setStatus( dto.getStatus() );
        alProty.setIsEnabled( dto.getIsEnabled() );
        alProty.parent( toEntity( dto.getParent() ) );
        alProty.operator( alAppleDTOToAlApple( dto.getOperator() ) );
        alProty.propertyProfile( alProProDTOToAlProPro( dto.getPropertyProfile() ) );
        alProty.avatar( metaverseDTOToMetaverse( dto.getAvatar() ) );
        alProty.application( johnLennonDTOToJohnLennon( dto.getApplication() ) );
    ...
    public void partialUpdate(AlProty entity, AlProtyDTO dto) {
        ...
        if ( dto.getOperator() != null ) {
            ...
            alAppleDTOToAlApple1( dto.getOperator(), entity.getOperator() );
        }
