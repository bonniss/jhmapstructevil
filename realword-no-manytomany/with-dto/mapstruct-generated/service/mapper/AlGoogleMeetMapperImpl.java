...
@Generated(
    ...
    date = "2024-10-22T00:29:25+0700",
    comments = "version: 1.6.2, compiler: javac, environment: Java 17.0.11 (Eclipse Adoptium)"
)
@Component
public class AlGoogleMeetMapperImpl implements AlGoogleMeetMapper {

    @Override
    public AlGoogleMeet toEntity(AlGoogleMeetDTO dto) {
        if ( dto == null ) {
            return null;
        }

        AlGoogleMeet alGoogleMeet = new AlGoogleMeet();

        alGoogleMeet.setId( dto.getId() );
        alGoogleMeet.setTitle( dto.getTitle() );
        alGoogleMeet.setDescription( dto.getDescription() );
        alGoogleMeet.setNumberOfParticipants( dto.getNumberOfParticipants() );
        alGoogleMeet.setPlannedDate( dto.getPlannedDate() );
        alGoogleMeet.setPlannedDurationInMinutes( dto.getPlannedDurationInMinutes() );
        alGoogleMeet.setActualDate( dto.getActualDate() );
        alGoogleMeet.setActualDurationInMinutes( dto.getActualDurationInMinutes() );
        alGoogleMeet.setContentJason( dto.getContentJason() );
        alGoogleMeet.customer( alPacinoDTOToAlPacino( dto.getCustomer() ) );
        alGoogleMeet.agency( alAppleDTOToAlApple( dto.getAgency() ) );
        alGoogleMeet.personInCharge( edSheeranDTOToEdSheeran( dto.getPersonInCharge() ) );
        alGoogleMeet.application( johnLennonDTOToJohnLennon( dto.getApplication() ) );

        return alGoogleMeet;
    }

    @Override
    public List<AlGoogleMeet> toEntity(List<AlGoogleMeetDTO> dtoList) {
        if ( dtoList == null ) {
            return null;
        }

        List<AlGoogleMeet> list = new ArrayList<AlGoogleMeet>( dtoList.size() );
        for ( AlGoogleMeetDTO alGoogleMeetDTO : dtoList ) {
            list.add( toEntity( alGoogleMeetDTO ) );
        }
    ...
    @Override
    public List<AlGoogleMeetDTO> toDto(List<AlGoogleMeet> entityList) {
        if ( entityList == null ) {
            return null;
        }

        List<AlGoogleMeetDTO> list = new ArrayList<AlGoogleMeetDTO>( entityList.size() );
        for ( AlGoogleMeet alGoogleMeet : entityList ) {
            list.add( toDto( alGoogleMeet ) );
        }
    ...
    @Override
    public void partialUpdate(AlGoogleMeet entity, AlGoogleMeetDTO dto) {
        if ( dto == null ) {
            return;
        }
        ...
        if ( dto.getPlannedDurationInMinutes() != null ) {
            entity.setPlannedDurationInMinutes( dto.getPlannedDurationInMinutes() );
        }
        if ( dto.getActualDate() != null ) {
            entity.setActualDate( dto.getActualDate() );
        }
        if ( dto.getActualDurationInMinutes() != null ) {
            entity.setActualDurationInMinutes( dto.getActualDurationInMinutes() );
        }
        if ( dto.getContentJason() != null ) {
            entity.setContentJason( dto.getContentJason() );
        }
        if ( dto.getCustomer() != null ) {
            if ( entity.getCustomer() == null ) {
                entity.customer( new AlPacino() );
            }
            alPacinoDTOToAlPacino1( dto.getCustomer(), entity.getCustomer() );
        }
        ...
        if ( dto.getPersonInCharge() != null ) {
            ...
            edSheeranDTOToEdSheeran1( dto.getPersonInCharge(), entity.getPersonInCharge() );
        }
    ...
    @Override
    public AlGoogleMeetDTO toDto(AlGoogleMeet s) {
        if ( s == null ) {
            return null;
        }

        AlGoogleMeetDTO alGoogleMeetDTO = new AlGoogleMeetDTO();

        alGoogleMeetDTO.setCustomer( toDtoAlPacinoId( s.getCustomer() ) );
        alGoogleMeetDTO.setAgency( toDtoAlAppleId( s.getAgency() ) );
        alGoogleMeetDTO.setPersonInCharge( toDtoEdSheeranId( s.getPersonInCharge() ) );
        alGoogleMeetDTO.setApplication( toDtoJohnLennonId( s.getApplication() ) );
        alGoogleMeetDTO.setId( s.getId() );
        alGoogleMeetDTO.setTitle( s.getTitle() );
        alGoogleMeetDTO.setDescription( s.getDescription() );
        alGoogleMeetDTO.setNumberOfParticipants( s.getNumberOfParticipants() );
        alGoogleMeetDTO.setPlannedDate( s.getPlannedDate() );
        alGoogleMeetDTO.setPlannedDurationInMinutes( s.getPlannedDurationInMinutes() );
        alGoogleMeetDTO.setActualDate( s.getActualDate() );
        alGoogleMeetDTO.setActualDurationInMinutes( s.getActualDurationInMinutes() );
        alGoogleMeetDTO.setContentJason( s.getContentJason() );
