...
public class AlProProMapperImpl implements AlProProMapper {
    ...
    @Override
    public AlProPro toEntity(AlProProDTO dto) {
        if ( dto == null ) {
            return null;
        }
        ...
        alProPro.setId( dto.getId() );
        alProPro.setName( dto.getName() );
        alProPro.setDescriptionHeitiga( dto.getDescriptionHeitiga() );
        alProPro.setPropertyType( dto.getPropertyType() );
        alProPro.setAreaInSquareMeter( dto.getAreaInSquareMeter() );
        alProPro.setNumberOfAdults( dto.getNumberOfAdults() );
        alProPro.setNumberOfPreschoolers( dto.getNumberOfPreschoolers() );
        alProPro.setNumberOfChildren( dto.getNumberOfChildren() );
        alProPro.setNumberOfRooms( dto.getNumberOfRooms() );
        alProPro.setNumberOfFloors( dto.getNumberOfFloors() );
        alProPro.setBedSize( dto.getBedSize() );
        alProPro.setIsEnabled( dto.getIsEnabled() );
        alProPro.parent( toEntity( dto.getParent() ) );
        alProPro.project( alLadyGagaDTOToAlLadyGaga( dto.getProject() ) );
        alProPro.avatar( metaverseDTOToMetaverse( dto.getAvatar() ) );
        alProPro.application( johnLennonDTOToJohnLennon( dto.getApplication() ) );
    ...
    public void partialUpdate(AlProPro entity, AlProProDTO dto) {
        ...
        if ( dto.getProject() != null ) {
            ...
            alLadyGagaDTOToAlLadyGaga1( dto.getProject(), entity.getProject() );
        }
