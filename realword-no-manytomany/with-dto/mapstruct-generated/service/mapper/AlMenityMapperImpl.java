...
public class AlMenityMapperImpl implements AlMenityMapper {
    ...
    @Override
    public AlMenity toEntity(AlMenityDTO dto) {
        if ( dto == null ) {
            return null;
        }
        ...
        alMenity.setId( dto.getId() );
        alMenity.setName( dto.getName() );
        alMenity.setIconSvg( dto.getIconSvg() );
        alMenity.setPropertyType( dto.getPropertyType() );
        alMenity.application( johnLennonDTOToJohnLennon( dto.getApplication() ) );
