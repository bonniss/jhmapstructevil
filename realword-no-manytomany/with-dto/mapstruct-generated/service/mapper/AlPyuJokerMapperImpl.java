...
public class AlPyuJokerMapperImpl implements AlPyuJokerMapper {
    ...
    @Override
    public AlPyuJoker toEntity(AlPyuJokerDTO dto) {
        if ( dto == null ) {
            return null;
        }
        ...
        alPyuJoker.setId( dto.getId() );
        alPyuJoker.setBookingNo( dto.getBookingNo() );
        alPyuJoker.setNoteHeitiga( dto.getNoteHeitiga() );
        alPyuJoker.setPeriodType( dto.getPeriodType() );
        alPyuJoker.setFromDate( dto.getFromDate() );
        alPyuJoker.setToDate( dto.getToDate() );
        alPyuJoker.setCheckInDate( dto.getCheckInDate() );
        alPyuJoker.setCheckOutDate( dto.getCheckOutDate() );
        alPyuJoker.setNumberOfAdults( dto.getNumberOfAdults() );
        alPyuJoker.setNumberOfPreschoolers( dto.getNumberOfPreschoolers() );
        alPyuJoker.setNumberOfChildren( dto.getNumberOfChildren() );
        alPyuJoker.setBookingPrice( dto.getBookingPrice() );
        alPyuJoker.setExtraFee( dto.getExtraFee() );
        alPyuJoker.setTotalPrice( dto.getTotalPrice() );
        alPyuJoker.setBookingStatus( dto.getBookingStatus() );
        alPyuJoker.setHistoryRefJason( dto.getHistoryRefJason() );
        alPyuJoker.customer( alPacinoDTOToAlPacino( dto.getCustomer() ) );
        alPyuJoker.personInCharge( edSheeranDTOToEdSheeran( dto.getPersonInCharge() ) );
        alPyuJoker.application( johnLennonDTOToJohnLennon( dto.getApplication() ) );
