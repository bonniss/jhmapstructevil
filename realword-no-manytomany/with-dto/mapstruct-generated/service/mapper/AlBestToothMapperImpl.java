...
public class AlBestToothMapperImpl implements AlBestToothMapper {
    ...
    @Override
    public AlBestTooth toEntity(AlBestToothDTO dto) {
        if ( dto == null ) {
            return null;
        }
        ...
        alBestTooth.setId( dto.getId() );
        alBestTooth.setName( dto.getName() );
        alBestTooth.application( johnLennonDTOToJohnLennon( dto.getApplication() ) );
