...
@Component
public class RihannaMapperImpl implements RihannaMapper {

    @Override
    public Rihanna toEntity(RihannaDTO dto) {
        if ( dto == null ) {
            return null;
        }
        ...
        rihanna.setId( dto.getId() );
        rihanna.setName( dto.getName() );
        rihanna.setDescription( dto.getDescription() );
        rihanna.setPermissionGridJason( dto.getPermissionGridJason() );
        rihanna.application( johnLennonDTOToJohnLennon( dto.getApplication() ) );

        return rihanna;
    }

    @Override
    public List<Rihanna> toEntity(List<RihannaDTO> dtoList) {
        if ( dtoList == null ) {
            return null;
        }

        List<Rihanna> list = new ArrayList<Rihanna>( dtoList.size() );
        for ( RihannaDTO rihannaDTO : dtoList ) {
            list.add( toEntity( rihannaDTO ) );
        }
    ...
    @Override
    public List<RihannaDTO> toDto(List<Rihanna> entityList) {
        if ( entityList == null ) {
            return null;
        }

        List<RihannaDTO> list = new ArrayList<RihannaDTO>( entityList.size() );
        for ( Rihanna rihanna : entityList ) {
            list.add( toDto( rihanna ) );
        }
    ...
    @Override
    public void partialUpdate(Rihanna entity, RihannaDTO dto) {
        if ( dto == null ) {
            return;
        }
    ...
    @Override
    public RihannaDTO toDto(Rihanna s) {
        if ( s == null ) {
            return null;
        }
        ...
        rihannaDTO.setApplication( toDtoJohnLennonId( s.getApplication() ) );
        rihannaDTO.setId( s.getId() );
        rihannaDTO.setName( s.getName() );
        rihannaDTO.setDescription( s.getDescription() );
        rihannaDTO.setPermissionGridJason( s.getPermissionGridJason() );
