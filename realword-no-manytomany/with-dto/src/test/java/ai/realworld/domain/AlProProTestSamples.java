...
public class AlProProTestSamples {

    private static final Random random = new Random();
    private static final AtomicInteger intCount = new AtomicInteger(random.nextInt() + (2 * Short.MAX_VALUE));

    public static AlProPro getAlProProSample1() {
        return new AlProPro()
    ...
    public static AlProPro getAlProProSample2() {
        return new AlProPro()
    ...
    public static AlProPro getAlProProRandomSampleGenerator() {
        return new AlProPro()
            .id(UUID.randomUUID())
