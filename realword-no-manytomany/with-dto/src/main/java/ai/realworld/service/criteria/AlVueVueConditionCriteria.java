...
/**
 * Criteria class for the {@link ai.realworld.domain.AlVueVueCondition} entity. This class is used
 * in {@link ai.realworld.web.rest.AlVueVueConditionResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /al-vue-vue-conditions?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlVueVueConditionCriteria implements Serializable, Criteria {
    ...
    public AlVueVueConditionCriteria() {}

    public AlVueVueConditionCriteria(AlVueVueConditionCriteria other) {
    ...
    @Override
    public AlVueVueConditionCriteria copy() {
        return new AlVueVueConditionCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final AlVueVueConditionCriteria that = (AlVueVueConditionCriteria) o;
        return (
    ...
    public String toString() {
        return "AlVueVueConditionCriteria{" +
