...
/**
 * Criteria class for the {@link ai.realworld.domain.SicilyUmeto} entity. This class is used
 * in {@link ai.realworld.web.rest.SicilyUmetoResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /sicily-umetos?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class SicilyUmetoCriteria implements Serializable, Criteria {
    ...
    public SicilyUmetoCriteria() {}

    public SicilyUmetoCriteria(SicilyUmetoCriteria other) {
    ...
    @Override
    public SicilyUmetoCriteria copy() {
        return new SicilyUmetoCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final SicilyUmetoCriteria that = (SicilyUmetoCriteria) o;
        return (
