...
/**
 * A DTO for the {@link ai.realworld.domain.AlZorroTemptation} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlZorroTemptationDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AlZorroTemptationDTO)) {
            return false;
        }

        AlZorroTemptationDTO alZorroTemptationDTO = (AlZorroTemptationDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, alZorroTemptationDTO.id);
    }
