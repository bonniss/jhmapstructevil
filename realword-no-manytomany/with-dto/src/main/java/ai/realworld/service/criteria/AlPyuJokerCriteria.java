...
/**
 * Criteria class for the {@link ai.realworld.domain.AlPyuJoker} entity. This class is used
 * in {@link ai.realworld.web.rest.AlPyuJokerResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /al-pyu-jokers?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlPyuJokerCriteria implements Serializable, Criteria {
    ...
    public AlPyuJokerCriteria() {}

    public AlPyuJokerCriteria(AlPyuJokerCriteria other) {
    ...
    @Override
    public AlPyuJokerCriteria copy() {
        return new AlPyuJokerCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final AlPyuJokerCriteria that = (AlPyuJokerCriteria) o;
        return (
