...
class OrderViViTest {
    ...
    void tenantTest() {
        ...
        orderViVi.setTenant(masterTenantBack);
        assertThat(orderViVi.getTenant()).isEqualTo(masterTenantBack);

        orderViVi.tenant(null);
        assertThat(orderViVi.getTenant()).isNull();
    }
