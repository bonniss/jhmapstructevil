...
class PaymentViTest {
    ...
    @Test
    void tenantTest() {
        PaymentVi paymentVi = getPaymentViRandomSampleGenerator();
        MasterTenant masterTenantBack = getMasterTenantRandomSampleGenerator();

        paymentVi.setTenant(masterTenantBack);
        assertThat(paymentVi.getTenant()).isEqualTo(masterTenantBack);

        paymentVi.tenant(null);
        assertThat(paymentVi.getTenant()).isNull();
    }
}
