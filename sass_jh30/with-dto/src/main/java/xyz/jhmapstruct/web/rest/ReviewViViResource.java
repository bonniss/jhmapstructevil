...
public class ReviewViViResource {
    ...
    public ReviewViViResource(ReviewViViService reviewViViService, ReviewViViRepository reviewViViRepository) {
     ...
     */
    @GetMapping("")
    public List<ReviewViViDTO> getAllReviewViVis(
        @RequestParam(name = "eagerload", required = false, defaultValue = "true") boolean eagerload
    ) {
        LOG.debug("REST request to get all ReviewViVis");
        return reviewViViService.findAll();
    }
