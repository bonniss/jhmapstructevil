...
import static xyz.jhmapstruct.domain.PaymentAsserts.*;
...
class PaymentResourceIT {
    ...
    public static Payment createEntity() {
        return new Payment().amount(DEFAULT_AMOUNT).paymentDate(DEFAULT_PAYMENT_DATE).paymentMethod(DEFAULT_PAYMENT_METHOD);
    }
    ...
    public static Payment createUpdatedEntity() {
        return new Payment().amount(UPDATED_AMOUNT).paymentDate(UPDATED_PAYMENT_DATE).paymentMethod(UPDATED_PAYMENT_METHOD);
    }
    ...
    void putExistingPayment() throws Exception {
        ...
        updatedPayment.amount(UPDATED_AMOUNT).paymentDate(UPDATED_PAYMENT_DATE).paymentMethod(UPDATED_PAYMENT_METHOD);
    ...
    void fullUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.amount(UPDATED_AMOUNT).paymentDate(UPDATED_PAYMENT_DATE).paymentMethod(UPDATED_PAYMENT_METHOD);
