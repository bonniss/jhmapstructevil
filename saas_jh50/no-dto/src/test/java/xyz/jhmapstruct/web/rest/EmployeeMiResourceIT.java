...
class EmployeeMiResourceIT {
    ...
    void createEmployeeMi() throws Exception {
        ...
        var returnedEmployeeMi = om.readValue(
            restEmployeeMiMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(employeeMi)))
    ...
    void putExistingEmployeeMi() throws Exception {
        ...
        restEmployeeMiMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedEmployeeMi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedEmployeeMi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingEmployeeMi() throws Exception {
        ...
        restEmployeeMiMockMvc
            .perform(
                put(ENTITY_API_URL_ID, employeeMi.getId()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(employeeMi))
            )
            .andExpect(status().isBadRequest());
        ...
        restEmployeeMiMockMvc
            .perform(
                put(ENTITY_API_URL_ID, longCount.incrementAndGet())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(employeeMi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamEmployeeMi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restEmployeeMiMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(employeeMi)))
    ...
    void patchNonExistingEmployeeMi() throws Exception {
        ...
        restEmployeeMiMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, employeeMi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(employeeMi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamEmployeeMi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restEmployeeMiMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(employeeMi)))
            .andExpect(status().isMethodNotAllowed());
