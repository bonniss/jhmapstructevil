...
class InvoiceViTest {
    ...
    @Test
    void tenantTest() {
        InvoiceVi invoiceVi = getInvoiceViRandomSampleGenerator();
        MasterTenant masterTenantBack = getMasterTenantRandomSampleGenerator();

        invoiceVi.setTenant(masterTenantBack);
        assertThat(invoiceVi.getTenant()).isEqualTo(masterTenantBack);

        invoiceVi.tenant(null);
        assertThat(invoiceVi.getTenant()).isNull();
    }
}
