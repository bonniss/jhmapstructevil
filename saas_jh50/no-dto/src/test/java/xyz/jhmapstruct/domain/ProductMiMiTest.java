...
class ProductMiMiTest {
    ...
    void tenantTest() {
        ...
        productMiMi.setTenant(masterTenantBack);
        assertThat(productMiMi.getTenant()).isEqualTo(masterTenantBack);

        productMiMi.tenant(null);
        assertThat(productMiMi.getTenant()).isNull();
    }
