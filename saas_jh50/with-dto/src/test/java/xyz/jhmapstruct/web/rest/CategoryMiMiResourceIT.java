...
class CategoryMiMiResourceIT {
    ...
    void createCategoryMiMi() throws Exception {
        ...
        CategoryMiMiDTO categoryMiMiDTO = categoryMiMiMapper.toDto(categoryMiMi);
        var returnedCategoryMiMiDTO = om.readValue(
            restCategoryMiMiMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(categoryMiMiDTO)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            CategoryMiMiDTO.class
        );

        // Validate the CategoryMiMi in the database
        assertIncrementedRepositoryCount(databaseSizeBeforeCreate);
        var returnedCategoryMiMi = categoryMiMiMapper.toEntity(returnedCategoryMiMiDTO);
    ...
    void putExistingCategoryMiMi() throws Exception {
        ...
        CategoryMiMiDTO categoryMiMiDTO = categoryMiMiMapper.toDto(updatedCategoryMiMi);

        restCategoryMiMiMockMvc
            .perform(
                put(ENTITY_API_URL_ID, categoryMiMiDTO.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(categoryMiMiDTO))
            )
            .andExpect(status().isOk());
    ...
    void putWithMissingIdPathParamCategoryMiMi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restCategoryMiMiMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(categoryMiMiDTO)))
    ...
    void patchNonExistingCategoryMiMi() throws Exception {
        ...
        restCategoryMiMiMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, categoryMiMiDTO.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(categoryMiMiDTO))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamCategoryMiMi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restCategoryMiMiMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(categoryMiMiDTO)))
            .andExpect(status().isMethodNotAllowed());
