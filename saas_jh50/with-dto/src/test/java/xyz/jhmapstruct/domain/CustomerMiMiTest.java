...
class CustomerMiMiTest {
    ...
    void tenantTest() {
        ...
        customerMiMi.setTenant(masterTenantBack);
        assertThat(customerMiMi.getTenant()).isEqualTo(masterTenantBack);

        customerMiMi.tenant(null);
        assertThat(customerMiMi.getTenant()).isNull();
    }
}
