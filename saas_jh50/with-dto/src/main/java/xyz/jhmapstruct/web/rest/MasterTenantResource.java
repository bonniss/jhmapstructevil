...
public class MasterTenantResource {
    ...
    public MasterTenantResource(MasterTenantService masterTenantService, MasterTenantRepository masterTenantRepository) {
     ...
     */
    @GetMapping("")
    public List<MasterTenantDTO> getAllMasterTenants() {
        LOG.debug("REST request to get all MasterTenants");
        return masterTenantService.findAll();
    }
