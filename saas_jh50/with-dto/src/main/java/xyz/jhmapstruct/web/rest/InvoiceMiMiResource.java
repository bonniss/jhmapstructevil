...
public class InvoiceMiMiResource {
    ...
    public InvoiceMiMiResource(InvoiceMiMiService invoiceMiMiService, InvoiceMiMiRepository invoiceMiMiRepository) {
     ...
     */
    @GetMapping("")
    public List<InvoiceMiMiDTO> getAllInvoiceMiMis() {
        LOG.debug("REST request to get all InvoiceMiMis");
        return invoiceMiMiService.findAll();
    }
