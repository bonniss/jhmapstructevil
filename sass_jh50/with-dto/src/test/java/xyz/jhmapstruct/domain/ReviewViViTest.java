...
class ReviewViViTest {
    ...
    void tenantTest() {
        ...
        reviewViVi.setTenant(masterTenantBack);
        assertThat(reviewViVi.getTenant()).isEqualTo(masterTenantBack);

        reviewViVi.tenant(null);
        assertThat(reviewViVi.getTenant()).isNull();
    }
}
