...
class SupplierViTest {
    ...
    void tenantTest() {
        ...
        supplierVi.setTenant(masterTenantBack);
        assertThat(supplierVi.getTenant()).isEqualTo(masterTenantBack);

        supplierVi.tenant(null);
        assertThat(supplierVi.getTenant()).isNull();
    }
