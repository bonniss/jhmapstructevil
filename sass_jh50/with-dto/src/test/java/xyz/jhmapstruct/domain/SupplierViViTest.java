...
class SupplierViViTest {
    ...
    void tenantTest() {
        ...
        supplierViVi.setTenant(masterTenantBack);
        assertThat(supplierViVi.getTenant()).isEqualTo(masterTenantBack);

        supplierViVi.tenant(null);
        assertThat(supplierViVi.getTenant()).isNull();
    }
