...
class PaymentMiTest {
    ...
    @Test
    void tenantTest() {
        PaymentMi paymentMi = getPaymentMiRandomSampleGenerator();
        MasterTenant masterTenantBack = getMasterTenantRandomSampleGenerator();

        paymentMi.setTenant(masterTenantBack);
        assertThat(paymentMi.getTenant()).isEqualTo(masterTenantBack);

        paymentMi.tenant(null);
        assertThat(paymentMi.getTenant()).isNull();
    }
}
