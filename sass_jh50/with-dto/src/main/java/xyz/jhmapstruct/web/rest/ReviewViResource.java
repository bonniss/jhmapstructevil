...
public class ReviewViResource {
    ...
    public ReviewViResource(ReviewViService reviewViService, ReviewViRepository reviewViRepository) {
     ...
     */
    @GetMapping("")
    public List<ReviewViDTO> getAllReviewVis(@RequestParam(name = "eagerload", required = false, defaultValue = "true") boolean eagerload) {
        LOG.debug("REST request to get all ReviewVis");
        return reviewViService.findAll();
    }
