...
class ProductMiResourceIT {
    ...
    void createProductMi() throws Exception {
        ...
        var returnedProductMi = om.readValue(
            restProductMiMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(productMi)))
    ...
    void putExistingProductMi() throws Exception {
        ...
        restProductMiMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedProductMi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedProductMi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingProductMi() throws Exception {
        ...
        restProductMiMockMvc
            .perform(
                put(ENTITY_API_URL_ID, productMi.getId()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(productMi))
            )
            .andExpect(status().isBadRequest());
        ...
        restProductMiMockMvc
            .perform(
                put(ENTITY_API_URL_ID, longCount.incrementAndGet())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(productMi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamProductMi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restProductMiMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(productMi)))
    ...
    void patchNonExistingProductMi() throws Exception {
        ...
        restProductMiMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, productMi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(productMi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamProductMi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restProductMiMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(productMi)))
            .andExpect(status().isMethodNotAllowed());
