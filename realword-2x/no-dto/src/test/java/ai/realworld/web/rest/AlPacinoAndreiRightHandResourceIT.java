...
class AlPacinoAndreiRightHandResourceIT {
    ...
    void createAlPacinoAndreiRightHand() throws Exception {
        ...
        var returnedAlPacinoAndreiRightHand = om.readValue(
            restAlPacinoAndreiRightHandMockMvc
                .perform(
                    post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alPacinoAndreiRightHand))
                )
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            AlPacinoAndreiRightHand.class
        );
    ...
    void createAlPacinoAndreiRightHandWithExistingId() throws Exception {
        ...
        restAlPacinoAndreiRightHandMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alPacinoAndreiRightHand)))
    ...
    void putExistingAlPacinoAndreiRightHand() throws Exception {
        ...
        restAlPacinoAndreiRightHandMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedAlPacinoAndreiRightHand.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedAlPacinoAndreiRightHand))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingAlPacinoAndreiRightHand() throws Exception {
        ...
        restAlPacinoAndreiRightHandMockMvc
            .perform(
                put(ENTITY_API_URL_ID, alPacinoAndreiRightHand.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(alPacinoAndreiRightHand))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamAlPacinoAndreiRightHand() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlPacinoAndreiRightHandMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alPacinoAndreiRightHand)))
    ...
    void patchNonExistingAlPacinoAndreiRightHand() throws Exception {
        ...
        restAlPacinoAndreiRightHandMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, alPacinoAndreiRightHand.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(alPacinoAndreiRightHand))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamAlPacinoAndreiRightHand() throws Exception {
        ...
        restAlPacinoAndreiRightHandMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(alPacinoAndreiRightHand))
            )
            .andExpect(status().isMethodNotAllowed());
