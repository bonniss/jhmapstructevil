...
class AlGoogleMeetResourceIT {
    ...
    void createAlGoogleMeet() throws Exception {
        ...
        var returnedAlGoogleMeet = om.readValue(
            restAlGoogleMeetMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alGoogleMeet)))
    ...
    void putExistingAlGoogleMeet() throws Exception {
        ...
        restAlGoogleMeetMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedAlGoogleMeet.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedAlGoogleMeet))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingAlGoogleMeet() throws Exception {
        ...
        restAlGoogleMeetMockMvc
            .perform(
                put(ENTITY_API_URL_ID, alGoogleMeet.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(alGoogleMeet))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamAlGoogleMeet() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlGoogleMeetMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alGoogleMeet)))
    ...
    void patchNonExistingAlGoogleMeet() throws Exception {
        ...
        restAlGoogleMeetMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, alGoogleMeet.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(alGoogleMeet))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamAlGoogleMeet() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlGoogleMeetMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(alGoogleMeet)))
            .andExpect(status().isMethodNotAllowed());
