...
class AlLeandroPlayingTimeViResourceIT {
    ...
    void createAlLeandroPlayingTimeVi() throws Exception {
        ...
        var returnedAlLeandroPlayingTimeVi = om.readValue(
            restAlLeandroPlayingTimeViMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alLeandroPlayingTimeVi)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            AlLeandroPlayingTimeVi.class
        );
    ...
    void putExistingAlLeandroPlayingTimeVi() throws Exception {
        ...
        restAlLeandroPlayingTimeViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedAlLeandroPlayingTimeVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedAlLeandroPlayingTimeVi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingAlLeandroPlayingTimeVi() throws Exception {
        ...
        restAlLeandroPlayingTimeViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, alLeandroPlayingTimeVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(alLeandroPlayingTimeVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamAlLeandroPlayingTimeVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlLeandroPlayingTimeViMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alLeandroPlayingTimeVi)))
    ...
    void patchNonExistingAlLeandroPlayingTimeVi() throws Exception {
        ...
        restAlLeandroPlayingTimeViMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, alLeandroPlayingTimeVi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(alLeandroPlayingTimeVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamAlLeandroPlayingTimeVi() throws Exception {
        ...
        restAlLeandroPlayingTimeViMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(alLeandroPlayingTimeVi))
            )
            .andExpect(status().isMethodNotAllowed());
