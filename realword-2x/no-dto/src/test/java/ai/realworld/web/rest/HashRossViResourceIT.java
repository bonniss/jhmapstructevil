...
class HashRossViResourceIT {
    ...
    void createHashRossVi() throws Exception {
        ...
        var returnedHashRossVi = om.readValue(
            restHashRossViMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(hashRossVi)))
    ...
    void putExistingHashRossVi() throws Exception {
        ...
        restHashRossViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedHashRossVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedHashRossVi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingHashRossVi() throws Exception {
        ...
        restHashRossViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, hashRossVi.getId()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(hashRossVi))
            )
            .andExpect(status().isBadRequest());
        ...
        restHashRossViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, longCount.incrementAndGet())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(hashRossVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamHashRossVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restHashRossViMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(hashRossVi)))
    ...
    void patchNonExistingHashRossVi() throws Exception {
        ...
        restHashRossViMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, hashRossVi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(hashRossVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamHashRossVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restHashRossViMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(hashRossVi)))
            .andExpect(status().isMethodNotAllowed());
