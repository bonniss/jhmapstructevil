...
class PamelaLouisResourceIT {
    ...
    void createPamelaLouis() throws Exception {
        ...
        var returnedPamelaLouis = om.readValue(
            restPamelaLouisMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(pamelaLouis)))
    ...
    void putExistingPamelaLouis() throws Exception {
        ...
        restPamelaLouisMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedPamelaLouis.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedPamelaLouis))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingPamelaLouis() throws Exception {
        ...
        restPamelaLouisMockMvc
            .perform(
                put(ENTITY_API_URL_ID, pamelaLouis.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(pamelaLouis))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamPamelaLouis() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restPamelaLouisMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(pamelaLouis)))
    ...
    void patchNonExistingPamelaLouis() throws Exception {
        ...
        restPamelaLouisMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, pamelaLouis.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(pamelaLouis))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamPamelaLouis() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restPamelaLouisMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(pamelaLouis)))
            .andExpect(status().isMethodNotAllowed());
