...
class AlInquiryViResourceIT {
    ...
    void createAlInquiryVi() throws Exception {
        ...
        var returnedAlInquiryVi = om.readValue(
            restAlInquiryViMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alInquiryVi)))
    ...
    void putExistingAlInquiryVi() throws Exception {
        ...
        restAlInquiryViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedAlInquiryVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedAlInquiryVi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingAlInquiryVi() throws Exception {
        ...
        restAlInquiryViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, alInquiryVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(alInquiryVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithIdMismatchAlInquiryVi() throws Exception {
        ...
        restAlInquiryViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, UUID.randomUUID()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alInquiryVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamAlInquiryVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlInquiryViMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alInquiryVi)))
    ...
    void patchNonExistingAlInquiryVi() throws Exception {
        ...
        restAlInquiryViMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, alInquiryVi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(alInquiryVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamAlInquiryVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlInquiryViMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(alInquiryVi)))
            .andExpect(status().isMethodNotAllowed());
