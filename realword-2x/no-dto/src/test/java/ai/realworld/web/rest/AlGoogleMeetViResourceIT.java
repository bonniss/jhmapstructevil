...
class AlGoogleMeetViResourceIT {
    ...
    void createAlGoogleMeetVi() throws Exception {
        ...
        var returnedAlGoogleMeetVi = om.readValue(
            restAlGoogleMeetViMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alGoogleMeetVi)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            AlGoogleMeetVi.class
        );
    ...
    void putExistingAlGoogleMeetVi() throws Exception {
        ...
        restAlGoogleMeetViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedAlGoogleMeetVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedAlGoogleMeetVi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingAlGoogleMeetVi() throws Exception {
        ...
        restAlGoogleMeetViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, alGoogleMeetVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(alGoogleMeetVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamAlGoogleMeetVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlGoogleMeetViMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alGoogleMeetVi)))
    ...
    void patchNonExistingAlGoogleMeetVi() throws Exception {
        ...
        restAlGoogleMeetViMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, alGoogleMeetVi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(alGoogleMeetVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamAlGoogleMeetVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlGoogleMeetViMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(alGoogleMeetVi)))
            .andExpect(status().isMethodNotAllowed());
