...
class AlBestToothViResourceIT {
    ...
    void createAlBestToothVi() throws Exception {
        ...
        var returnedAlBestToothVi = om.readValue(
            restAlBestToothViMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alBestToothVi)))
    ...
    void putExistingAlBestToothVi() throws Exception {
        ...
        restAlBestToothViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedAlBestToothVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedAlBestToothVi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingAlBestToothVi() throws Exception {
        ...
        restAlBestToothViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, alBestToothVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(alBestToothVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamAlBestToothVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlBestToothViMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alBestToothVi)))
    ...
    void patchNonExistingAlBestToothVi() throws Exception {
        ...
        restAlBestToothViMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, alBestToothVi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(alBestToothVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamAlBestToothVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlBestToothViMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(alBestToothVi)))
            .andExpect(status().isMethodNotAllowed());
