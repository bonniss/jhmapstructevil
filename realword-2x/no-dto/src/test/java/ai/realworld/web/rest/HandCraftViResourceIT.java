...
class HandCraftViResourceIT {
    ...
    void createHandCraftVi() throws Exception {
        ...
        var returnedHandCraftVi = om.readValue(
            restHandCraftViMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(handCraftVi)))
    ...
    void putExistingHandCraftVi() throws Exception {
        ...
        restHandCraftViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedHandCraftVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedHandCraftVi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingHandCraftVi() throws Exception {
        ...
        restHandCraftViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, handCraftVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(handCraftVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamHandCraftVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restHandCraftViMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(handCraftVi)))
    ...
    void patchNonExistingHandCraftVi() throws Exception {
        ...
        restHandCraftViMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, handCraftVi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(handCraftVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamHandCraftVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restHandCraftViMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(handCraftVi)))
            .andExpect(status().isMethodNotAllowed());
