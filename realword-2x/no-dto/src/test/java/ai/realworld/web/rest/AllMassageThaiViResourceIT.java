...
class AllMassageThaiViResourceIT {
    ...
    void createAllMassageThaiVi() throws Exception {
        ...
        var returnedAllMassageThaiVi = om.readValue(
            restAllMassageThaiViMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(allMassageThaiVi)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            AllMassageThaiVi.class
        );
    ...
    void putExistingAllMassageThaiVi() throws Exception {
        ...
        restAllMassageThaiViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedAllMassageThaiVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedAllMassageThaiVi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingAllMassageThaiVi() throws Exception {
        ...
        restAllMassageThaiViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, allMassageThaiVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(allMassageThaiVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamAllMassageThaiVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAllMassageThaiViMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(allMassageThaiVi)))
    ...
    void patchNonExistingAllMassageThaiVi() throws Exception {
        ...
        restAllMassageThaiViMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, allMassageThaiVi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(allMassageThaiVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamAllMassageThaiVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAllMassageThaiViMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(allMassageThaiVi)))
            .andExpect(status().isMethodNotAllowed());
