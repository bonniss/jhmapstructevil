...
class AntonioBanderasViResourceIT {
    ...
    void createAntonioBanderasVi() throws Exception {
        ...
        var returnedAntonioBanderasVi = om.readValue(
            restAntonioBanderasViMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(antonioBanderasVi)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            AntonioBanderasVi.class
        );
    ...
    void putExistingAntonioBanderasVi() throws Exception {
        ...
        restAntonioBanderasViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedAntonioBanderasVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedAntonioBanderasVi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingAntonioBanderasVi() throws Exception {
        ...
        restAntonioBanderasViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, antonioBanderasVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(antonioBanderasVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamAntonioBanderasVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAntonioBanderasViMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(antonioBanderasVi)))
    ...
    void patchNonExistingAntonioBanderasVi() throws Exception {
        ...
        restAntonioBanderasViMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, antonioBanderasVi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(antonioBanderasVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamAntonioBanderasVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAntonioBanderasViMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(antonioBanderasVi)))
            .andExpect(status().isMethodNotAllowed());
