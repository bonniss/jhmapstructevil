...
class RihannaViResourceIT {
    ...
    void createRihannaVi() throws Exception {
        ...
        var returnedRihannaVi = om.readValue(
            restRihannaViMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(rihannaVi)))
    ...
    void putExistingRihannaVi() throws Exception {
        ...
        restRihannaViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedRihannaVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedRihannaVi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingRihannaVi() throws Exception {
        ...
        restRihannaViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, rihannaVi.getId()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(rihannaVi))
            )
            .andExpect(status().isBadRequest());
        ...
        restRihannaViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, longCount.incrementAndGet())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(rihannaVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamRihannaVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restRihannaViMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(rihannaVi)))
    ...
    void patchNonExistingRihannaVi() throws Exception {
        ...
        restRihannaViMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, rihannaVi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(rihannaVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamRihannaVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restRihannaViMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(rihannaVi)))
            .andExpect(status().isMethodNotAllowed());
