...
public class MetaverseAsserts {
    ...
    public static void assertMetaverseUpdatableRelationshipsEquals(Metaverse expected, Metaverse actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getAlProProVis()).as("check alProProVis").isEqualTo(actual.getAlProProVis()))
            .satisfies(e -> assertThat(e.getAlProtyVis()).as("check alProtyVis").isEqualTo(actual.getAlProtyVis()));
    }
}
