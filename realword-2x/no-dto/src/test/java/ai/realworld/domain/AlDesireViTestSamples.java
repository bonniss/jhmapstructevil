...
public class AlDesireViTestSamples {

    private static final Random random = new Random();
    private static final AtomicInteger intCount = new AtomicInteger(random.nextInt() + (2 * Short.MAX_VALUE));

    public static AlDesireVi getAlDesireViSample1() {
    ...
    public static AlDesireVi getAlDesireViSample2() {
        return new AlDesireVi()
    ...
    public static AlDesireVi getAlDesireViRandomSampleGenerator() {
        return new AlDesireVi()
            .id(UUID.randomUUID())
