...
class AlPyuJokerViTest {
    ...
    void propertyTest() {
        ...
        alPyuJokerVi.addProperty(alProtyViBack);
        assertThat(alPyuJokerVi.getProperties()).containsOnly(alProtyViBack);

        alPyuJokerVi.removeProperty(alProtyViBack);
        assertThat(alPyuJokerVi.getProperties()).doesNotContain(alProtyViBack);

        alPyuJokerVi.properties(new HashSet<>(Set.of(alProtyViBack)));
        assertThat(alPyuJokerVi.getProperties()).containsOnly(alProtyViBack);

        alPyuJokerVi.setProperties(new HashSet<>());
        assertThat(alPyuJokerVi.getProperties()).doesNotContain(alProtyViBack);
    }
}
