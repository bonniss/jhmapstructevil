...
class MetaverseCriteriaTest {
    ...
    private static void setAllFilters(MetaverseCriteria metaverseCriteria) {
        ...
        metaverseCriteria.alProProId();
        metaverseCriteria.alProtyId();
        metaverseCriteria.alProProViId();
        metaverseCriteria.alProtyViId();
    ...
    private static Condition<MetaverseCriteria> criteriaFiltersAre(Function<Object, Boolean> condition) {
        return new Condition<>(
            criteria ->
                ...
                condition.apply(criteria.getAlProProId()) &&
                condition.apply(criteria.getAlProtyId()) &&
                condition.apply(criteria.getAlProProViId()) &&
                condition.apply(criteria.getAlProtyViId()) &&
    ...
    private static Condition<MetaverseCriteria> copyFiltersAre(MetaverseCriteria copy, BiFunction<Object, Object, Boolean> condition) {
        return new Condition<>(
            criteria ->
                ...
                condition.apply(criteria.getAlProProId(), copy.getAlProProId()) &&
                condition.apply(criteria.getAlProtyId(), copy.getAlProtyId()) &&
                condition.apply(criteria.getAlProProViId(), copy.getAlProProViId()) &&
                condition.apply(criteria.getAlProtyViId(), copy.getAlProtyViId()) &&
