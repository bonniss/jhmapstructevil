...
public class AlProtyVi implements Serializable {
    ...
    @JoinTable(
        name = "rel_al_proty_vi__image",
        joinColumns = @JoinColumn(name = "al_proty_vi_id"),
    ...
    private Set<AlPyuJokerVi> bookings = new HashSet<>();
    ...
    public AlProtyVi images(Set<Metaverse> metaverses) {
        this.setImages(metaverses);
        return this;
    }

    public AlProtyVi addImage(Metaverse metaverse) {
        this.images.add(metaverse);
        return this;
    }

    public AlProtyVi removeImage(Metaverse metaverse) {
    ...
    public Set<AlPyuJokerVi> getBookings() {
        return this.bookings;
    }

    public void setBookings(Set<AlPyuJokerVi> alPyuJokerVis) {
        if (this.bookings != null) {
            this.bookings.forEach(i -> i.removeProperty(this));
        }
        if (alPyuJokerVis != null) {
            alPyuJokerVis.forEach(i -> i.addProperty(this));
        }
        this.bookings = alPyuJokerVis;
    }

    public AlProtyVi bookings(Set<AlPyuJokerVi> alPyuJokerVis) {
        this.setBookings(alPyuJokerVis);
        return this;
    }

    public AlProtyVi addBooking(AlPyuJokerVi alPyuJokerVi) {
        this.bookings.add(alPyuJokerVi);
        alPyuJokerVi.getProperties().add(this);
        return this;
    }

    public AlProtyVi removeBooking(AlPyuJokerVi alPyuJokerVi) {
        this.bookings.remove(alPyuJokerVi);
        alPyuJokerVi.getProperties().remove(this);
        return this;
    }
