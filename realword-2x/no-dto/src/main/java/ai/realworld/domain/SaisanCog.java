 ...
 */
@Entity
@Table(name = "saisan_cog")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("common-java:DuplicatedBlocks")
public class SaisanCog implements Serializable {
    ...
    public SaisanCog key(String key) {
        this.setKey(key);
        return this;
    }
    ...
    public SaisanCog valueJason(String valueJason) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SaisanCog)) {
            return false;
        }
        return getId() != null && getId().equals(((SaisanCog) o).getId());
    }
