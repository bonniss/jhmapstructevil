...
public class AlPyuJokerVi implements Serializable {
    ...
    @JoinTable(
        name = "rel_al_pyu_joker_vi__property",
        joinColumns = @JoinColumn(name = "al_pyu_joker_vi_id"),
    ...
    private Set<AlProtyVi> properties = new HashSet<>();
    ...
    public Set<AlProtyVi> getProperties() {
        return this.properties;
    }

    public void setProperties(Set<AlProtyVi> alProtyVis) {
        this.properties = alProtyVis;
    }

    public AlPyuJokerVi properties(Set<AlProtyVi> alProtyVis) {
        this.setProperties(alProtyVis);
        return this;
    }

    public AlPyuJokerVi addProperty(AlProtyVi alProtyVi) {
        this.properties.add(alProtyVi);
        return this;
    }

    public AlPyuJokerVi removeProperty(AlProtyVi alProtyVi) {
        this.properties.remove(alProtyVi);
        return this;
    }
