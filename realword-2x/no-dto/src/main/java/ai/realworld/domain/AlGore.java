...
public class AlGore implements Serializable {
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JsonIgnoreProperties(value = { "supplier", "customer", "application", "discounts" }, allowSetters = true)
    private AlBetonamuRelationVi bizRelationVi;
    ...
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    @JsonIgnoreProperties(value = { "parent", "application" }, allowSetters = true)
    private Set<AlGoreConditionVi> conditionVis = new HashSet<>();
    ...
    public AlBetonamuRelationVi getBizRelationVi() {
        return this.bizRelationVi;
    }

    public void setBizRelationVi(AlBetonamuRelationVi alBetonamuRelationVi) {
        this.bizRelationVi = alBetonamuRelationVi;
    }

    public AlGore bizRelationVi(AlBetonamuRelationVi alBetonamuRelationVi) {
        this.setBizRelationVi(alBetonamuRelationVi);
        return this;
    }
    ...
    public Set<AlGoreConditionVi> getConditionVis() {
        return this.conditionVis;
    }

    public void setConditionVis(Set<AlGoreConditionVi> alGoreConditionVis) {
        if (this.conditionVis != null) {
            this.conditionVis.forEach(i -> i.setParent(null));
        }
        if (alGoreConditionVis != null) {
            alGoreConditionVis.forEach(i -> i.setParent(this));
        }
        this.conditionVis = alGoreConditionVis;
    }

    public AlGore conditionVis(Set<AlGoreConditionVi> alGoreConditionVis) {
        this.setConditionVis(alGoreConditionVis);
        return this;
    }

    public AlGore addConditionVis(AlGoreConditionVi alGoreConditionVi) {
        this.conditionVis.add(alGoreConditionVi);
        alGoreConditionVi.setParent(this);
        return this;
    }

    public AlGore removeConditionVis(AlGoreConditionVi alGoreConditionVi) {
        this.conditionVis.remove(alGoreConditionVi);
        alGoreConditionVi.setParent(null);
        return this;
    }
