 ...
 */
@Entity
@Table(name = "al_actiso_vi")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlActisoVi implements Serializable {
    ...
    public AlActisoVi key(String key) {
        this.setKey(key);
        return this;
    }
    ...
    public AlActisoVi valueJason(String valueJason) {
    ...
    public AlActisoVi application(JohnLennon johnLennon) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AlActisoVi)) {
            return false;
        }
        return getId() != null && getId().equals(((AlActisoVi) o).getId());
    }
