...
/**
 * Criteria class for the {@link ai.realworld.domain.AlPyuDjibril} entity. This class is used
 * in {@link ai.realworld.web.rest.AlPyuDjibrilResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /al-pyu-djibrils?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlPyuDjibrilCriteria implements Serializable, Criteria {
    ...
    public AlPyuDjibrilCriteria() {}

    public AlPyuDjibrilCriteria(AlPyuDjibrilCriteria other) {
    ...
    @Override
    public AlPyuDjibrilCriteria copy() {
        return new AlPyuDjibrilCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final AlPyuDjibrilCriteria that = (AlPyuDjibrilCriteria) o;
        return (
