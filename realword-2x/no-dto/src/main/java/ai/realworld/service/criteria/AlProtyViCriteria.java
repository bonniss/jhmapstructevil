...
/**
 * Criteria class for the {@link ai.realworld.domain.AlProtyVi} entity. This class is used
 * in {@link ai.realworld.web.rest.AlProtyViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /al-proty-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlProtyViCriteria implements Serializable, Criteria {
    ...
    public AlProtyViCriteria() {}

    public AlProtyViCriteria(AlProtyViCriteria other) {
    ...
    @Override
    public AlProtyViCriteria copy() {
        return new AlProtyViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final AlProtyViCriteria that = (AlProtyViCriteria) o;
        return (
