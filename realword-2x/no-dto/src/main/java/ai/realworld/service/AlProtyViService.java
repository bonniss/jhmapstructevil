...
public class AlProtyViService {
     ...
     */
    public Page<AlProtyVi> findAllWithEagerRelationships(Pageable pageable) {
        return alProtyViRepository.findAllWithEagerRelationships(pageable);
    }
    ...
    public Optional<AlProtyVi> findOne(UUID id) {
        ...
        return alProtyViRepository.findOneWithEagerRelationships(id);
    }
