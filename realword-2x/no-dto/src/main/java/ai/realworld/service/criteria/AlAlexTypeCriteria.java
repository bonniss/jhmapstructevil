...
/**
 * Criteria class for the {@link ai.realworld.domain.AlAlexType} entity. This class is used
 * in {@link ai.realworld.web.rest.AlAlexTypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /al-alex-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlAlexTypeCriteria implements Serializable, Criteria {
    ...
    public AlAlexTypeCriteria() {}

    public AlAlexTypeCriteria(AlAlexTypeCriteria other) {
    ...
    @Override
    public AlAlexTypeCriteria copy() {
        return new AlAlexTypeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final AlAlexTypeCriteria that = (AlAlexTypeCriteria) o;
        return (
