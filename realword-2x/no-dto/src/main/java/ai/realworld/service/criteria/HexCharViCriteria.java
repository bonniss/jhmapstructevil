...
/**
 * Criteria class for the {@link ai.realworld.domain.HexCharVi} entity. This class is used
 * in {@link ai.realworld.web.rest.HexCharViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /hex-char-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class HexCharViCriteria implements Serializable, Criteria {
    ...
    public HexCharViCriteria() {}

    public HexCharViCriteria(HexCharViCriteria other) {
    ...
    @Override
    public HexCharViCriteria copy() {
        return new HexCharViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final HexCharViCriteria that = (HexCharViCriteria) o;
        return (
