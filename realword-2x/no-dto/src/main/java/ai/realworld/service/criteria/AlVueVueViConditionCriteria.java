...
/**
 * Criteria class for the {@link ai.realworld.domain.AlVueVueViCondition} entity. This class is used
 * in {@link ai.realworld.web.rest.AlVueVueViConditionResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /al-vue-vue-vi-conditions?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlVueVueViConditionCriteria implements Serializable, Criteria {
    ...
    public AlVueVueViConditionCriteria() {}

    public AlVueVueViConditionCriteria(AlVueVueViConditionCriteria other) {
    ...
    @Override
    public AlVueVueViConditionCriteria copy() {
        return new AlVueVueViConditionCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final AlVueVueViConditionCriteria that = (AlVueVueViConditionCriteria) o;
        return (
    ...
    public String toString() {
        return "AlVueVueViConditionCriteria{" +
