...
public class AlProProViService {
     ...
     */
    public Page<AlProProVi> findAllWithEagerRelationships(Pageable pageable) {
        return alProProViRepository.findAllWithEagerRelationships(pageable);
    }
    ...
    public Optional<AlProProVi> findOne(UUID id) {
        ...
        return alProProViRepository.findOneWithEagerRelationships(id);
    }
