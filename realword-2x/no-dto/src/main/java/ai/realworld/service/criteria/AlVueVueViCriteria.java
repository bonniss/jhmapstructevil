...
/**
 * Criteria class for the {@link ai.realworld.domain.AlVueVueVi} entity. This class is used
 * in {@link ai.realworld.web.rest.AlVueVueViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /al-vue-vue-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlVueVueViCriteria implements Serializable, Criteria {
    ...
    public AlVueVueViCriteria() {}

    public AlVueVueViCriteria(AlVueVueViCriteria other) {
    ...
    @Override
    public AlVueVueViCriteria copy() {
        return new AlVueVueViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final AlVueVueViCriteria that = (AlVueVueViCriteria) o;
        return (
