 ...
 */
@Entity
@Table(name = "pamela_louis_vi")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("common-java:DuplicatedBlocks")
public class PamelaLouisVi implements Serializable {
    ...
    public PamelaLouisVi id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public PamelaLouisVi name(String name) {
        this.setName(name);
        return this;
    }
    ...
    public PamelaLouisVi configJason(String configJason) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PamelaLouisVi)) {
            return false;
        }
        return getId() != null && getId().equals(((PamelaLouisVi) o).getId());
    }
