...
public class AlProPro implements Serializable {
    ...
    @JoinTable(
        name = "rel_al_pro_pro__amenity",
        joinColumns = @JoinColumn(name = "al_pro_pro_id"),
        inverseJoinColumns = @JoinColumn(name = "amenity_id")
    )
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    @JsonIgnoreProperties(value = { "application", "propertyProfiles" }, allowSetters = true)
    private Set<AlMenity> amenities = new HashSet<>();

    @ManyToMany(fetch = FetchType.LAZY)
    @JoinTable(
        name = "rel_al_pro_pro__image",
        joinColumns = @JoinColumn(name = "al_pro_pro_id"),
    ...
    public Set<AlMenity> getAmenities() {
        return this.amenities;
    }

    public void setAmenities(Set<AlMenity> alMenities) {
        this.amenities = alMenities;
    }

    public AlProPro amenities(Set<AlMenity> alMenities) {
        this.setAmenities(alMenities);
        return this;
    }

    public AlProPro addAmenity(AlMenity alMenity) {
        this.amenities.add(alMenity);
        return this;
    }

    public AlProPro removeAmenity(AlMenity alMenity) {
        this.amenities.remove(alMenity);
        return this;
    }
    ...
    public AlProPro images(Set<Metaverse> metaverses) {
        this.setImages(metaverses);
        return this;
    }

    public AlProPro addImage(Metaverse metaverse) {
        this.images.add(metaverse);
        return this;
    }

    public AlProPro removeImage(Metaverse metaverse) {
