...
public class AlMenity implements Serializable {
    ...
    private Set<AlProPro> propertyProfiles = new HashSet<>();
    ...
    public Set<AlProPro> getPropertyProfiles() {
        return this.propertyProfiles;
    }

    public void setPropertyProfiles(Set<AlProPro> alProPros) {
        if (this.propertyProfiles != null) {
            this.propertyProfiles.forEach(i -> i.removeAmenity(this));
        }
        if (alProPros != null) {
            alProPros.forEach(i -> i.addAmenity(this));
        }
        this.propertyProfiles = alProPros;
    }

    public AlMenity propertyProfiles(Set<AlProPro> alProPros) {
        this.setPropertyProfiles(alProPros);
        return this;
    }

    public AlMenity addPropertyProfile(AlProPro alProPro) {
        this.propertyProfiles.add(alProPro);
        alProPro.getAmenities().add(this);
        return this;
    }

    public AlMenity removePropertyProfile(AlProPro alProPro) {
        this.propertyProfiles.remove(alProPro);
        alProPro.getAmenities().remove(this);
        return this;
    }
