...
public class AlProProVi implements Serializable {
    ...
    @JoinTable(
        name = "rel_al_pro_pro_vi__amenity",
        joinColumns = @JoinColumn(name = "al_pro_pro_vi_id"),
        inverseJoinColumns = @JoinColumn(name = "amenity_id")
    )
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    @JsonIgnoreProperties(value = { "application", "propertyProfiles" }, allowSetters = true)
    private Set<AlMenityVi> amenities = new HashSet<>();

    @ManyToMany(fetch = FetchType.LAZY)
    @JoinTable(
        name = "rel_al_pro_pro_vi__image",
        joinColumns = @JoinColumn(name = "al_pro_pro_vi_id"),
    ...
    public Set<AlMenityVi> getAmenities() {
        return this.amenities;
    }

    public void setAmenities(Set<AlMenityVi> alMenityVis) {
        this.amenities = alMenityVis;
    }

    public AlProProVi amenities(Set<AlMenityVi> alMenityVis) {
        this.setAmenities(alMenityVis);
        return this;
    }

    public AlProProVi addAmenity(AlMenityVi alMenityVi) {
        this.amenities.add(alMenityVi);
        return this;
    }

    public AlProProVi removeAmenity(AlMenityVi alMenityVi) {
        this.amenities.remove(alMenityVi);
        return this;
    }
    ...
    public AlProProVi images(Set<Metaverse> metaverses) {
        this.setImages(metaverses);
        return this;
    }

    public AlProProVi addImage(Metaverse metaverse) {
        this.images.add(metaverse);
        return this;
    }

    public AlProProVi removeImage(Metaverse metaverse) {
