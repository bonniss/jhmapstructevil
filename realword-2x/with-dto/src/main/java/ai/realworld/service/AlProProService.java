...
public class AlProProService {
    ...
    /**
     * Get all the alProPros with eager load of many-to-many relationships.
     *
     * @return the list of entities.
     */
    public Page<AlProProDTO> findAllWithEagerRelationships(Pageable pageable) {
        return alProProRepository.findAllWithEagerRelationships(pageable).map(alProProMapper::toDto);
    }
    ...
    public Optional<AlProProDTO> findOne(UUID id) {
        ...
        return alProProRepository.findOneWithEagerRelationships(id).map(alProProMapper::toDto);
    }
