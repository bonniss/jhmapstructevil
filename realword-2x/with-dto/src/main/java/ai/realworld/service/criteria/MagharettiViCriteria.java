...
/**
 * Criteria class for the {@link ai.realworld.domain.MagharettiVi} entity. This class is used
 * in {@link ai.realworld.web.rest.MagharettiViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /magharetti-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class MagharettiViCriteria implements Serializable, Criteria {
    ...
    public MagharettiViCriteria() {}

    public MagharettiViCriteria(MagharettiViCriteria other) {
    ...
    @Override
    public MagharettiViCriteria copy() {
        return new MagharettiViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MagharettiViCriteria that = (MagharettiViCriteria) o;
        return (
