...
public class MetaverseDTO implements Serializable {
    ...
    private Set<AlProProDTO> alProPros = new HashSet<>();

    private Set<AlProtyDTO> alProties = new HashSet<>();

    private Set<AlProProViDTO> alProProVis = new HashSet<>();

    private Set<AlProtyViDTO> alProtyVis = new HashSet<>();
    ...
    public Set<AlProProDTO> getAlProPros() {
        return alProPros;
    }

    public void setAlProPros(Set<AlProProDTO> alProPros) {
        this.alProPros = alProPros;
    }

    public Set<AlProtyDTO> getAlProties() {
        return alProties;
    }

    public void setAlProties(Set<AlProtyDTO> alProties) {
        this.alProties = alProties;
    }

    public Set<AlProProViDTO> getAlProProVis() {
        return alProProVis;
    }

    public void setAlProProVis(Set<AlProProViDTO> alProProVis) {
        this.alProProVis = alProProVis;
    }

    public Set<AlProtyViDTO> getAlProtyVis() {
        return alProtyVis;
    }

    public void setAlProtyVis(Set<AlProtyViDTO> alProtyVis) {
    ...
    public String toString() {
        return "MetaverseDTO{" +
            ...
            ", alProPros=" + getAlProPros() +
            ", alProties=" + getAlProties() +
            ", alProProVis=" + getAlProProVis() +
            ", alProtyVis=" + getAlProtyVis() +
            "}";
    }
}
