...
/**
 * Criteria class for the {@link ai.realworld.domain.AlInquiryVi} entity. This class is used
 * in {@link ai.realworld.web.rest.AlInquiryViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /al-inquiry-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlInquiryViCriteria implements Serializable, Criteria {
    ...
    public AlInquiryViCriteria() {}

    public AlInquiryViCriteria(AlInquiryViCriteria other) {
    ...
    @Override
    public AlInquiryViCriteria copy() {
        return new AlInquiryViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final AlInquiryViCriteria that = (AlInquiryViCriteria) o;
        return (
