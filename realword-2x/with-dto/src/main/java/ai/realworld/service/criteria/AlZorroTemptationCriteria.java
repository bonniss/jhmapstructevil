...
/**
 * Criteria class for the {@link ai.realworld.domain.AlZorroTemptation} entity. This class is used
 * in {@link ai.realworld.web.rest.AlZorroTemptationResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /al-zorro-temptations?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlZorroTemptationCriteria implements Serializable, Criteria {
    ...
    public AlZorroTemptationCriteria() {}

    public AlZorroTemptationCriteria(AlZorroTemptationCriteria other) {
    ...
    @Override
    public AlZorroTemptationCriteria copy() {
        return new AlZorroTemptationCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final AlZorroTemptationCriteria that = (AlZorroTemptationCriteria) o;
        return (
    ...
    public String toString() {
        return "AlZorroTemptationCriteria{" +
