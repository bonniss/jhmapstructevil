...
/**
 * Criteria class for the {@link ai.realworld.domain.AlMenityVi} entity. This class is used
 * in {@link ai.realworld.web.rest.AlMenityViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /al-menity-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlMenityViCriteria implements Serializable, Criteria {
    ...
    public AlMenityViCriteria() {}

    public AlMenityViCriteria(AlMenityViCriteria other) {
    ...
    @Override
    public AlMenityViCriteria copy() {
        return new AlMenityViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final AlMenityViCriteria that = (AlMenityViCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, iconSvg, propertyType, applicationId, propertyProfileId, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "AlMenityViCriteria{" +
