...
/**
 * A DTO for the {@link ai.realworld.domain.AlLeandroPlayingTimeVi} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlLeandroPlayingTimeViDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AlLeandroPlayingTimeViDTO)) {
            return false;
        }

        AlLeandroPlayingTimeViDTO alLeandroPlayingTimeViDTO = (AlLeandroPlayingTimeViDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, alLeandroPlayingTimeViDTO.id);
    }
    ...
    public String toString() {
        return "AlLeandroPlayingTimeViDTO{" +
            "id='" + getId() + "'" +
            ", status='" + getStatus() + "'" +
            ", wonDate='" + getWonDate() + "'" +
