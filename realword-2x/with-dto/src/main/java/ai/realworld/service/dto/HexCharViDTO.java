...
/**
 * A DTO for the {@link ai.realworld.domain.HexCharVi} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class HexCharViDTO implements Serializable {
    ...
    public HashRossViDTO getRole() {
        return role;
    }

    public void setRole(HashRossViDTO role) {
        this.role = role;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HexCharViDTO)) {
            return false;
        }

        HexCharViDTO hexCharViDTO = (HexCharViDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, hexCharViDTO.id);
    }
