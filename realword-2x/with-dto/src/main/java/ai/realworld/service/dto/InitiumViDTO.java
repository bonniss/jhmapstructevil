...
/**
 * A DTO for the {@link ai.realworld.domain.InitiumVi} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class InitiumViDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InitiumViDTO)) {
            return false;
        }

        InitiumViDTO initiumViDTO = (InitiumViDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, initiumViDTO.id);
    }
