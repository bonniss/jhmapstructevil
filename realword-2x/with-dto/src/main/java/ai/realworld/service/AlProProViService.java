...
public class AlProProViService {
    ...
    /**
     * Get all the alProProVis with eager load of many-to-many relationships.
     *
     * @return the list of entities.
     */
    public Page<AlProProViDTO> findAllWithEagerRelationships(Pageable pageable) {
        return alProProViRepository.findAllWithEagerRelationships(pageable).map(alProProViMapper::toDto);
    }
    ...
    public Optional<AlProProViDTO> findOne(UUID id) {
        ...
        return alProProViRepository.findOneWithEagerRelationships(id).map(alProProViMapper::toDto);
    }
