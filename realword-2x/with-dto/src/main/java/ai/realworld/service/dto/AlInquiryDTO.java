...
/**
 * A DTO for the {@link ai.realworld.domain.AlInquiry} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlInquiryDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AlInquiryDTO)) {
            return false;
        }

        AlInquiryDTO alInquiryDTO = (AlInquiryDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, alInquiryDTO.id);
    }
