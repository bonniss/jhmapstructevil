...
/**
 * Criteria class for the {@link ai.realworld.domain.AlVueVueViUsage} entity. This class is used
 * in {@link ai.realworld.web.rest.AlVueVueViUsageResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /al-vue-vue-vi-usages?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlVueVueViUsageCriteria implements Serializable, Criteria {
    ...
    public AlVueVueViUsageCriteria() {}

    public AlVueVueViUsageCriteria(AlVueVueViUsageCriteria other) {
    ...
    @Override
    public AlVueVueViUsageCriteria copy() {
        return new AlVueVueViUsageCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final AlVueVueViUsageCriteria that = (AlVueVueViUsageCriteria) o;
        return (
    ...
    public String toString() {
        return "AlVueVueViUsageCriteria{" +
