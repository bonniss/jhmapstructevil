...
public class AlGoreDTO implements Serializable {
    ...
    private AlBetonamuRelationViDTO bizRelationVi;
    ...
    public AlBetonamuRelationViDTO getBizRelationVi() {
        return bizRelationVi;
    }

    public void setBizRelationVi(AlBetonamuRelationViDTO bizRelationVi) {
        this.bizRelationVi = bizRelationVi;
    }
    ...
    public String toString() {
        return "AlGoreDTO{" +
            ...
            ", bizRelationVi=" + getBizRelationVi() +
            "}";
    }
}
