...
public class MetaverseCriteria implements Serializable, Criteria {
    ...
    private UUIDFilter alProProId;

    private UUIDFilter alProtyId;

    private UUIDFilter alProProViId;

    private UUIDFilter alProtyViId;
    ...
    public MetaverseCriteria(MetaverseCriteria other) {
        ...
        this.alProProId = other.optionalAlProProId().map(UUIDFilter::copy).orElse(null);
        this.alProtyId = other.optionalAlProtyId().map(UUIDFilter::copy).orElse(null);
        this.alProProViId = other.optionalAlProProViId().map(UUIDFilter::copy).orElse(null);
        this.alProtyViId = other.optionalAlProtyViId().map(UUIDFilter::copy).orElse(null);
    ...
    public UUIDFilter getAlProProId() {
        return alProProId;
    }

    public Optional<UUIDFilter> optionalAlProProId() {
        return Optional.ofNullable(alProProId);
    }

    public UUIDFilter alProProId() {
        if (alProProId == null) {
            setAlProProId(new UUIDFilter());
        }
        return alProProId;
    }

    public void setAlProProId(UUIDFilter alProProId) {
        this.alProProId = alProProId;
    }

    public UUIDFilter getAlProtyId() {
        return alProtyId;
    }

    public Optional<UUIDFilter> optionalAlProtyId() {
        return Optional.ofNullable(alProtyId);
    }

    public UUIDFilter alProtyId() {
        if (alProtyId == null) {
            setAlProtyId(new UUIDFilter());
        }
        return alProtyId;
    }

    public void setAlProtyId(UUIDFilter alProtyId) {
        this.alProtyId = alProtyId;
    }

    public UUIDFilter getAlProProViId() {
        return alProProViId;
    }

    public Optional<UUIDFilter> optionalAlProProViId() {
        return Optional.ofNullable(alProProViId);
    }

    public UUIDFilter alProProViId() {
        if (alProProViId == null) {
            setAlProProViId(new UUIDFilter());
        }
        return alProProViId;
    }

    public void setAlProProViId(UUIDFilter alProProViId) {
        this.alProProViId = alProProViId;
    }

    public UUIDFilter getAlProtyViId() {
        return alProtyViId;
    }

    public Optional<UUIDFilter> optionalAlProtyViId() {
        return Optional.ofNullable(alProtyViId);
    }

    public UUIDFilter alProtyViId() {
        if (alProtyViId == null) {
            setAlProtyViId(new UUIDFilter());
        }
        return alProtyViId;
    }

    public void setAlProtyViId(UUIDFilter alProtyViId) {
        this.alProtyViId = alProtyViId;
    }
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(alProProId, that.alProProId) &&
            Objects.equals(alProtyId, that.alProtyId) &&
            Objects.equals(alProProViId, that.alProProViId) &&
            Objects.equals(alProtyViId, that.alProtyViId) &&
    ...
    public String toString() {
        return "MetaverseCriteria{" +
            ...
            optionalAlProProId().map(f -> "alProProId=" + f + ", ").orElse("") +
            optionalAlProtyId().map(f -> "alProtyId=" + f + ", ").orElse("") +
            optionalAlProProViId().map(f -> "alProProViId=" + f + ", ").orElse("") +
            optionalAlProtyViId().map(f -> "alProtyViId=" + f + ", ").orElse("") +
