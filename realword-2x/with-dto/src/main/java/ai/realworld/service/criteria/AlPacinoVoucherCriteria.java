...
/**
 * Criteria class for the {@link ai.realworld.domain.AlPacinoVoucher} entity. This class is used
 * in {@link ai.realworld.web.rest.AlPacinoVoucherResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /al-pacino-vouchers?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlPacinoVoucherCriteria implements Serializable, Criteria {
    ...
    public AlPacinoVoucherCriteria() {}

    public AlPacinoVoucherCriteria(AlPacinoVoucherCriteria other) {
    ...
    @Override
    public AlPacinoVoucherCriteria copy() {
        return new AlPacinoVoucherCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final AlPacinoVoucherCriteria that = (AlPacinoVoucherCriteria) o;
        return (
    ...
    public String toString() {
        return "AlPacinoVoucherCriteria{" +
