...
/**
 * A DTO for the {@link ai.realworld.domain.AlSherMaleVi} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlSherMaleViDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AlSherMaleViDTO)) {
            return false;
        }

        AlSherMaleViDTO alSherMaleViDTO = (AlSherMaleViDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, alSherMaleViDTO.id);
    }
