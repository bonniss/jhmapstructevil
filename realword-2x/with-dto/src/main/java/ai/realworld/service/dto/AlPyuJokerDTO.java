...
/**
 * A DTO for the {@link ai.realworld.domain.AlPyuJoker} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlPyuJokerDTO implements Serializable {
    ...
    private Set<AlProtyDTO> properties = new HashSet<>();
    ...
    public Set<AlProtyDTO> getProperties() {
        return properties;
    }

    public void setProperties(Set<AlProtyDTO> properties) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AlPyuJokerDTO)) {
            return false;
        }

        AlPyuJokerDTO alPyuJokerDTO = (AlPyuJokerDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, alPyuJokerDTO.id);
    }
