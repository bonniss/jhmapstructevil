...
/**
 * Criteria class for the {@link ai.realworld.domain.HandCraftVi} entity. This class is used
 * in {@link ai.realworld.web.rest.HandCraftViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /hand-craft-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class HandCraftViCriteria implements Serializable, Criteria {
    ...
    public HandCraftViCriteria() {}

    public HandCraftViCriteria(HandCraftViCriteria other) {
    ...
    @Override
    public HandCraftViCriteria copy() {
        return new HandCraftViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final HandCraftViCriteria that = (HandCraftViCriteria) o;
        return (
