...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, ai.realworld.domain.Metaverse.class.getName() + ".alProProVis");
            createCache(cm, ai.realworld.domain.Metaverse.class.getName() + ".alProtyVis");
            ...
            createCache(cm, ai.realworld.domain.AlMenityVi.class.getName() + ".propertyProfiles");
            ...
            createCache(cm, ai.realworld.domain.AlPyuJokerVi.class.getName() + ".properties");
            createCache(cm, ai.realworld.domain.AlLadyGagaVi.class.getName());
            createCache(cm, ai.realworld.domain.AlProProVi.class.getName());
            createCache(cm, ai.realworld.domain.AlProProVi.class.getName() + ".amenities");
            createCache(cm, ai.realworld.domain.AlProProVi.class.getName() + ".images");
            ...
            createCache(cm, ai.realworld.domain.AlProtyVi.class.getName() + ".images");
            createCache(cm, ai.realworld.domain.AlProtyVi.class.getName() + ".children");
            createCache(cm, ai.realworld.domain.AlProtyVi.class.getName() + ".bookings");
