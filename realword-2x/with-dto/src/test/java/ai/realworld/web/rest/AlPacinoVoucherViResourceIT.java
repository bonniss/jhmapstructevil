...
class AlPacinoVoucherViResourceIT {
    ...
    void createAlPacinoVoucherVi() throws Exception {
        ...
        AlPacinoVoucherViDTO alPacinoVoucherViDTO = alPacinoVoucherViMapper.toDto(alPacinoVoucherVi);
        var returnedAlPacinoVoucherViDTO = om.readValue(
            restAlPacinoVoucherViMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alPacinoVoucherViDTO)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            AlPacinoVoucherViDTO.class
        );

        // Validate the AlPacinoVoucherVi in the database
        assertIncrementedRepositoryCount(databaseSizeBeforeCreate);
        var returnedAlPacinoVoucherVi = alPacinoVoucherViMapper.toEntity(returnedAlPacinoVoucherViDTO);
    ...
    void putExistingAlPacinoVoucherVi() throws Exception {
        ...
        AlPacinoVoucherViDTO alPacinoVoucherViDTO = alPacinoVoucherViMapper.toDto(updatedAlPacinoVoucherVi);

        restAlPacinoVoucherViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, alPacinoVoucherViDTO.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(alPacinoVoucherViDTO))
            )
            .andExpect(status().isOk());
    ...
    void putWithMissingIdPathParamAlPacinoVoucherVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlPacinoVoucherViMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alPacinoVoucherViDTO)))
    ...
    void patchNonExistingAlPacinoVoucherVi() throws Exception {
        ...
        restAlPacinoVoucherViMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, alPacinoVoucherViDTO.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(alPacinoVoucherViDTO))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamAlPacinoVoucherVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlPacinoVoucherViMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(alPacinoVoucherViDTO)))
            .andExpect(status().isMethodNotAllowed());
