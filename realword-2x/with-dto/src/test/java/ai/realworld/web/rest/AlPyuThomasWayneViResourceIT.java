...
class AlPyuThomasWayneViResourceIT {
    ...
    void createAlPyuThomasWayneVi() throws Exception {
        ...
        AlPyuThomasWayneViDTO alPyuThomasWayneViDTO = alPyuThomasWayneViMapper.toDto(alPyuThomasWayneVi);
        var returnedAlPyuThomasWayneViDTO = om.readValue(
            restAlPyuThomasWayneViMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alPyuThomasWayneViDTO)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            AlPyuThomasWayneViDTO.class
        );

        // Validate the AlPyuThomasWayneVi in the database
        assertIncrementedRepositoryCount(databaseSizeBeforeCreate);
        var returnedAlPyuThomasWayneVi = alPyuThomasWayneViMapper.toEntity(returnedAlPyuThomasWayneViDTO);
    ...
    void putExistingAlPyuThomasWayneVi() throws Exception {
        ...
        AlPyuThomasWayneViDTO alPyuThomasWayneViDTO = alPyuThomasWayneViMapper.toDto(updatedAlPyuThomasWayneVi);

        restAlPyuThomasWayneViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, alPyuThomasWayneViDTO.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(alPyuThomasWayneViDTO))
            )
            .andExpect(status().isOk());
    ...
    void putWithMissingIdPathParamAlPyuThomasWayneVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlPyuThomasWayneViMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alPyuThomasWayneViDTO)))
    ...
    void patchNonExistingAlPyuThomasWayneVi() throws Exception {
        ...
        restAlPyuThomasWayneViMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, alPyuThomasWayneViDTO.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(alPyuThomasWayneViDTO))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamAlPyuThomasWayneVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlPyuThomasWayneViMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(alPyuThomasWayneViDTO)))
            .andExpect(status().isMethodNotAllowed());
