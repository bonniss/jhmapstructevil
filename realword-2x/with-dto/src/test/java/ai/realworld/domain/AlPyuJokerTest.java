...
class AlPyuJokerTest {
    ...
    void propertyTest() {
        ...
        alPyuJoker.addProperty(alProtyBack);
        assertThat(alPyuJoker.getProperties()).containsOnly(alProtyBack);

        alPyuJoker.removeProperty(alProtyBack);
        assertThat(alPyuJoker.getProperties()).doesNotContain(alProtyBack);

        alPyuJoker.properties(new HashSet<>(Set.of(alProtyBack)));
        assertThat(alPyuJoker.getProperties()).containsOnly(alProtyBack);

        alPyuJoker.setProperties(new HashSet<>());
        assertThat(alPyuJoker.getProperties()).doesNotContain(alProtyBack);
    }
}
