...
class AlPyuJokerViResourceIT {
    ...
    void createAlPyuJokerVi() throws Exception {
        ...
        var returnedAlPyuJokerVi = om.readValue(
            restAlPyuJokerViMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alPyuJokerVi)))
    ...
    void putExistingAlPyuJokerVi() throws Exception {
        ...
        restAlPyuJokerViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedAlPyuJokerVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedAlPyuJokerVi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingAlPyuJokerVi() throws Exception {
        ...
        restAlPyuJokerViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, alPyuJokerVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(alPyuJokerVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamAlPyuJokerVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlPyuJokerViMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alPyuJokerVi)))
    ...
    void patchNonExistingAlPyuJokerVi() throws Exception {
        ...
        restAlPyuJokerViMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, alPyuJokerVi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(alPyuJokerVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamAlPyuJokerVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlPyuJokerViMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(alPyuJokerVi)))
            .andExpect(status().isMethodNotAllowed());
