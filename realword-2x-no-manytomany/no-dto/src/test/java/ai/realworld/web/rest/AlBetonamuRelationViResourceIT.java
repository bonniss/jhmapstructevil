...
class AlBetonamuRelationViResourceIT {
    ...
    void createAlBetonamuRelationVi() throws Exception {
        ...
        var returnedAlBetonamuRelationVi = om.readValue(
            restAlBetonamuRelationViMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alBetonamuRelationVi)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            AlBetonamuRelationVi.class
        );
    ...
    void putExistingAlBetonamuRelationVi() throws Exception {
        ...
        restAlBetonamuRelationViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedAlBetonamuRelationVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedAlBetonamuRelationVi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingAlBetonamuRelationVi() throws Exception {
        ...
        restAlBetonamuRelationViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, alBetonamuRelationVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(alBetonamuRelationVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamAlBetonamuRelationVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlBetonamuRelationViMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alBetonamuRelationVi)))
    ...
    void patchNonExistingAlBetonamuRelationVi() throws Exception {
        ...
        restAlBetonamuRelationViMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, alBetonamuRelationVi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(alBetonamuRelationVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamAlBetonamuRelationVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlBetonamuRelationViMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(alBetonamuRelationVi)))
            .andExpect(status().isMethodNotAllowed());
