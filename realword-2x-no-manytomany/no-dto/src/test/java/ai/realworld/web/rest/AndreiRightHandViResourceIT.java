...
class AndreiRightHandViResourceIT {
    ...
    void createAndreiRightHandVi() throws Exception {
        ...
        var returnedAndreiRightHandVi = om.readValue(
            restAndreiRightHandViMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(andreiRightHandVi)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            AndreiRightHandVi.class
        );
    ...
    void putExistingAndreiRightHandVi() throws Exception {
        ...
        restAndreiRightHandViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedAndreiRightHandVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedAndreiRightHandVi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingAndreiRightHandVi() throws Exception {
        ...
        restAndreiRightHandViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, andreiRightHandVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(andreiRightHandVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamAndreiRightHandVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAndreiRightHandViMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(andreiRightHandVi)))
    ...
    void patchNonExistingAndreiRightHandVi() throws Exception {
        ...
        restAndreiRightHandViMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, andreiRightHandVi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(andreiRightHandVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamAndreiRightHandVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAndreiRightHandViMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(andreiRightHandVi)))
            .andExpect(status().isMethodNotAllowed());
