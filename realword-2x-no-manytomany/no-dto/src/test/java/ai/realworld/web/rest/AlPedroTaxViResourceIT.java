...
class AlPedroTaxViResourceIT {
    ...
    void createAlPedroTaxVi() throws Exception {
        ...
        var returnedAlPedroTaxVi = om.readValue(
            restAlPedroTaxViMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alPedroTaxVi)))
    ...
    void putExistingAlPedroTaxVi() throws Exception {
        ...
        restAlPedroTaxViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedAlPedroTaxVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedAlPedroTaxVi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingAlPedroTaxVi() throws Exception {
        ...
        restAlPedroTaxViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, alPedroTaxVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(alPedroTaxVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamAlPedroTaxVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlPedroTaxViMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alPedroTaxVi)))
    ...
    void patchNonExistingAlPedroTaxVi() throws Exception {
        ...
        restAlPedroTaxViMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, alPedroTaxVi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(alPedroTaxVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamAlPedroTaxVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlPedroTaxViMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(alPedroTaxVi)))
            .andExpect(status().isMethodNotAllowed());
