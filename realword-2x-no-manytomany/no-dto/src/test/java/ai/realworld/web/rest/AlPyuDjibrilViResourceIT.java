...
class AlPyuDjibrilViResourceIT {
    ...
    void createAlPyuDjibrilVi() throws Exception {
        ...
        var returnedAlPyuDjibrilVi = om.readValue(
            restAlPyuDjibrilViMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alPyuDjibrilVi)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            AlPyuDjibrilVi.class
        );
    ...
    void putExistingAlPyuDjibrilVi() throws Exception {
        ...
        restAlPyuDjibrilViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedAlPyuDjibrilVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedAlPyuDjibrilVi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingAlPyuDjibrilVi() throws Exception {
        ...
        restAlPyuDjibrilViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, alPyuDjibrilVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(alPyuDjibrilVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamAlPyuDjibrilVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlPyuDjibrilViMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alPyuDjibrilVi)))
    ...
    void patchNonExistingAlPyuDjibrilVi() throws Exception {
        ...
        restAlPyuDjibrilViMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, alPyuDjibrilVi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(alPyuDjibrilVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamAlPyuDjibrilVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlPyuDjibrilViMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(alPyuDjibrilVi)))
            .andExpect(status().isMethodNotAllowed());
