...
class SaisanCogViResourceIT {
    ...
    void createSaisanCogVi() throws Exception {
        ...
        var returnedSaisanCogVi = om.readValue(
            restSaisanCogViMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(saisanCogVi)))
    ...
    void putExistingSaisanCogVi() throws Exception {
        ...
        restSaisanCogViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedSaisanCogVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedSaisanCogVi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingSaisanCogVi() throws Exception {
        ...
        restSaisanCogViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, saisanCogVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(saisanCogVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamSaisanCogVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restSaisanCogViMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(saisanCogVi)))
    ...
    void patchNonExistingSaisanCogVi() throws Exception {
        ...
        restSaisanCogViMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, saisanCogVi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(saisanCogVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamSaisanCogVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restSaisanCogViMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(saisanCogVi)))
            .andExpect(status().isMethodNotAllowed());
