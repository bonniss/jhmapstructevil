...
class AlActisoViResourceIT {
    ...
    void createAlActisoVi() throws Exception {
        ...
        var returnedAlActisoVi = om.readValue(
            restAlActisoViMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alActisoVi)))
    ...
    void putExistingAlActisoVi() throws Exception {
        ...
        restAlActisoViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedAlActisoVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedAlActisoVi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingAlActisoVi() throws Exception {
        ...
        restAlActisoViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, alActisoVi.getId()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alActisoVi))
            )
            .andExpect(status().isBadRequest());
        ...
        restAlActisoViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, longCount.incrementAndGet())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(alActisoVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamAlActisoVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlActisoViMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alActisoVi)))
    ...
    void patchNonExistingAlActisoVi() throws Exception {
        ...
        restAlActisoViMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, alActisoVi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(alActisoVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamAlActisoVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlActisoViMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(alActisoVi)))
            .andExpect(status().isMethodNotAllowed());
