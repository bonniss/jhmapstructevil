...
class AlVueVueConditionResourceIT {
    ...
    void createAlVueVueCondition() throws Exception {
        ...
        var returnedAlVueVueCondition = om.readValue(
            restAlVueVueConditionMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alVueVueCondition)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            AlVueVueCondition.class
        );
    ...
    void putExistingAlVueVueCondition() throws Exception {
        ...
        restAlVueVueConditionMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedAlVueVueCondition.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedAlVueVueCondition))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingAlVueVueCondition() throws Exception {
        ...
        restAlVueVueConditionMockMvc
            .perform(
                put(ENTITY_API_URL_ID, alVueVueCondition.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(alVueVueCondition))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamAlVueVueCondition() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlVueVueConditionMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alVueVueCondition)))
    ...
    void patchNonExistingAlVueVueCondition() throws Exception {
        ...
        restAlVueVueConditionMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, alVueVueCondition.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(alVueVueCondition))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamAlVueVueCondition() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlVueVueConditionMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(alVueVueCondition)))
            .andExpect(status().isMethodNotAllowed());
