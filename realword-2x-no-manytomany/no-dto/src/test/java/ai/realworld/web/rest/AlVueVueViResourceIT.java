...
class AlVueVueViResourceIT {
    ...
    void createAlVueVueVi() throws Exception {
        ...
        var returnedAlVueVueVi = om.readValue(
            restAlVueVueViMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alVueVueVi)))
    ...
    void putExistingAlVueVueVi() throws Exception {
        ...
        restAlVueVueViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedAlVueVueVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedAlVueVueVi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingAlVueVueVi() throws Exception {
        ...
        restAlVueVueViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, alVueVueVi.getId()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alVueVueVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithIdMismatchAlVueVueVi() throws Exception {
        ...
        restAlVueVueViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, UUID.randomUUID()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alVueVueVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamAlVueVueVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlVueVueViMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alVueVueVi)))
    ...
    void patchNonExistingAlVueVueVi() throws Exception {
        ...
        restAlVueVueViMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, alVueVueVi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(alVueVueVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamAlVueVueVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlVueVueViMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(alVueVueVi)))
            .andExpect(status().isMethodNotAllowed());
