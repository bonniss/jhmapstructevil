...
class AlPacinoAndreiRightHandViResourceIT {
    ...
    void createAlPacinoAndreiRightHandVi() throws Exception {
        ...
        var returnedAlPacinoAndreiRightHandVi = om.readValue(
            restAlPacinoAndreiRightHandViMockMvc
                .perform(
                    post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alPacinoAndreiRightHandVi))
                )
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            AlPacinoAndreiRightHandVi.class
        );
    ...
    void createAlPacinoAndreiRightHandViWithExistingId() throws Exception {
        ...
        restAlPacinoAndreiRightHandViMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alPacinoAndreiRightHandVi)))
    ...
    void putExistingAlPacinoAndreiRightHandVi() throws Exception {
        ...
        restAlPacinoAndreiRightHandViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedAlPacinoAndreiRightHandVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedAlPacinoAndreiRightHandVi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingAlPacinoAndreiRightHandVi() throws Exception {
        ...
        restAlPacinoAndreiRightHandViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, alPacinoAndreiRightHandVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(alPacinoAndreiRightHandVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamAlPacinoAndreiRightHandVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlPacinoAndreiRightHandViMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alPacinoAndreiRightHandVi)))
    ...
    void patchNonExistingAlPacinoAndreiRightHandVi() throws Exception {
        ...
        restAlPacinoAndreiRightHandViMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, alPacinoAndreiRightHandVi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(alPacinoAndreiRightHandVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamAlPacinoAndreiRightHandVi() throws Exception {
        ...
        restAlPacinoAndreiRightHandViMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(alPacinoAndreiRightHandVi))
            )
            .andExpect(status().isMethodNotAllowed());
