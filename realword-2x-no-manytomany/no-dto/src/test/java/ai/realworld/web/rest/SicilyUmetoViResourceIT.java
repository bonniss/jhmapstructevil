...
class SicilyUmetoViResourceIT {
    ...
    void createSicilyUmetoVi() throws Exception {
        ...
        var returnedSicilyUmetoVi = om.readValue(
            restSicilyUmetoViMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(sicilyUmetoVi)))
    ...
    void putExistingSicilyUmetoVi() throws Exception {
        ...
        restSicilyUmetoViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedSicilyUmetoVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedSicilyUmetoVi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingSicilyUmetoVi() throws Exception {
        ...
        restSicilyUmetoViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, sicilyUmetoVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(sicilyUmetoVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamSicilyUmetoVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restSicilyUmetoViMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(sicilyUmetoVi)))
    ...
    void patchNonExistingSicilyUmetoVi() throws Exception {
        ...
        restSicilyUmetoViMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, sicilyUmetoVi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(sicilyUmetoVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamSicilyUmetoVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restSicilyUmetoViMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(sicilyUmetoVi)))
            .andExpect(status().isMethodNotAllowed());
