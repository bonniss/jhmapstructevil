...
class AlLadyGagaViResourceIT {
    ...
    void createAlLadyGagaVi() throws Exception {
        ...
        var returnedAlLadyGagaVi = om.readValue(
            restAlLadyGagaViMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alLadyGagaVi)))
    ...
    void putExistingAlLadyGagaVi() throws Exception {
        ...
        restAlLadyGagaViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedAlLadyGagaVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedAlLadyGagaVi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingAlLadyGagaVi() throws Exception {
        ...
        restAlLadyGagaViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, alLadyGagaVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(alLadyGagaVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamAlLadyGagaVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlLadyGagaViMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alLadyGagaVi)))
    ...
    void patchNonExistingAlLadyGagaVi() throws Exception {
        ...
        restAlLadyGagaViMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, alLadyGagaVi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(alLadyGagaVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamAlLadyGagaVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlLadyGagaViMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(alLadyGagaVi)))
            .andExpect(status().isMethodNotAllowed());
