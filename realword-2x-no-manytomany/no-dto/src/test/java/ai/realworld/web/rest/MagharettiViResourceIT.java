...
class MagharettiViResourceIT {
    ...
    void createMagharettiVi() throws Exception {
        ...
        var returnedMagharettiVi = om.readValue(
            restMagharettiViMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(magharettiVi)))
    ...
    void putExistingMagharettiVi() throws Exception {
        ...
        restMagharettiViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedMagharettiVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedMagharettiVi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingMagharettiVi() throws Exception {
        ...
        restMagharettiViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, magharettiVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(magharettiVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamMagharettiVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restMagharettiViMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(magharettiVi)))
    ...
    void patchNonExistingMagharettiVi() throws Exception {
        ...
        restMagharettiViMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, magharettiVi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(magharettiVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamMagharettiVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restMagharettiViMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(magharettiVi)))
            .andExpect(status().isMethodNotAllowed());
