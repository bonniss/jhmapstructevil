...
class JohnLennonTest {
    ...
    @Test
    void jelloInitiumViTest() {
        JohnLennon johnLennon = getJohnLennonRandomSampleGenerator();
        InitiumVi initiumViBack = getInitiumViRandomSampleGenerator();

        johnLennon.setJelloInitiumVi(initiumViBack);
        assertThat(johnLennon.getJelloInitiumVi()).isEqualTo(initiumViBack);

        johnLennon.jelloInitiumVi(null);
        assertThat(johnLennon.getJelloInitiumVi()).isNull();
    }

    @Test
    void inhouseInitiumViTest() {
        JohnLennon johnLennon = getJohnLennonRandomSampleGenerator();
        InitiumVi initiumViBack = getInitiumViRandomSampleGenerator();

        johnLennon.setInhouseInitiumVi(initiumViBack);
        assertThat(johnLennon.getInhouseInitiumVi()).isEqualTo(initiumViBack);

        johnLennon.inhouseInitiumVi(null);
        assertThat(johnLennon.getInhouseInitiumVi()).isNull();
    }
}
