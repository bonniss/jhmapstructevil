...
class OlMasterTest {
    ...
    void addressViTest() {
        ...
        olMaster.setAddressVi(andreiRightHandViBack);
        assertThat(olMaster.getAddressVi()).isEqualTo(andreiRightHandViBack);

        olMaster.addressVi(null);
        assertThat(olMaster.getAddressVi()).isNull();
    }
