 ...
 */
@Entity
@Table(name = "al_vue_vue")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlVueVue implements Serializable {
    ...
    private Set<AlVueVueCondition> conditions = new HashSet<>();
    ...
    public AlVueVue code(String code) {
        this.setCode(code);
        return this;
    }
    ...
    public AlVueVue name(String name) {
        this.setName(name);
        return this;
    }
    ...
    public AlVueVue contentHeitiga(String contentHeitiga) {
    ...
    public AlVueVue discountType(AlcountTypo discountType) {
    ...
    public AlVueVue discountRate(BigDecimal discountRate) {
    ...
    public AlVueVue scope(AlcountScopy scope) {
        this.setScope(scope);
        return this;
    }
    ...
    public AlVueVue isIndividuallyUsedOnly(Boolean isIndividuallyUsedOnly) {
    ...
    public AlVueVue usageLifeTimeLimit(Integer usageLifeTimeLimit) {
    ...
    public AlVueVue usageLimitPerUser(Integer usageLimitPerUser) {
    ...
    public AlVueVue usageQuantity(Integer usageQuantity) {
    ...
    public AlVueVue minimumSpend(BigDecimal minimumSpend) {
    ...
    public AlVueVue maximumSpend(BigDecimal maximumSpend) {
    ...
    public AlVueVue canBeCollectedByUser(Boolean canBeCollectedByUser) {
    ...
    public AlVueVue salePriceFromDate(LocalDate salePriceFromDate) {
    ...
    public AlVueVue salePriceToDate(LocalDate salePriceToDate) {
    ...
    public AlVueVue publicationStatus(PaoloStatus publicationStatus) {
    ...
    public AlVueVue publishedDate(Instant publishedDate) {
    ...
    public AlVueVue image(Metaverse metaverse) {
    ...
    public AlVueVue alVueVueUsage(AlVueVueUsage alVueVueUsage) {
    ...
    public AlVueVue application(JohnLennon johnLennon) {
        this.setApplication(johnLennon);
        return this;
    }

    public Set<AlVueVueCondition> getConditions() {
        return this.conditions;
    }

    public void setConditions(Set<AlVueVueCondition> alVueVueConditions) {
        if (this.conditions != null) {
            this.conditions.forEach(i -> i.setParent(null));
        }
        if (alVueVueConditions != null) {
            alVueVueConditions.forEach(i -> i.setParent(this));
        }
        this.conditions = alVueVueConditions;
    }

    public AlVueVue conditions(Set<AlVueVueCondition> alVueVueConditions) {
        this.setConditions(alVueVueConditions);
        return this;
    }

    public AlVueVue addConditions(AlVueVueCondition alVueVueCondition) {
        this.conditions.add(alVueVueCondition);
        alVueVueCondition.setParent(this);
        return this;
    }

    public AlVueVue removeConditions(AlVueVueCondition alVueVueCondition) {
        this.conditions.remove(alVueVueCondition);
        alVueVueCondition.setParent(null);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AlVueVue)) {
            return false;
        }
        return getId() != null && getId().equals(((AlVueVue) o).getId());
    }
