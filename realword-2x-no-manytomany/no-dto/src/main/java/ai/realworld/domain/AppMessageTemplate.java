...
/**
 * A AppMessageTemplate.
 */
@Entity
@Table(name = "app_message_template")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AppMessageTemplate implements Serializable {
    ...
    public AppMessageTemplate id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public AppMessageTemplate title(String title) {
        this.setTitle(title);
        return this;
    }
    ...
    public AppMessageTemplate topContent(String topContent) {
    ...
    public AppMessageTemplate content(String content) {
    ...
    public AppMessageTemplate bottomContent(String bottomContent) {
    ...
    public AppMessageTemplate propTitleMappingJason(String propTitleMappingJason) {
    ...
    public AppMessageTemplate dataSourceMappingType(AlphaSourceType dataSourceMappingType) {
    ...
    public AppMessageTemplate targetUrls(String targetUrls) {
    ...
    public AppMessageTemplate thumbnail(Metaverse metaverse) {
    ...
    public AppMessageTemplate application(JohnLennon johnLennon) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AppMessageTemplate)) {
            return false;
        }
        return getId() != null && getId().equals(((AppMessageTemplate) o).getId());
    }
