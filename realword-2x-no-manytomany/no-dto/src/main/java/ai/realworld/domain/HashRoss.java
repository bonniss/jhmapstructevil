 ...
 */
@Entity
@Table(name = "hash_ross")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("common-java:DuplicatedBlocks")
public class HashRoss implements Serializable {
    ...
    public HashRoss name(String name) {
        this.setName(name);
        return this;
    }
    ...
    public HashRoss slug(String slug) {
        this.setSlug(slug);
        return this;
    }
    ...
    public HashRoss description(String description) {
    ...
    public HashRoss permissionGridJason(String permissionGridJason) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HashRoss)) {
            return false;
        }
        return getId() != null && getId().equals(((HashRoss) o).getId());
    }
