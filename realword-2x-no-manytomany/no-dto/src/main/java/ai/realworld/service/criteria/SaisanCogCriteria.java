...
/**
 * Criteria class for the {@link ai.realworld.domain.SaisanCog} entity. This class is used
 * in {@link ai.realworld.web.rest.SaisanCogResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /saisan-cogs?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class SaisanCogCriteria implements Serializable, Criteria {
    ...
    public SaisanCogCriteria() {}

    public SaisanCogCriteria(SaisanCogCriteria other) {
    ...
    @Override
    public SaisanCogCriteria copy() {
        return new SaisanCogCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final SaisanCogCriteria that = (SaisanCogCriteria) o;
        return (
