...
/**
 * Criteria class for the {@link ai.realworld.domain.AlPacinoAndreiRightHandVi} entity. This class is used
 * in {@link ai.realworld.web.rest.AlPacinoAndreiRightHandViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /al-pacino-andrei-right-hand-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlPacinoAndreiRightHandViCriteria implements Serializable, Criteria {
    ...
    public AlPacinoAndreiRightHandViCriteria() {}

    public AlPacinoAndreiRightHandViCriteria(AlPacinoAndreiRightHandViCriteria other) {
    ...
    @Override
    public AlPacinoAndreiRightHandViCriteria copy() {
        return new AlPacinoAndreiRightHandViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final AlPacinoAndreiRightHandViCriteria that = (AlPacinoAndreiRightHandViCriteria) o;
        return (
    ...
    public String toString() {
        return "AlPacinoAndreiRightHandViCriteria{" +
