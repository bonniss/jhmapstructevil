...
/**
 * Criteria class for the {@link ai.realworld.domain.RihannaVi} entity. This class is used
 * in {@link ai.realworld.web.rest.RihannaViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /rihanna-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class RihannaViCriteria implements Serializable, Criteria {
    ...
    public RihannaViCriteria() {}

    public RihannaViCriteria(RihannaViCriteria other) {
    ...
    @Override
    public RihannaViCriteria copy() {
        return new RihannaViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final RihannaViCriteria that = (RihannaViCriteria) o;
        return (
