...
/**
 * Criteria class for the {@link ai.realworld.domain.InitiumVi} entity. This class is used
 * in {@link ai.realworld.web.rest.InitiumViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /initium-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class InitiumViCriteria implements Serializable, Criteria {
    ...
    public InitiumViCriteria() {}

    public InitiumViCriteria(InitiumViCriteria other) {
    ...
    @Override
    public InitiumViCriteria copy() {
        return new InitiumViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final InitiumViCriteria that = (InitiumViCriteria) o;
        return (
