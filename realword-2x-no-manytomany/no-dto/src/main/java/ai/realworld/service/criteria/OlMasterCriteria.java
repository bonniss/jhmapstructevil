...
public class OlMasterCriteria implements Serializable, Criteria {
    ...
    private LongFilter addressViId;
    ...
    public OlMasterCriteria(OlMasterCriteria other) {
        ...
        this.addressViId = other.optionalAddressViId().map(LongFilter::copy).orElse(null);
    ...
    public LongFilter getAddressViId() {
        return addressViId;
    }

    public Optional<LongFilter> optionalAddressViId() {
        return Optional.ofNullable(addressViId);
    }

    public LongFilter addressViId() {
        if (addressViId == null) {
            setAddressViId(new LongFilter());
        }
        return addressViId;
    }

    public void setAddressViId(LongFilter addressViId) {
        this.addressViId = addressViId;
    }
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(addressViId, that.addressViId) &&
    ...
    public String toString() {
        return "OlMasterCriteria{" +
            ...
            optionalAddressViId().map(f -> "addressViId=" + f + ", ").orElse("") +
