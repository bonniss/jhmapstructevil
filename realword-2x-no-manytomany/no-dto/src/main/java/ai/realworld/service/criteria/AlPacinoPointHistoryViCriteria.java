...
/**
 * Criteria class for the {@link ai.realworld.domain.AlPacinoPointHistoryVi} entity. This class is used
 * in {@link ai.realworld.web.rest.AlPacinoPointHistoryViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /al-pacino-point-history-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlPacinoPointHistoryViCriteria implements Serializable, Criteria {
    ...
    public AlPacinoPointHistoryViCriteria() {}

    public AlPacinoPointHistoryViCriteria(AlPacinoPointHistoryViCriteria other) {
    ...
    @Override
    public AlPacinoPointHistoryViCriteria copy() {
        return new AlPacinoPointHistoryViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final AlPacinoPointHistoryViCriteria that = (AlPacinoPointHistoryViCriteria) o;
        return (
    ...
    public String toString() {
        return "AlPacinoPointHistoryViCriteria{" +
