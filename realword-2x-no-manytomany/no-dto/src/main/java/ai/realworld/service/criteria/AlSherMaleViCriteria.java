...
/**
 * Criteria class for the {@link ai.realworld.domain.AlSherMaleVi} entity. This class is used
 * in {@link ai.realworld.web.rest.AlSherMaleViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /al-sher-male-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlSherMaleViCriteria implements Serializable, Criteria {
    ...
    public AlSherMaleViCriteria() {}

    public AlSherMaleViCriteria(AlSherMaleViCriteria other) {
    ...
    @Override
    public AlSherMaleViCriteria copy() {
        return new AlSherMaleViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final AlSherMaleViCriteria that = (AlSherMaleViCriteria) o;
        return (
