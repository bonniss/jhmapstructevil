...
/**
 * Criteria class for the {@link ai.realworld.domain.AlPowerShellVi} entity. This class is used
 * in {@link ai.realworld.web.rest.AlPowerShellViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /al-power-shell-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlPowerShellViCriteria implements Serializable, Criteria {
    ...
    public AlPowerShellViCriteria() {}

    public AlPowerShellViCriteria(AlPowerShellViCriteria other) {
    ...
    @Override
    public AlPowerShellViCriteria copy() {
        return new AlPowerShellViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final AlPowerShellViCriteria that = (AlPowerShellViCriteria) o;
        return (
