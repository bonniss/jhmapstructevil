...
class AlPacinoTest {
    ...
    @Test
    void membershipTierViTest() {
        AlPacino alPacino = getAlPacinoRandomSampleGenerator();
        AlMemTierVi alMemTierViBack = getAlMemTierViRandomSampleGenerator();

        alPacino.setMembershipTierVi(alMemTierViBack);
        assertThat(alPacino.getMembershipTierVi()).isEqualTo(alMemTierViBack);

        alPacino.membershipTierVi(null);
        assertThat(alPacino.getMembershipTierVi()).isNull();
    }
    ...
    void alVueVueViUsageTest() {
        ...
        alPacino.setAlVueVueViUsage(alVueVueViUsageBack);
        assertThat(alPacino.getAlVueVueViUsage()).isEqualTo(alVueVueViUsageBack);

        alPacino.alVueVueViUsage(null);
        assertThat(alPacino.getAlVueVueViUsage()).isNull();
    }
}
