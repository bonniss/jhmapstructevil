...
class AlVueVueViUsageResourceIT {
    ...
    void createAlVueVueViUsage() throws Exception {
        ...
        AlVueVueViUsageDTO alVueVueViUsageDTO = alVueVueViUsageMapper.toDto(alVueVueViUsage);
        var returnedAlVueVueViUsageDTO = om.readValue(
            restAlVueVueViUsageMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alVueVueViUsageDTO)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            AlVueVueViUsageDTO.class
        );

        // Validate the AlVueVueViUsage in the database
        assertIncrementedRepositoryCount(databaseSizeBeforeCreate);
        var returnedAlVueVueViUsage = alVueVueViUsageMapper.toEntity(returnedAlVueVueViUsageDTO);
    ...
    void putExistingAlVueVueViUsage() throws Exception {
        ...
        AlVueVueViUsageDTO alVueVueViUsageDTO = alVueVueViUsageMapper.toDto(updatedAlVueVueViUsage);

        restAlVueVueViUsageMockMvc
            .perform(
                put(ENTITY_API_URL_ID, alVueVueViUsageDTO.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(alVueVueViUsageDTO))
            )
            .andExpect(status().isOk());
    ...
    void putWithMissingIdPathParamAlVueVueViUsage() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlVueVueViUsageMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alVueVueViUsageDTO)))
    ...
    void patchNonExistingAlVueVueViUsage() throws Exception {
        ...
        restAlVueVueViUsageMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, alVueVueViUsageDTO.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(alVueVueViUsageDTO))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamAlVueVueViUsage() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlVueVueViUsageMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(alVueVueViUsageDTO)))
            .andExpect(status().isMethodNotAllowed());
