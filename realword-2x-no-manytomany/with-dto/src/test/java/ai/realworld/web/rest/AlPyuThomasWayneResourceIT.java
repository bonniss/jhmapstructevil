...
class AlPyuThomasWayneResourceIT {
    ...
    void createAlPyuThomasWayne() throws Exception {
        ...
        AlPyuThomasWayneDTO alPyuThomasWayneDTO = alPyuThomasWayneMapper.toDto(alPyuThomasWayne);
        var returnedAlPyuThomasWayneDTO = om.readValue(
            restAlPyuThomasWayneMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alPyuThomasWayneDTO)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            AlPyuThomasWayneDTO.class
        );

        // Validate the AlPyuThomasWayne in the database
        assertIncrementedRepositoryCount(databaseSizeBeforeCreate);
        var returnedAlPyuThomasWayne = alPyuThomasWayneMapper.toEntity(returnedAlPyuThomasWayneDTO);
    ...
    void putExistingAlPyuThomasWayne() throws Exception {
        ...
        AlPyuThomasWayneDTO alPyuThomasWayneDTO = alPyuThomasWayneMapper.toDto(updatedAlPyuThomasWayne);

        restAlPyuThomasWayneMockMvc
            .perform(
                put(ENTITY_API_URL_ID, alPyuThomasWayneDTO.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(alPyuThomasWayneDTO))
            )
            .andExpect(status().isOk());
    ...
    void putWithMissingIdPathParamAlPyuThomasWayne() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlPyuThomasWayneMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alPyuThomasWayneDTO)))
    ...
    void patchNonExistingAlPyuThomasWayne() throws Exception {
        ...
        restAlPyuThomasWayneMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, alPyuThomasWayneDTO.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(alPyuThomasWayneDTO))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamAlPyuThomasWayne() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlPyuThomasWayneMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(alPyuThomasWayneDTO)))
            .andExpect(status().isMethodNotAllowed());
