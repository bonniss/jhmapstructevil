...
class AlPacinoPointHistoryViResourceIT {
    ...
    void createAlPacinoPointHistoryVi() throws Exception {
        ...
        AlPacinoPointHistoryViDTO alPacinoPointHistoryViDTO = alPacinoPointHistoryViMapper.toDto(alPacinoPointHistoryVi);
        var returnedAlPacinoPointHistoryViDTO = om.readValue(
            restAlPacinoPointHistoryViMockMvc
                .perform(
                    post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alPacinoPointHistoryViDTO))
                )
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            AlPacinoPointHistoryViDTO.class
        );

        // Validate the AlPacinoPointHistoryVi in the database
        assertIncrementedRepositoryCount(databaseSizeBeforeCreate);
        var returnedAlPacinoPointHistoryVi = alPacinoPointHistoryViMapper.toEntity(returnedAlPacinoPointHistoryViDTO);
    ...
    void createAlPacinoPointHistoryViWithExistingId() throws Exception {
        ...
        restAlPacinoPointHistoryViMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alPacinoPointHistoryViDTO)))
    ...
    void putExistingAlPacinoPointHistoryVi() throws Exception {
        ...
        AlPacinoPointHistoryViDTO alPacinoPointHistoryViDTO = alPacinoPointHistoryViMapper.toDto(updatedAlPacinoPointHistoryVi);

        restAlPacinoPointHistoryViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, alPacinoPointHistoryViDTO.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(alPacinoPointHistoryViDTO))
            )
            .andExpect(status().isOk());
    ...
    void putWithMissingIdPathParamAlPacinoPointHistoryVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlPacinoPointHistoryViMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alPacinoPointHistoryViDTO)))
    ...
    void patchNonExistingAlPacinoPointHistoryVi() throws Exception {
        ...
        restAlPacinoPointHistoryViMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, alPacinoPointHistoryViDTO.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(alPacinoPointHistoryViDTO))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamAlPacinoPointHistoryVi() throws Exception {
        ...
        restAlPacinoPointHistoryViMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(alPacinoPointHistoryViDTO))
            )
            .andExpect(status().isMethodNotAllowed());
