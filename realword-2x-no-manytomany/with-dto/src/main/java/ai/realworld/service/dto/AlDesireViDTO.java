...
/**
 * A DTO for the {@link ai.realworld.domain.AlDesireVi} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlDesireViDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AlDesireViDTO)) {
            return false;
        }

        AlDesireViDTO alDesireViDTO = (AlDesireViDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, alDesireViDTO.id);
    }
