...
/**
 * A DTO for the {@link ai.realworld.domain.AlPedroTax} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlPedroTaxDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AlPedroTaxDTO)) {
            return false;
        }

        AlPedroTaxDTO alPedroTaxDTO = (AlPedroTaxDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, alPedroTaxDTO.id);
    }
