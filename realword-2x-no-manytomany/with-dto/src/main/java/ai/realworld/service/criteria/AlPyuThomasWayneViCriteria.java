...
/**
 * Criteria class for the {@link ai.realworld.domain.AlPyuThomasWayneVi} entity. This class is used
 * in {@link ai.realworld.web.rest.AlPyuThomasWayneViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /al-pyu-thomas-wayne-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlPyuThomasWayneViCriteria implements Serializable, Criteria {
    ...
    public AlPyuThomasWayneViCriteria() {}

    public AlPyuThomasWayneViCriteria(AlPyuThomasWayneViCriteria other) {
    ...
    @Override
    public AlPyuThomasWayneViCriteria copy() {
        return new AlPyuThomasWayneViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final AlPyuThomasWayneViCriteria that = (AlPyuThomasWayneViCriteria) o;
        return (
    ...
    public String toString() {
        return "AlPyuThomasWayneViCriteria{" +
