...
/**
 * Criteria class for the {@link ai.realworld.domain.AlCatalina} entity. This class is used
 * in {@link ai.realworld.web.rest.AlCatalinaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /al-catalinas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlCatalinaCriteria implements Serializable, Criteria {
    ...
    public AlCatalinaCriteria() {}

    public AlCatalinaCriteria(AlCatalinaCriteria other) {
    ...
    @Override
    public AlCatalinaCriteria copy() {
        return new AlCatalinaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final AlCatalinaCriteria that = (AlCatalinaCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, description, treeDepth, parentId, avatarId, applicationId, childrenId, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "AlCatalinaCriteria{" +
