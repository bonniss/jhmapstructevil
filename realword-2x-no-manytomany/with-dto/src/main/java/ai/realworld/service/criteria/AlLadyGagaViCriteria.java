...
/**
 * Criteria class for the {@link ai.realworld.domain.AlLadyGagaVi} entity. This class is used
 * in {@link ai.realworld.web.rest.AlLadyGagaViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /al-lady-gaga-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlLadyGagaViCriteria implements Serializable, Criteria {
    ...
    public AlLadyGagaViCriteria() {}

    public AlLadyGagaViCriteria(AlLadyGagaViCriteria other) {
    ...
    @Override
    public AlLadyGagaViCriteria copy() {
        return new AlLadyGagaViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final AlLadyGagaViCriteria that = (AlLadyGagaViCriteria) o;
        return (
