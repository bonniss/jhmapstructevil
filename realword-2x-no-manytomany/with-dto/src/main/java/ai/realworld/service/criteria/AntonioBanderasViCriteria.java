...
/**
 * Criteria class for the {@link ai.realworld.domain.AntonioBanderasVi} entity. This class is used
 * in {@link ai.realworld.web.rest.AntonioBanderasViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /antonio-banderas-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AntonioBanderasViCriteria implements Serializable, Criteria {
    ...
    private LongFilter antonioBanderasViId;

    private Boolean distinct;

    public AntonioBanderasViCriteria() {}

    public AntonioBanderasViCriteria(AntonioBanderasViCriteria other) {
        ...
        this.antonioBanderasViId = other.optionalAntonioBanderasViId().map(LongFilter::copy).orElse(null);
        this.distinct = other.distinct;
    }

    @Override
    public AntonioBanderasViCriteria copy() {
        return new AntonioBanderasViCriteria(this);
    }
    ...
    public LongFilter getAntonioBanderasViId() {
        return antonioBanderasViId;
    }

    public Optional<LongFilter> optionalAntonioBanderasViId() {
        return Optional.ofNullable(antonioBanderasViId);
    }

    public LongFilter antonioBanderasViId() {
        if (antonioBanderasViId == null) {
            setAntonioBanderasViId(new LongFilter());
        }
        return antonioBanderasViId;
    }

    public void setAntonioBanderasViId(LongFilter antonioBanderasViId) {
        this.antonioBanderasViId = antonioBanderasViId;
    }
    ...
    public boolean equals(Object o) {
        ...
        final AntonioBanderasViCriteria that = (AntonioBanderasViCriteria) o;
        return (
            ...
            Objects.equals(antonioBanderasViId, that.antonioBanderasViId) &&
    ...
    public String toString() {
        return "AntonioBanderasViCriteria{" +
            ...
            optionalAntonioBanderasViId().map(f -> "antonioBanderasViId=" + f + ", ").orElse("") +
