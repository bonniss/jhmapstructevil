...
/**
 * A DTO for the {@link ai.realworld.domain.AllMassageThaiVi} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AllMassageThaiViDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AllMassageThaiViDTO)) {
            return false;
        }

        AllMassageThaiViDTO allMassageThaiViDTO = (AllMassageThaiViDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, allMassageThaiViDTO.id);
    }
