...
/**
 * Criteria class for the {@link ai.realworld.domain.AllMassageThaiVi} entity. This class is used
 * in {@link ai.realworld.web.rest.AllMassageThaiViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /all-massage-thai-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AllMassageThaiViCriteria implements Serializable, Criteria {
    ...
    public AllMassageThaiViCriteria() {}

    public AllMassageThaiViCriteria(AllMassageThaiViCriteria other) {
    ...
    @Override
    public AllMassageThaiViCriteria copy() {
        return new AllMassageThaiViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final AllMassageThaiViCriteria that = (AllMassageThaiViCriteria) o;
        return (
    ...
    public String toString() {
        return "AllMassageThaiViCriteria{" +
