...
/**
 * A DTO for the {@link ai.realworld.domain.EdSheeranVi} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class EdSheeranViDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EdSheeranViDTO)) {
            return false;
        }

        EdSheeranViDTO edSheeranViDTO = (EdSheeranViDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, edSheeranViDTO.id);
    }
