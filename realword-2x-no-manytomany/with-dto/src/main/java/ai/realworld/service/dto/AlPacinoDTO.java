...
public class AlPacinoDTO implements Serializable {
    ...
    private AlMemTierViDTO membershipTierVi;
    ...
    public AlMemTierViDTO getMembershipTierVi() {
        return membershipTierVi;
    }

    public void setMembershipTierVi(AlMemTierViDTO membershipTierVi) {
        this.membershipTierVi = membershipTierVi;
    }
    ...
    public String toString() {
        return "AlPacinoDTO{" +
            ...
            ", membershipTierVi=" + getMembershipTierVi() +
