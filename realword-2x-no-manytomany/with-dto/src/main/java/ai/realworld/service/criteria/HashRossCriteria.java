...
/**
 * Criteria class for the {@link ai.realworld.domain.HashRoss} entity. This class is used
 * in {@link ai.realworld.web.rest.HashRossResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /hash-rosses?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class HashRossCriteria implements Serializable, Criteria {
    ...
    public HashRossCriteria() {}

    public HashRossCriteria(HashRossCriteria other) {
    ...
    @Override
    public HashRossCriteria copy() {
        return new HashRossCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final HashRossCriteria that = (HashRossCriteria) o;
        return (
