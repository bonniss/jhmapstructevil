...
public interface JohnLennonMapper extends EntityMapper<JohnLennonDTO, JohnLennon> {
    ...
    @Mapping(target = "jelloInitiumVi", source = "jelloInitiumVi", qualifiedByName = "initiumViId")
    @Mapping(target = "inhouseInitiumVi", source = "inhouseInitiumVi", qualifiedByName = "initiumViId")
    ...
    @BeanMapping(ignoreByDefault = true)
    @Mapping(target = "id", source = "id")
    InitiumViDTO toDtoInitiumViId(InitiumVi initiumVi);
