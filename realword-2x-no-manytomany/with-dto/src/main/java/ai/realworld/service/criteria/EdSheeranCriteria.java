...
/**
 * Criteria class for the {@link ai.realworld.domain.EdSheeran} entity. This class is used
 * in {@link ai.realworld.web.rest.EdSheeranResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /ed-sheerans?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class EdSheeranCriteria implements Serializable, Criteria {
    ...
    public EdSheeranCriteria() {}

    public EdSheeranCriteria(EdSheeranCriteria other) {
    ...
    @Override
    public EdSheeranCriteria copy() {
        return new EdSheeranCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final EdSheeranCriteria that = (EdSheeranCriteria) o;
        return (
