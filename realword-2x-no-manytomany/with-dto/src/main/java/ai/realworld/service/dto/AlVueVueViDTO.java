...
/**
 * A DTO for the {@link ai.realworld.domain.AlVueVueVi} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlVueVueViDTO implements Serializable {
    ...
    private AlVueVueViUsageDTO alVueVueViUsage;
    ...
    public AlVueVueViUsageDTO getAlVueVueViUsage() {
        return alVueVueViUsage;
    }

    public void setAlVueVueViUsage(AlVueVueViUsageDTO alVueVueViUsage) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AlVueVueViDTO)) {
            return false;
        }

        AlVueVueViDTO alVueVueViDTO = (AlVueVueViDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, alVueVueViDTO.id);
    }
    ...
    public String toString() {
        return "AlVueVueViDTO{" +
            ...
            ", image=" + getImage() +
            ", alVueVueViUsage=" + getAlVueVueViUsage() +
