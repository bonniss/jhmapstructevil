...
/**
 * Criteria class for the {@link ai.realworld.domain.AlPedroTaxVi} entity. This class is used
 * in {@link ai.realworld.web.rest.AlPedroTaxViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /al-pedro-tax-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlPedroTaxViCriteria implements Serializable, Criteria {
    ...
    public AlPedroTaxViCriteria() {}

    public AlPedroTaxViCriteria(AlPedroTaxViCriteria other) {
    ...
    @Override
    public AlPedroTaxViCriteria copy() {
        return new AlPedroTaxViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final AlPedroTaxViCriteria that = (AlPedroTaxViCriteria) o;
        return (
