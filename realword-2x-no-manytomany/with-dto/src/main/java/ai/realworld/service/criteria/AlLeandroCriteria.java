...
public class AlLeandroCriteria implements Serializable, Criteria {
    ...
    public AlLeandroCriteria(AlLeandroCriteria other) {
        ...
        this.awardVisId = other.optionalAwardVisId().map(UUIDFilter::copy).orElse(null);
    ...
    public UUIDFilter getAwardVisId() {
        return awardVisId;
    }

    public Optional<UUIDFilter> optionalAwardVisId() {
        return Optional.ofNullable(awardVisId);
    }

    public UUIDFilter awardVisId() {
        if (awardVisId == null) {
            setAwardVisId(new UUIDFilter());
        }
        return awardVisId;
    }

    public void setAwardVisId(UUIDFilter awardVisId) {
        this.awardVisId = awardVisId;
    }
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(awardVisId, that.awardVisId) &&
    ...
    public String toString() {
        return "AlLeandroCriteria{" +
            ...
            optionalAwardVisId().map(f -> "awardVisId=" + f + ", ").orElse("") +
