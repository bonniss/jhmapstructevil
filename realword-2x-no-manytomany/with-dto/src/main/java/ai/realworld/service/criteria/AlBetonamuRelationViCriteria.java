...
/**
 * Criteria class for the {@link ai.realworld.domain.AlBetonamuRelationVi} entity. This class is used
 * in {@link ai.realworld.web.rest.AlBetonamuRelationViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /al-betonamu-relation-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlBetonamuRelationViCriteria implements Serializable, Criteria {
    ...
    public AlBetonamuRelationViCriteria() {}

    public AlBetonamuRelationViCriteria(AlBetonamuRelationViCriteria other) {
    ...
    @Override
    public AlBetonamuRelationViCriteria copy() {
        return new AlBetonamuRelationViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final AlBetonamuRelationViCriteria that = (AlBetonamuRelationViCriteria) o;
        return (
    ...
    public String toString() {
        return "AlBetonamuRelationViCriteria{" +
