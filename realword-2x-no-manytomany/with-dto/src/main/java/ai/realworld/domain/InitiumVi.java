 ...
 */
@Entity
@Table(name = "initium_vi")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("common-java:DuplicatedBlocks")
public class InitiumVi implements Serializable {
    ...
    public InitiumVi name(String name) {
        this.setName(name);
        return this;
    }
    ...
    public InitiumVi slug(String slug) {
        this.setSlug(slug);
        return this;
    }
    ...
    public InitiumVi description(String description) {
    ...
    public InitiumVi isJelloSupported(Boolean isJelloSupported) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InitiumVi)) {
            return false;
        }
        return getId() != null && getId().equals(((InitiumVi) o).getId());
    }
