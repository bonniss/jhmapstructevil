...
/**
 * A AlZorroTemptationVi.
 */
@Entity
@Table(name = "al_zorro_temptation_vi")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlZorroTemptationVi implements Serializable {
    ...
    public AlZorroTemptationVi id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public AlZorroTemptationVi zipAction(KnsIction zipAction) {
    ...
    public AlZorroTemptationVi name(String name) {
        this.setName(name);
        return this;
    }
    ...
    public AlZorroTemptationVi templateId(String templateId) {
    ...
    public AlZorroTemptationVi dataSourceMappingType(AlphaSourceType dataSourceMappingType) {
    ...
    public AlZorroTemptationVi templateDataMapping(String templateDataMapping) {
    ...
    public AlZorroTemptationVi targetUrls(String targetUrls) {
    ...
    public AlZorroTemptationVi thumbnail(Metaverse metaverse) {
    ...
    public AlZorroTemptationVi application(JohnLennon johnLennon) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AlZorroTemptationVi)) {
            return false;
        }
        return getId() != null && getId().equals(((AlZorroTemptationVi) o).getId());
    }
