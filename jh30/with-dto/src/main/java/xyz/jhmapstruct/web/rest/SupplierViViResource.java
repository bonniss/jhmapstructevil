...
public class SupplierViViResource {
    ...
    public SupplierViViResource(SupplierViViService supplierViViService, SupplierViViRepository supplierViViRepository) {
     ...
     */
    @GetMapping("")
    public List<SupplierViViDTO> getAllSupplierViVis(
        @RequestParam(name = "eagerload", required = false, defaultValue = "true") boolean eagerload
    ) {
        LOG.debug("REST request to get all SupplierViVis");
        return supplierViViService.findAll();
    }
