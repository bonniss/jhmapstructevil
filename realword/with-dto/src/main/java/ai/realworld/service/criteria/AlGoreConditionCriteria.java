...
/**
 * Criteria class for the {@link ai.realworld.domain.AlGoreCondition} entity. This class is used
 * in {@link ai.realworld.web.rest.AlGoreConditionResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /al-gore-conditions?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlGoreConditionCriteria implements Serializable, Criteria {
    ...
    public AlGoreConditionCriteria() {}

    public AlGoreConditionCriteria(AlGoreConditionCriteria other) {
    ...
    @Override
    public AlGoreConditionCriteria copy() {
        return new AlGoreConditionCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final AlGoreConditionCriteria that = (AlGoreConditionCriteria) o;
        return (
    ...
    public String toString() {
        return "AlGoreConditionCriteria{" +
