...
public class AlPyuJokerService {
    ...
    /**
     * Get all the alPyuJokers with eager load of many-to-many relationships.
     *
     * @return the list of entities.
     */
    public Page<AlPyuJokerDTO> findAllWithEagerRelationships(Pageable pageable) {
        return alPyuJokerRepository.findAllWithEagerRelationships(pageable).map(alPyuJokerMapper::toDto);
    }
    ...
    public Optional<AlPyuJokerDTO> findOne(UUID id) {
        ...
        return alPyuJokerRepository.findOneWithEagerRelationships(id).map(alPyuJokerMapper::toDto);
    }
