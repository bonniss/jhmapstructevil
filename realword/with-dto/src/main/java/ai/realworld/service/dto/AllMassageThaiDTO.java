...
/**
 * A DTO for the {@link ai.realworld.domain.AllMassageThai} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AllMassageThaiDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AllMassageThaiDTO)) {
            return false;
        }

        AllMassageThaiDTO allMassageThaiDTO = (AllMassageThaiDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, allMassageThaiDTO.id);
    }
