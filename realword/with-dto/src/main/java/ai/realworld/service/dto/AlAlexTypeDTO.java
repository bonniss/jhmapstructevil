...
/**
 * A DTO for the {@link ai.realworld.domain.AlAlexType} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlAlexTypeDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AlAlexTypeDTO)) {
            return false;
        }

        AlAlexTypeDTO alAlexTypeDTO = (AlAlexTypeDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, alAlexTypeDTO.id);
    }
