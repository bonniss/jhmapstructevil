...
/**
 * Criteria class for the {@link ai.realworld.domain.AndreiRightHand} entity. This class is used
 * in {@link ai.realworld.web.rest.AndreiRightHandResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /andrei-right-hands?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AndreiRightHandCriteria implements Serializable, Criteria {
    ...
    public AndreiRightHandCriteria() {}

    public AndreiRightHandCriteria(AndreiRightHandCriteria other) {
    ...
    @Override
    public AndreiRightHandCriteria copy() {
        return new AndreiRightHandCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final AndreiRightHandCriteria that = (AndreiRightHandCriteria) o;
        return (
    ...
    public String toString() {
        return "AndreiRightHandCriteria{" +
