...
class AlPacinoPointHistoryResourceIT {
    ...
    void createAlPacinoPointHistory() throws Exception {
        ...
        AlPacinoPointHistoryDTO alPacinoPointHistoryDTO = alPacinoPointHistoryMapper.toDto(alPacinoPointHistory);
        var returnedAlPacinoPointHistoryDTO = om.readValue(
            restAlPacinoPointHistoryMockMvc
                .perform(
                    post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alPacinoPointHistoryDTO))
                )
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            AlPacinoPointHistoryDTO.class
        );

        // Validate the AlPacinoPointHistory in the database
        assertIncrementedRepositoryCount(databaseSizeBeforeCreate);
        var returnedAlPacinoPointHistory = alPacinoPointHistoryMapper.toEntity(returnedAlPacinoPointHistoryDTO);
    ...
    void createAlPacinoPointHistoryWithExistingId() throws Exception {
        ...
        restAlPacinoPointHistoryMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alPacinoPointHistoryDTO)))
    ...
    void putExistingAlPacinoPointHistory() throws Exception {
        ...
        AlPacinoPointHistoryDTO alPacinoPointHistoryDTO = alPacinoPointHistoryMapper.toDto(updatedAlPacinoPointHistory);

        restAlPacinoPointHistoryMockMvc
            .perform(
                put(ENTITY_API_URL_ID, alPacinoPointHistoryDTO.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(alPacinoPointHistoryDTO))
            )
            .andExpect(status().isOk());
    ...
    void putWithMissingIdPathParamAlPacinoPointHistory() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlPacinoPointHistoryMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alPacinoPointHistoryDTO)))
    ...
    void patchNonExistingAlPacinoPointHistory() throws Exception {
        ...
        restAlPacinoPointHistoryMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, alPacinoPointHistoryDTO.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(alPacinoPointHistoryDTO))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamAlPacinoPointHistory() throws Exception {
        ...
        restAlPacinoPointHistoryMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(alPacinoPointHistoryDTO))
            )
            .andExpect(status().isMethodNotAllowed());
