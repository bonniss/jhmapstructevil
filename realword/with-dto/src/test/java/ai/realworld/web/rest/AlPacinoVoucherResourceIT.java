...
class AlPacinoVoucherResourceIT {
    ...
    void createAlPacinoVoucher() throws Exception {
        ...
        AlPacinoVoucherDTO alPacinoVoucherDTO = alPacinoVoucherMapper.toDto(alPacinoVoucher);
        var returnedAlPacinoVoucherDTO = om.readValue(
            restAlPacinoVoucherMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alPacinoVoucherDTO)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            AlPacinoVoucherDTO.class
        );

        // Validate the AlPacinoVoucher in the database
        assertIncrementedRepositoryCount(databaseSizeBeforeCreate);
        var returnedAlPacinoVoucher = alPacinoVoucherMapper.toEntity(returnedAlPacinoVoucherDTO);
    ...
    void putExistingAlPacinoVoucher() throws Exception {
        ...
        AlPacinoVoucherDTO alPacinoVoucherDTO = alPacinoVoucherMapper.toDto(updatedAlPacinoVoucher);

        restAlPacinoVoucherMockMvc
            .perform(
                put(ENTITY_API_URL_ID, alPacinoVoucherDTO.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(alPacinoVoucherDTO))
            )
            .andExpect(status().isOk());
    ...
    void putWithMissingIdPathParamAlPacinoVoucher() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlPacinoVoucherMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alPacinoVoucherDTO)))
    ...
    void patchNonExistingAlPacinoVoucher() throws Exception {
        ...
        restAlPacinoVoucherMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, alPacinoVoucherDTO.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(alPacinoVoucherDTO))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamAlPacinoVoucher() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlPacinoVoucherMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(alPacinoVoucherDTO)))
            .andExpect(status().isMethodNotAllowed());
