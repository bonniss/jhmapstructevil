...
class AndreiRightHandResourceIT {
    ...
    void createAndreiRightHand() throws Exception {
        ...
        AndreiRightHandDTO andreiRightHandDTO = andreiRightHandMapper.toDto(andreiRightHand);
        var returnedAndreiRightHandDTO = om.readValue(
            restAndreiRightHandMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(andreiRightHandDTO)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            AndreiRightHandDTO.class
        );

        // Validate the AndreiRightHand in the database
        assertIncrementedRepositoryCount(databaseSizeBeforeCreate);
        var returnedAndreiRightHand = andreiRightHandMapper.toEntity(returnedAndreiRightHandDTO);
    ...
    void putExistingAndreiRightHand() throws Exception {
        ...
        AndreiRightHandDTO andreiRightHandDTO = andreiRightHandMapper.toDto(updatedAndreiRightHand);

        restAndreiRightHandMockMvc
            .perform(
                put(ENTITY_API_URL_ID, andreiRightHandDTO.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(andreiRightHandDTO))
            )
            .andExpect(status().isOk());
    ...
    void putWithMissingIdPathParamAndreiRightHand() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAndreiRightHandMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(andreiRightHandDTO)))
    ...
    void patchNonExistingAndreiRightHand() throws Exception {
        ...
        restAndreiRightHandMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, andreiRightHandDTO.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(andreiRightHandDTO))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamAndreiRightHand() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAndreiRightHandMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(andreiRightHandDTO)))
            .andExpect(status().isMethodNotAllowed());
