...
public class AlPyuJokerTestSamples {

    private static final Random random = new Random();
    private static final AtomicInteger intCount = new AtomicInteger(random.nextInt() + (2 * Short.MAX_VALUE));

    public static AlPyuJoker getAlPyuJokerSample1() {
    ...
    public static AlPyuJoker getAlPyuJokerSample2() {
        return new AlPyuJoker()
    ...
    public static AlPyuJoker getAlPyuJokerRandomSampleGenerator() {
        return new AlPyuJoker()
            .id(UUID.randomUUID())
