...
@Component
public class AlProProMapperImpl implements AlProProMapper {

    @Override
    public List<AlProPro> toEntity(List<AlProProDTO> dtoList) {
        if ( dtoList == null ) {
            return null;
        }

        List<AlProPro> list = new ArrayList<AlProPro>( dtoList.size() );
        for ( AlProProDTO alProProDTO : dtoList ) {
            list.add( toEntity( alProProDTO ) );
        }
    ...
    @Override
    public List<AlProProDTO> toDto(List<AlProPro> entityList) {
        if ( entityList == null ) {
            return null;
        }

        List<AlProProDTO> list = new ArrayList<AlProProDTO>( entityList.size() );
        for ( AlProPro alProPro : entityList ) {
            list.add( toDto( alProPro ) );
        }
    ...
    @Override
    public void partialUpdate(AlProPro entity, AlProProDTO dto) {
        if ( dto == null ) {
            return;
        }
        ...
        if ( dto.getAreaInSquareMeter() != null ) {
            entity.setAreaInSquareMeter( dto.getAreaInSquareMeter() );
        }
        ...
        if ( dto.getBedSize() != null ) {
            entity.setBedSize( dto.getBedSize() );
        }
        ...
        if ( dto.getProject() != null ) {
            if ( entity.getProject() == null ) {
                entity.project( new AlLadyGaga() );
            }
            alLadyGagaDTOToAlLadyGaga( dto.getProject(), entity.getProject() );
        }
        ...
        if ( entity.getAmenities() != null ) {
            Set<AlMenity> set = alMenityDTOSetToAlMenitySet( dto.getAmenities() );
            if ( set != null ) {
                entity.getAmenities().clear();
                entity.getAmenities().addAll( set );
            }
        }
        else {
            Set<AlMenity> set = alMenityDTOSetToAlMenitySet( dto.getAmenities() );
            if ( set != null ) {
                entity.amenities( set );
            }
        }
        if ( entity.getImages() != null ) {
            Set<Metaverse> set1 = metaverseDTOSetToMetaverseSet( dto.getImages() );
            if ( set1 != null ) {
                entity.getImages().clear();
                entity.getImages().addAll( set1 );
            }
        }
        else {
            Set<Metaverse> set1 = metaverseDTOSetToMetaverseSet( dto.getImages() );
    ...
    @Override
    public AlProProDTO toDto(AlProPro s) {
        if ( s == null ) {
            return null;
        }
        ...
        alProProDTO.setParent( toDtoAlProProId( s.getParent() ) );
        alProProDTO.setProject( toDtoAlLadyGagaId( s.getProject() ) );
        alProProDTO.setAvatar( toDtoMetaverseId( s.getAvatar() ) );
        alProProDTO.setApplication( toDtoJohnLennonId( s.getApplication() ) );
        alProProDTO.setAmenities( toDtoAlMenityIdSet( s.getAmenities() ) );
        alProProDTO.setImages( toDtoMetaverseIdSet( s.getImages() ) );
        alProProDTO.setId( s.getId() );
        alProProDTO.setName( s.getName() );
        alProProDTO.setDescriptionHeitiga( s.getDescriptionHeitiga() );
        alProProDTO.setPropertyType( s.getPropertyType() );
        alProProDTO.setAreaInSquareMeter( s.getAreaInSquareMeter() );
        alProProDTO.setNumberOfAdults( s.getNumberOfAdults() );
        alProProDTO.setNumberOfPreschoolers( s.getNumberOfPreschoolers() );
        alProProDTO.setNumberOfChildren( s.getNumberOfChildren() );
        alProProDTO.setNumberOfRooms( s.getNumberOfRooms() );
        alProProDTO.setNumberOfFloors( s.getNumberOfFloors() );
        alProProDTO.setBedSize( s.getBedSize() );
        alProProDTO.setIsEnabled( s.getIsEnabled() );

        return alProProDTO;
    }

    @Override
    public AlProPro toEntity(AlProProDTO alProProDTO) {
        if ( alProProDTO == null ) {
            return null;
        }
        ...
        alProPro.parent( toEntity( alProProDTO.getParent() ) );
        alProPro.project( alLadyGagaDTOToAlLadyGaga1( alProProDTO.getProject() ) );
    ...
    @Override
    public AlLadyGagaDTO toDtoAlLadyGagaId(AlLadyGaga alLadyGaga) {
        if ( alLadyGaga == null ) {
            return null;
        }

        AlLadyGagaDTO alLadyGagaDTO = new AlLadyGagaDTO();

        alLadyGagaDTO.setId( alLadyGaga.getId() );
    ...
    @Override
    public AlMenityDTO toDtoAlMenityId(AlMenity alMenity) {
        if ( alMenity == null ) {
            return null;
        }

        AlMenityDTO alMenityDTO = new AlMenityDTO();

        alMenityDTO.setId( alMenity.getId() );
    ...
    protected AlProty alProtyDTOToAlProty(AlProtyDTO alProtyDTO) {
        ...
        alProty.propertyProfile( toEntity( alProtyDTO.getPropertyProfile() ) );
    ...
    protected void alLadyGagaDTOToAlLadyGaga(AlLadyGagaDTO alLadyGagaDTO, AlLadyGaga mappingTarget) {
    ...
    protected AlLadyGaga alLadyGagaDTOToAlLadyGaga1(AlLadyGagaDTO alLadyGagaDTO) {
        if ( alLadyGagaDTO == null ) {
            return null;
        }
