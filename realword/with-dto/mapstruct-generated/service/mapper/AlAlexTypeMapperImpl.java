...
@Generated(
    ...
    date = "2024-10-22T00:22:55+0700",
    comments = "version: 1.6.2, compiler: javac, environment: Java 17.0.11 (Eclipse Adoptium)"
)
@Component
public class AlAlexTypeMapperImpl implements AlAlexTypeMapper {

    @Override
    public AlAlexType toEntity(AlAlexTypeDTO dto) {
        if ( dto == null ) {
            return null;
        }
        ...
        alAlexType.setId( dto.getId() );
        alAlexType.setName( dto.getName() );
        alAlexType.setDescription( dto.getDescription() );
        alAlexType.setCanDoRetail( dto.getCanDoRetail() );
        alAlexType.setIsOrgDivision( dto.getIsOrgDivision() );
        alAlexType.setConfigJason( dto.getConfigJason() );
        alAlexType.setTreeDepth( dto.getTreeDepth() );
        alAlexType.application( johnLennonDTOToJohnLennon( dto.getApplication() ) );

        return alAlexType;
    }

    @Override
    public List<AlAlexType> toEntity(List<AlAlexTypeDTO> dtoList) {
        if ( dtoList == null ) {
            return null;
        }

        List<AlAlexType> list = new ArrayList<AlAlexType>( dtoList.size() );
        for ( AlAlexTypeDTO alAlexTypeDTO : dtoList ) {
            list.add( toEntity( alAlexTypeDTO ) );
        }
    ...
    @Override
    public List<AlAlexTypeDTO> toDto(List<AlAlexType> entityList) {
        if ( entityList == null ) {
            return null;
        }

        List<AlAlexTypeDTO> list = new ArrayList<AlAlexTypeDTO>( entityList.size() );
        for ( AlAlexType alAlexType : entityList ) {
            list.add( toDto( alAlexType ) );
        }
    ...
    @Override
    public void partialUpdate(AlAlexType entity, AlAlexTypeDTO dto) {
        if ( dto == null ) {
            return;
        }
        ...
        if ( dto.getCanDoRetail() != null ) {
            entity.setCanDoRetail( dto.getCanDoRetail() );
        }
        if ( dto.getIsOrgDivision() != null ) {
            entity.setIsOrgDivision( dto.getIsOrgDivision() );
        }
        if ( dto.getConfigJason() != null ) {
            entity.setConfigJason( dto.getConfigJason() );
        }
        if ( dto.getTreeDepth() != null ) {
            entity.setTreeDepth( dto.getTreeDepth() );
        }
    ...
    @Override
    public AlAlexTypeDTO toDto(AlAlexType s) {
        if ( s == null ) {
            return null;
        }
        ...
        alAlexTypeDTO.setApplication( toDtoJohnLennonId( s.getApplication() ) );
        alAlexTypeDTO.setId( s.getId() );
        alAlexTypeDTO.setName( s.getName() );
        alAlexTypeDTO.setDescription( s.getDescription() );
        alAlexTypeDTO.setCanDoRetail( s.getCanDoRetail() );
        alAlexTypeDTO.setIsOrgDivision( s.getIsOrgDivision() );
        alAlexTypeDTO.setConfigJason( s.getConfigJason() );
        alAlexTypeDTO.setTreeDepth( s.getTreeDepth() );
    ...
    protected AlApple alAppleDTOToAlApple(AlAppleDTO alAppleDTO) {
        ...
        alApple.agencyType( toEntity( alAppleDTO.getAgencyType() ) );
