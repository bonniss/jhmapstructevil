...
@Generated(
    ...
    date = "2024-10-22T00:22:58+0700",
    comments = "version: 1.6.2, compiler: javac, environment: Java 17.0.11 (Eclipse Adoptium)"
)
@Component
public class AlBestToothMapperImpl implements AlBestToothMapper {

    @Override
    public List<AlBestTooth> toEntity(List<AlBestToothDTO> dtoList) {
        if ( dtoList == null ) {
            return null;
        }

        List<AlBestTooth> list = new ArrayList<AlBestTooth>( dtoList.size() );
        for ( AlBestToothDTO alBestToothDTO : dtoList ) {
            list.add( toEntity( alBestToothDTO ) );
        }
    ...
    @Override
    public List<AlBestToothDTO> toDto(List<AlBestTooth> entityList) {
        if ( entityList == null ) {
            return null;
        }

        List<AlBestToothDTO> list = new ArrayList<AlBestToothDTO>( entityList.size() );
        for ( AlBestTooth alBestTooth : entityList ) {
            list.add( toDto( alBestTooth ) );
        }
    ...
    @Override
    public void partialUpdate(AlBestTooth entity, AlBestToothDTO dto) {
        if ( dto == null ) {
            return;
        }
        ...
        if ( entity.getArticles() != null ) {
            Set<AlLexFerg> set = alLexFergDTOSetToAlLexFergSet( dto.getArticles() );
            if ( set != null ) {
                entity.getArticles().clear();
                entity.getArticles().addAll( set );
            }
        }
        else {
            Set<AlLexFerg> set = alLexFergDTOSetToAlLexFergSet( dto.getArticles() );
    ...
    @Override
    public AlBestToothDTO toDto(AlBestTooth s) {
        if ( s == null ) {
            return null;
        }
        ...
        alBestToothDTO.setApplication( toDtoJohnLennonId( s.getApplication() ) );
        alBestToothDTO.setArticles( toDtoAlLexFergIdSet( s.getArticles() ) );
        alBestToothDTO.setId( s.getId() );
        alBestToothDTO.setName( s.getName() );

        return alBestToothDTO;
    }

    @Override
    public AlBestTooth toEntity(AlBestToothDTO alBestToothDTO) {
    ...
    @Override
    public AlLexFergDTO toDtoAlLexFergId(AlLexFerg alLexFerg) {
        if ( alLexFerg == null ) {
            return null;
        }
        ...
        alLexFergDTO.setId( alLexFerg.getId() );
    ...
    protected AlCatalina alCatalinaDTOToAlCatalina(AlCatalinaDTO alCatalinaDTO) {
        ...
        alCatalina.parent( alCatalinaDTOToAlCatalina( alCatalinaDTO.getParent() ) );
    ...
    protected Set<AlBestTooth> alBestToothDTOSetToAlBestToothSet(Set<AlBestToothDTO> set) {
        ...
        for ( AlBestToothDTO alBestToothDTO : set ) {
            set1.add( toEntity( alBestToothDTO ) );
        }

        return set1;
    }

    protected AlLexFerg alLexFergDTOToAlLexFerg(AlLexFergDTO alLexFergDTO) {
        ...
        alLexFerg.category( alCatalinaDTOToAlCatalina( alLexFergDTO.getCategory() ) );
    ...
    protected Set<AlLexFerg> alLexFergDTOSetToAlLexFergSet(Set<AlLexFergDTO> set) {
        ...
        for ( AlLexFergDTO alLexFergDTO : set ) {
            set1.add( alLexFergDTOToAlLexFerg( alLexFergDTO ) );
        }
