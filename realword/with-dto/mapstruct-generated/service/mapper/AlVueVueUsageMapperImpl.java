...
@Generated(
    ...
    date = "2024-10-22T00:21:54+0700",
    comments = "version: 1.6.2, compiler: javac, environment: Java 17.0.11 (Eclipse Adoptium)"
)
@Component
public class AlVueVueUsageMapperImpl implements AlVueVueUsageMapper {

    @Override
    public AlVueVueUsage toEntity(AlVueVueUsageDTO dto) {
        if ( dto == null ) {
            return null;
        }
        ...
        alVueVueUsage.setId( dto.getId() );
        alVueVueUsage.application( johnLennonDTOToJohnLennon( dto.getApplication() ) );

        return alVueVueUsage;
    }

    @Override
    public List<AlVueVueUsage> toEntity(List<AlVueVueUsageDTO> dtoList) {
        if ( dtoList == null ) {
            return null;
        }

        List<AlVueVueUsage> list = new ArrayList<AlVueVueUsage>( dtoList.size() );
        for ( AlVueVueUsageDTO alVueVueUsageDTO : dtoList ) {
            list.add( toEntity( alVueVueUsageDTO ) );
        }
    ...
    @Override
    public List<AlVueVueUsageDTO> toDto(List<AlVueVueUsage> entityList) {
        if ( entityList == null ) {
            return null;
        }

        List<AlVueVueUsageDTO> list = new ArrayList<AlVueVueUsageDTO>( entityList.size() );
        for ( AlVueVueUsage alVueVueUsage : entityList ) {
            list.add( toDto( alVueVueUsage ) );
        }
    ...
    @Override
    public void partialUpdate(AlVueVueUsage entity, AlVueVueUsageDTO dto) {
        if ( dto == null ) {
            return;
        }
    ...
    @Override
    public AlVueVueUsageDTO toDto(AlVueVueUsage s) {
        if ( s == null ) {
            return null;
        }
        ...
        alVueVueUsageDTO.setApplication( toDtoJohnLennonId( s.getApplication() ) );
        alVueVueUsageDTO.setId( s.getId() );
    ...
    protected AlPacino alPacinoDTOToAlPacino(AlPacinoDTO alPacinoDTO) {
        ...
        alPacino.alVueVueUsage( toEntity( alPacinoDTO.getAlVueVueUsage() ) );
