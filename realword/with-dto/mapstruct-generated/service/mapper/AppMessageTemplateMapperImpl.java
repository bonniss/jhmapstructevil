...
@Generated(
    ...
    date = "2024-10-22T00:23:27+0700",
    comments = "version: 1.6.2, compiler: javac, environment: Java 17.0.11 (Eclipse Adoptium)"
)
@Component
public class AppMessageTemplateMapperImpl implements AppMessageTemplateMapper {

    @Override
    public AppMessageTemplate toEntity(AppMessageTemplateDTO dto) {
        if ( dto == null ) {
            return null;
        }
        ...
        appMessageTemplate.setId( dto.getId() );
        appMessageTemplate.setTitle( dto.getTitle() );
        appMessageTemplate.setTopContent( dto.getTopContent() );
        appMessageTemplate.setContent( dto.getContent() );
        appMessageTemplate.setBottomContent( dto.getBottomContent() );
        appMessageTemplate.setPropTitleMappingJason( dto.getPropTitleMappingJason() );
        appMessageTemplate.setDataSourceMappingType( dto.getDataSourceMappingType() );
        appMessageTemplate.setTargetUrls( dto.getTargetUrls() );
        appMessageTemplate.thumbnail( metaverseDTOToMetaverse( dto.getThumbnail() ) );
        appMessageTemplate.application( johnLennonDTOToJohnLennon( dto.getApplication() ) );

        return appMessageTemplate;
    }

    @Override
    public List<AppMessageTemplate> toEntity(List<AppMessageTemplateDTO> dtoList) {
        if ( dtoList == null ) {
            return null;
        }

        List<AppMessageTemplate> list = new ArrayList<AppMessageTemplate>( dtoList.size() );
        for ( AppMessageTemplateDTO appMessageTemplateDTO : dtoList ) {
            list.add( toEntity( appMessageTemplateDTO ) );
        }
    ...
    @Override
    public List<AppMessageTemplateDTO> toDto(List<AppMessageTemplate> entityList) {
        if ( entityList == null ) {
            return null;
        }

        List<AppMessageTemplateDTO> list = new ArrayList<AppMessageTemplateDTO>( entityList.size() );
        for ( AppMessageTemplate appMessageTemplate : entityList ) {
            list.add( toDto( appMessageTemplate ) );
        }
    ...
    @Override
    public void partialUpdate(AppMessageTemplate entity, AppMessageTemplateDTO dto) {
        if ( dto == null ) {
            return;
        }
    ...
    @Override
    public AppMessageTemplateDTO toDto(AppMessageTemplate s) {
        if ( s == null ) {
            return null;
        }

        AppMessageTemplateDTO appMessageTemplateDTO = new AppMessageTemplateDTO();

        appMessageTemplateDTO.setThumbnail( toDtoMetaverseId( s.getThumbnail() ) );
        appMessageTemplateDTO.setApplication( toDtoJohnLennonId( s.getApplication() ) );
        appMessageTemplateDTO.setId( s.getId() );
        appMessageTemplateDTO.setTitle( s.getTitle() );
        appMessageTemplateDTO.setTopContent( s.getTopContent() );
        appMessageTemplateDTO.setContent( s.getContent() );
        appMessageTemplateDTO.setBottomContent( s.getBottomContent() );
        appMessageTemplateDTO.setPropTitleMappingJason( s.getPropTitleMappingJason() );
        appMessageTemplateDTO.setDataSourceMappingType( s.getDataSourceMappingType() );
        appMessageTemplateDTO.setTargetUrls( s.getTargetUrls() );
