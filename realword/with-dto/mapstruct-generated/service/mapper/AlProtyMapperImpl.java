...
@Generated(
    ...
    date = "2024-10-22T00:21:53+0700",
    comments = "version: 1.6.2, compiler: javac, environment: Java 17.0.11 (Eclipse Adoptium)"
)
@Component
public class AlProtyMapperImpl implements AlProtyMapper {

    @Override
    public List<AlProty> toEntity(List<AlProtyDTO> dtoList) {
        if ( dtoList == null ) {
            return null;
        }

        List<AlProty> list = new ArrayList<AlProty>( dtoList.size() );
        for ( AlProtyDTO alProtyDTO : dtoList ) {
            list.add( toEntity( alProtyDTO ) );
        }
    ...
    @Override
    public List<AlProtyDTO> toDto(List<AlProty> entityList) {
        if ( entityList == null ) {
            return null;
        }

        List<AlProtyDTO> list = new ArrayList<AlProtyDTO>( entityList.size() );
        for ( AlProty alProty : entityList ) {
            list.add( toDto( alProty ) );
        }
    ...
    @Override
    public void partialUpdate(AlProty entity, AlProtyDTO dto) {
        if ( dto == null ) {
            return;
        }
        ...
        if ( dto.getOperator() != null ) {
            if ( entity.getOperator() == null ) {
                entity.operator( new AlApple() );
            }
            alAppleDTOToAlApple( dto.getOperator(), entity.getOperator() );
        }
        ...
        if ( dto.getAvatar() != null ) {
            ...
            metaverseDTOToMetaverse( dto.getAvatar(), entity.getAvatar() );
        }
        ...
        if ( entity.getImages() != null ) {
            Set<Metaverse> set = metaverseDTOSetToMetaverseSet( dto.getImages() );
            if ( set != null ) {
                entity.getImages().clear();
                entity.getImages().addAll( set );
            }
        }
        else {
            Set<Metaverse> set = metaverseDTOSetToMetaverseSet( dto.getImages() );
        ...
        if ( entity.getBookings() != null ) {
            Set<AlPyuJoker> set1 = alPyuJokerDTOSetToAlPyuJokerSet( dto.getBookings() );
            if ( set1 != null ) {
                entity.getBookings().clear();
                entity.getBookings().addAll( set1 );
            }
        }
        else {
            Set<AlPyuJoker> set1 = alPyuJokerDTOSetToAlPyuJokerSet( dto.getBookings() );
            if ( set1 != null ) {
                entity.bookings( set1 );
            }
        }
    }

    @Override
    public AlProtyDTO toDto(AlProty s) {
        if ( s == null ) {
            return null;
        }
        ...
        alProtyDTO.setParent( toDtoAlProtyId( s.getParent() ) );
        alProtyDTO.setOperator( toDtoAlAppleId( s.getOperator() ) );
        alProtyDTO.setPropertyProfile( toDtoAlProProId( s.getPropertyProfile() ) );
        alProtyDTO.setAvatar( toDtoMetaverseId( s.getAvatar() ) );
        alProtyDTO.setApplication( toDtoJohnLennonId( s.getApplication() ) );
        alProtyDTO.setImages( toDtoMetaverseIdSet( s.getImages() ) );
        alProtyDTO.setBookings( toDtoAlPyuJokerIdSet( s.getBookings() ) );
        alProtyDTO.setId( s.getId() );
        alProtyDTO.setName( s.getName() );
        alProtyDTO.setDescriptionHeitiga( s.getDescriptionHeitiga() );
        alProtyDTO.setCoordinate( s.getCoordinate() );
        alProtyDTO.setCode( s.getCode() );
        alProtyDTO.setStatus( s.getStatus() );
        alProtyDTO.setIsEnabled( s.getIsEnabled() );

        return alProtyDTO;
    }

    @Override
    public AlProty toEntity(AlProtyDTO alProtyDTO) {
        if ( alProtyDTO == null ) {
            return null;
        }
        ...
        alProty.parent( toEntity( alProtyDTO.getParent() ) );
        alProty.operator( alAppleDTOToAlApple1( alProtyDTO.getOperator() ) );
    ...
    protected void antonioBanderasDTOToAntonioBanderas(AntonioBanderasDTO antonioBanderasDTO, AntonioBanderas mappingTarget) {
        ...
        if ( antonioBanderasDTO.getCurrent() != null ) {
            ...
            antonioBanderasDTOToAntonioBanderas( antonioBanderasDTO.getCurrent(), mappingTarget.getCurrent() );
        }
        if ( antonioBanderasDTO.getParent() != null ) {
            if ( mappingTarget.getParent() == null ) {
                mappingTarget.parent( new AntonioBanderas() );
            }
            antonioBanderasDTOToAntonioBanderas( antonioBanderasDTO.getParent(), mappingTarget.getParent() );
        }
    }

    protected void andreiRightHandDTOToAndreiRightHand(AndreiRightHandDTO andreiRightHandDTO, AndreiRightHand mappingTarget) {
        ...
        if ( andreiRightHandDTO.getCountry() != null ) {
            ...
            antonioBanderasDTOToAntonioBanderas( andreiRightHandDTO.getCountry(), mappingTarget.getCountry() );
        }
        if ( andreiRightHandDTO.getProvince() != null ) {
            if ( mappingTarget.getProvince() == null ) {
                mappingTarget.province( new AntonioBanderas() );
            }
            antonioBanderasDTOToAntonioBanderas( andreiRightHandDTO.getProvince(), mappingTarget.getProvince() );
        }
        if ( andreiRightHandDTO.getDistrict() != null ) {
            if ( mappingTarget.getDistrict() == null ) {
                mappingTarget.district( new AntonioBanderas() );
            }
            antonioBanderasDTOToAntonioBanderas( andreiRightHandDTO.getDistrict(), mappingTarget.getDistrict() );
        }
        if ( andreiRightHandDTO.getWard() != null ) {
            if ( mappingTarget.getWard() == null ) {
                mappingTarget.ward( new AntonioBanderas() );
            }
            antonioBanderasDTOToAntonioBanderas( andreiRightHandDTO.getWard(), mappingTarget.getWard() );
        }
    }

    protected AntonioBanderas antonioBanderasDTOToAntonioBanderas1(AntonioBanderasDTO antonioBanderasDTO) {
        if ( antonioBanderasDTO == null ) {
            return null;
        }
        ...
        antonioBanderas.current( antonioBanderasDTOToAntonioBanderas1( antonioBanderasDTO.getCurrent() ) );
        antonioBanderas.parent( antonioBanderasDTOToAntonioBanderas1( antonioBanderasDTO.getParent() ) );

        return antonioBanderas;
    }

    protected AndreiRightHand andreiRightHandDTOToAndreiRightHand1(AndreiRightHandDTO andreiRightHandDTO) {
        if ( andreiRightHandDTO == null ) {
            return null;
        }
        ...
        andreiRightHand.country( antonioBanderasDTOToAntonioBanderas1( andreiRightHandDTO.getCountry() ) );
        andreiRightHand.province( antonioBanderasDTOToAntonioBanderas1( andreiRightHandDTO.getProvince() ) );
        andreiRightHand.district( antonioBanderasDTOToAntonioBanderas1( andreiRightHandDTO.getDistrict() ) );
        andreiRightHand.ward( antonioBanderasDTOToAntonioBanderas1( andreiRightHandDTO.getWard() ) );
    ...
    protected OlMaster olMasterDTOToOlMaster(OlMasterDTO olMasterDTO) {
        ...
        olMaster.address( andreiRightHandDTOToAndreiRightHand1( olMasterDTO.getAddress() ) );
    ...
    protected AlLadyGaga alLadyGagaDTOToAlLadyGaga(AlLadyGagaDTO alLadyGagaDTO) {
        ...
        alLadyGaga.address( andreiRightHandDTOToAndreiRightHand1( alLadyGagaDTO.getAddress() ) );
    ...
    protected void olMasterDTOToOlMaster1(OlMasterDTO olMasterDTO, OlMaster mappingTarget) {
        ...
        if ( olMasterDTO.getAddress() != null ) {
            ...
            andreiRightHandDTOToAndreiRightHand( olMasterDTO.getAddress(), mappingTarget.getAddress() );
        }
    }
    ...
    protected void alAlexTypeDTOToAlAlexType(AlAlexTypeDTO alAlexTypeDTO, AlAlexType mappingTarget) {
    ...
    protected void alAppleDTOToAlApple(AlAppleDTO alAppleDTO, AlApple mappingTarget) {
        if ( alAppleDTO == null ) {
            return;
        }
        ...
        if ( alAppleDTO.getAddress() != null ) {
            ...
            andreiRightHandDTOToAndreiRightHand( alAppleDTO.getAddress(), mappingTarget.getAddress() );
        }
        if ( alAppleDTO.getAgencyType() != null ) {
            if ( mappingTarget.getAgencyType() == null ) {
                mappingTarget.agencyType( new AlAlexType() );
            }
            alAlexTypeDTOToAlAlexType( alAppleDTO.getAgencyType(), mappingTarget.getAgencyType() );
        }
    ...
    protected void alLadyGagaDTOToAlLadyGaga1(AlLadyGagaDTO alLadyGagaDTO, AlLadyGaga mappingTarget) {
        ...
        if ( alLadyGagaDTO.getAddress() != null ) {
            ...
            andreiRightHandDTOToAndreiRightHand( alLadyGagaDTO.getAddress(), mappingTarget.getAddress() );
        }
        if ( alLadyGagaDTO.getAvatar() != null ) {
            if ( mappingTarget.getAvatar() == null ) {
                mappingTarget.avatar( new Metaverse() );
            }
            metaverseDTOToMetaverse( alLadyGagaDTO.getAvatar(), mappingTarget.getAvatar() );
        }
        if ( alLadyGagaDTO.getApplication() != null ) {
            if ( mappingTarget.getApplication() == null ) {
                mappingTarget.application( new JohnLennon() );
            }
            johnLennonDTOToJohnLennon( alLadyGagaDTO.getApplication(), mappingTarget.getApplication() );
        }
    }
    ...
    protected void alProProDTOToAlProPro1(AlProProDTO alProProDTO, AlProPro mappingTarget) {
        ...
        if ( alProProDTO.getAvatar() != null ) {
            ...
            metaverseDTOToMetaverse( alProProDTO.getAvatar(), mappingTarget.getAvatar() );
        }
        if ( alProProDTO.getApplication() != null ) {
            if ( mappingTarget.getApplication() == null ) {
                mappingTarget.application( new JohnLennon() );
            }
            johnLennonDTOToJohnLennon( alProProDTO.getApplication(), mappingTarget.getApplication() );
        }
        if ( mappingTarget.getAmenities() != null ) {
            Set<AlMenity> set = alMenityDTOSetToAlMenitySet( alProProDTO.getAmenities() );
            if ( set != null ) {
                mappingTarget.getAmenities().clear();
                mappingTarget.getAmenities().addAll( set );
            }
        }
        else {
            Set<AlMenity> set = alMenityDTOSetToAlMenitySet( alProProDTO.getAmenities() );
            if ( set != null ) {
                mappingTarget.amenities( set );
            }
        }
        if ( mappingTarget.getImages() != null ) {
            Set<Metaverse> set1 = metaverseDTOSetToMetaverseSet( alProProDTO.getImages() );
            if ( set1 != null ) {
                mappingTarget.getImages().clear();
                mappingTarget.getImages().addAll( set1 );
            }
        }
        else {
            Set<Metaverse> set1 = metaverseDTOSetToMetaverseSet( alProProDTO.getImages() );
            if ( set1 != null ) {
                mappingTarget.images( set1 );
            }
        }
    }
    ...
    protected AlAlexType alAlexTypeDTOToAlAlexType1(AlAlexTypeDTO alAlexTypeDTO) {
        if ( alAlexTypeDTO == null ) {
            return null;
        }
    ...
    protected AlApple alAppleDTOToAlApple1(AlAppleDTO alAppleDTO) {
        if ( alAppleDTO == null ) {
            return null;
        }
        ...
        alApple.address( andreiRightHandDTOToAndreiRightHand1( alAppleDTO.getAddress() ) );
        alApple.agencyType( alAlexTypeDTOToAlAlexType1( alAppleDTO.getAgencyType() ) );
    ...
    protected EdSheeran edSheeranDTOToEdSheeran(EdSheeranDTO edSheeranDTO) {
        ...
        edSheeran.agency( alAppleDTOToAlApple1( edSheeranDTO.getAgency() ) );
