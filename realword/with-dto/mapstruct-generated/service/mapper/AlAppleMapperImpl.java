...
@Generated(
    ...
    date = "2024-10-22T00:23:23+0700",
    comments = "version: 1.6.2, compiler: javac, environment: Java 17.0.11 (Eclipse Adoptium)"
)
@Component
public class AlAppleMapperImpl implements AlAppleMapper {

    @Override
    public AlApple toEntity(AlAppleDTO dto) {
        if ( dto == null ) {
            return null;
        }
        ...
        alApple.setId( dto.getId() );
        alApple.setName( dto.getName() );
        alApple.setDescription( dto.getDescription() );
        alApple.setHotline( dto.getHotline() );
        alApple.setTaxCode( dto.getTaxCode() );
        alApple.setContactsJason( dto.getContactsJason() );
        alApple.setExtensionJason( dto.getExtensionJason() );
        alApple.setIsEnabled( dto.getIsEnabled() );
        alApple.address( andreiRightHandDTOToAndreiRightHand( dto.getAddress() ) );
        alApple.agencyType( alAlexTypeDTOToAlAlexType( dto.getAgencyType() ) );
        alApple.logo( metaverseDTOToMetaverse( dto.getLogo() ) );
        alApple.application( johnLennonDTOToJohnLennon( dto.getApplication() ) );

        return alApple;
    }

    @Override
    public List<AlApple> toEntity(List<AlAppleDTO> dtoList) {
        if ( dtoList == null ) {
            return null;
        }

        List<AlApple> list = new ArrayList<AlApple>( dtoList.size() );
        for ( AlAppleDTO alAppleDTO : dtoList ) {
            list.add( toEntity( alAppleDTO ) );
        }
    ...
    @Override
    public List<AlAppleDTO> toDto(List<AlApple> entityList) {
        if ( entityList == null ) {
            return null;
        }

        List<AlAppleDTO> list = new ArrayList<AlAppleDTO>( entityList.size() );
        for ( AlApple alApple : entityList ) {
            list.add( toDto( alApple ) );
        }
    ...
    @Override
    public void partialUpdate(AlApple entity, AlAppleDTO dto) {
        if ( dto == null ) {
            return;
        }
        ...
        if ( dto.getAgencyType() != null ) {
            if ( entity.getAgencyType() == null ) {
                entity.agencyType( new AlAlexType() );
            }
            alAlexTypeDTOToAlAlexType1( dto.getAgencyType(), entity.getAgencyType() );
        }
        if ( dto.getLogo() != null ) {
    ...
    @Override
    public AlAppleDTO toDto(AlApple s) {
        if ( s == null ) {
            return null;
        }
        ...
        alAppleDTO.setAddress( toDtoAndreiRightHandId( s.getAddress() ) );
        alAppleDTO.setAgencyType( toDtoAlAlexTypeId( s.getAgencyType() ) );
        alAppleDTO.setLogo( toDtoMetaverseId( s.getLogo() ) );
        alAppleDTO.setApplication( toDtoJohnLennonId( s.getApplication() ) );
        alAppleDTO.setId( s.getId() );
        alAppleDTO.setName( s.getName() );
        alAppleDTO.setDescription( s.getDescription() );
        alAppleDTO.setHotline( s.getHotline() );
        alAppleDTO.setTaxCode( s.getTaxCode() );
        alAppleDTO.setContactsJason( s.getContactsJason() );
        alAppleDTO.setExtensionJason( s.getExtensionJason() );
        alAppleDTO.setIsEnabled( s.getIsEnabled() );
    ...
    protected EdSheeran edSheeranDTOToEdSheeran(EdSheeranDTO edSheeranDTO) {
        ...
        edSheeran.agency( toEntity( edSheeranDTO.getAgency() ) );
    ...
    protected AlProty alProtyDTOToAlProty(AlProtyDTO alProtyDTO) {
        ...
        alProty.operator( toEntity( alProtyDTO.getOperator() ) );
