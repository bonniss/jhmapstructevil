...
public class AlPyuJokerService {
     ...
     */
    public Page<AlPyuJoker> findAllWithEagerRelationships(Pageable pageable) {
        return alPyuJokerRepository.findAllWithEagerRelationships(pageable);
    }
    ...
    public Optional<AlPyuJoker> findOne(UUID id) {
        ...
        return alPyuJokerRepository.findOneWithEagerRelationships(id);
    }
