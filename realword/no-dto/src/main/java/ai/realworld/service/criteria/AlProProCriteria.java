...
/**
 * Criteria class for the {@link ai.realworld.domain.AlProPro} entity. This class is used
 * in {@link ai.realworld.web.rest.AlProProResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /al-pro-pros?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlProProCriteria implements Serializable, Criteria {
    ...
    public AlProProCriteria() {}

    public AlProProCriteria(AlProProCriteria other) {
        ...
        this.amenityId = other.optionalAmenityId().map(LongFilter::copy).orElse(null);
    ...
    @Override
    public AlProProCriteria copy() {
        return new AlProProCriteria(this);
    }
    ...
    public LongFilter getAmenityId() {
        return amenityId;
    }

    public Optional<LongFilter> optionalAmenityId() {
        return Optional.ofNullable(amenityId);
    }

    public LongFilter amenityId() {
        if (amenityId == null) {
            setAmenityId(new LongFilter());
        }
        return amenityId;
    }

    public void setAmenityId(LongFilter amenityId) {
    ...
    public boolean equals(Object o) {
        ...
        final AlProProCriteria that = (AlProProCriteria) o;
        return (
    ...
    public String toString() {
        return "AlProProCriteria{" +
            ...
            optionalAmenityId().map(f -> "amenityId=" + f + ", ").orElse("") +
