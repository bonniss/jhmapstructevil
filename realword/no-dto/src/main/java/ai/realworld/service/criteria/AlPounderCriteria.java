...
/**
 * Criteria class for the {@link ai.realworld.domain.AlPounder} entity. This class is used
 * in {@link ai.realworld.web.rest.AlPounderResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /al-pounders?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlPounderCriteria implements Serializable, Criteria {
    ...
    public AlPounderCriteria() {}

    public AlPounderCriteria(AlPounderCriteria other) {
    ...
    @Override
    public AlPounderCriteria copy() {
        return new AlPounderCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final AlPounderCriteria that = (AlPounderCriteria) o;
        return (
