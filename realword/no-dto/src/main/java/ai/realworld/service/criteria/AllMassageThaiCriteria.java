...
/**
 * Criteria class for the {@link ai.realworld.domain.AllMassageThai} entity. This class is used
 * in {@link ai.realworld.web.rest.AllMassageThaiResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /all-massage-thais?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AllMassageThaiCriteria implements Serializable, Criteria {
    ...
    public AllMassageThaiCriteria() {}

    public AllMassageThaiCriteria(AllMassageThaiCriteria other) {
    ...
    @Override
    public AllMassageThaiCriteria copy() {
        return new AllMassageThaiCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final AllMassageThaiCriteria that = (AllMassageThaiCriteria) o;
        return (
