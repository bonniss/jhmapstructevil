...
public class AlProProService {
     ...
     */
    public Page<AlProPro> findAllWithEagerRelationships(Pageable pageable) {
        return alProProRepository.findAllWithEagerRelationships(pageable);
    }
    ...
    public Optional<AlProPro> findOne(UUID id) {
        ...
        return alProProRepository.findOneWithEagerRelationships(id);
    }
