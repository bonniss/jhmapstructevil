...
public class AlProtyService {
     ...
     */
    public Page<AlProty> findAllWithEagerRelationships(Pageable pageable) {
        return alProtyRepository.findAllWithEagerRelationships(pageable);
    }
    ...
    public Optional<AlProty> findOne(UUID id) {
        ...
        return alProtyRepository.findOneWithEagerRelationships(id);
    }
