...
/**
 * Criteria class for the {@link ai.realworld.domain.AlGoogleMeet} entity. This class is used
 * in {@link ai.realworld.web.rest.AlGoogleMeetResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /al-google-meets?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AlGoogleMeetCriteria implements Serializable, Criteria {
    ...
    public AlGoogleMeetCriteria() {}

    public AlGoogleMeetCriteria(AlGoogleMeetCriteria other) {
    ...
    @Override
    public AlGoogleMeetCriteria copy() {
        return new AlGoogleMeetCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final AlGoogleMeetCriteria that = (AlGoogleMeetCriteria) o;
        return (
