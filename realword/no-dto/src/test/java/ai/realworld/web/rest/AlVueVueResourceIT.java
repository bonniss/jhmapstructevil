...
class AlVueVueResourceIT {
    ...
    void createAlVueVue() throws Exception {
        ...
        // Create the AlVueVue
        var returnedAlVueVue = om.readValue(
            restAlVueVueMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alVueVue)))
    ...
    void putExistingAlVueVue() throws Exception {
        ...
        restAlVueVueMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedAlVueVue.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedAlVueVue))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingAlVueVue() throws Exception {
        ...
        restAlVueVueMockMvc
            .perform(
                put(ENTITY_API_URL_ID, alVueVue.getId()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alVueVue))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithIdMismatchAlVueVue() throws Exception {
        ...
        restAlVueVueMockMvc
            .perform(
                put(ENTITY_API_URL_ID, UUID.randomUUID()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alVueVue))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamAlVueVue() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlVueVueMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alVueVue)))
    ...
    void patchNonExistingAlVueVue() throws Exception {
        ...
        restAlVueVueMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, alVueVue.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(alVueVue))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamAlVueVue() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlVueVueMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(alVueVue)))
            .andExpect(status().isMethodNotAllowed());
