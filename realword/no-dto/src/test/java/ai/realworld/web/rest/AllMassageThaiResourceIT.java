...
class AllMassageThaiResourceIT {
    ...
    void createAllMassageThai() throws Exception {
        ...
        var returnedAllMassageThai = om.readValue(
            restAllMassageThaiMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(allMassageThai)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            AllMassageThai.class
        );
    ...
    void putExistingAllMassageThai() throws Exception {
        ...
        restAllMassageThaiMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedAllMassageThai.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedAllMassageThai))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingAllMassageThai() throws Exception {
        ...
        restAllMassageThaiMockMvc
            .perform(
                put(ENTITY_API_URL_ID, allMassageThai.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(allMassageThai))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamAllMassageThai() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAllMassageThaiMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(allMassageThai)))
    ...
    void patchNonExistingAllMassageThai() throws Exception {
        ...
        restAllMassageThaiMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, allMassageThai.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(allMassageThai))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamAllMassageThai() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAllMassageThaiMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(allMassageThai)))
            .andExpect(status().isMethodNotAllowed());
