...
class AntonioBanderasResourceIT {
    ...
    void createAntonioBanderas() throws Exception {
        ...
        var returnedAntonioBanderas = om.readValue(
            restAntonioBanderasMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(antonioBanderas)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            AntonioBanderas.class
        );
    ...
    void putExistingAntonioBanderas() throws Exception {
        ...
        restAntonioBanderasMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedAntonioBanderas.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedAntonioBanderas))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingAntonioBanderas() throws Exception {
        ...
        restAntonioBanderasMockMvc
            .perform(
                put(ENTITY_API_URL_ID, antonioBanderas.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(antonioBanderas))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamAntonioBanderas() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAntonioBanderasMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(antonioBanderas)))
    ...
    void patchNonExistingAntonioBanderas() throws Exception {
        ...
        restAntonioBanderasMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, antonioBanderas.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(antonioBanderas))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamAntonioBanderas() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAntonioBanderasMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(antonioBanderas)))
            .andExpect(status().isMethodNotAllowed());
