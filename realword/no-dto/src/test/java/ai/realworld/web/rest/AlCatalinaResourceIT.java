...
class AlCatalinaResourceIT {
    ...
    void createAlCatalina() throws Exception {
        ...
        var returnedAlCatalina = om.readValue(
            restAlCatalinaMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alCatalina)))
    ...
    void putExistingAlCatalina() throws Exception {
        ...
        restAlCatalinaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedAlCatalina.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedAlCatalina))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingAlCatalina() throws Exception {
        ...
        restAlCatalinaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, alCatalina.getId()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alCatalina))
            )
            .andExpect(status().isBadRequest());
        ...
        restAlCatalinaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, longCount.incrementAndGet())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(alCatalina))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamAlCatalina() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlCatalinaMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(alCatalina)))
    ...
    void patchNonExistingAlCatalina() throws Exception {
        ...
        restAlCatalinaMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, alCatalina.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(alCatalina))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamAlCatalina() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAlCatalinaMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(alCatalina)))
            .andExpect(status().isMethodNotAllowed());
