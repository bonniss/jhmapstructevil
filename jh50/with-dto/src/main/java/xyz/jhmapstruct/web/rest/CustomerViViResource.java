...
public class CustomerViViResource {
    ...
    public CustomerViViResource(CustomerViViService customerViViService, CustomerViViRepository customerViViRepository) {
     ...
     */
    @GetMapping("")
    public List<CustomerViViDTO> getAllCustomerViVis() {
        LOG.debug("REST request to get all CustomerViVis");
        return customerViViService.findAll();
    }
