...
public class CustomerMiMiResource {
    ...
    public CustomerMiMiResource(CustomerMiMiService customerMiMiService, CustomerMiMiRepository customerMiMiRepository) {
     ...
     */
    @GetMapping("")
    public List<CustomerMiMiDTO> getAllCustomerMiMis() {
        LOG.debug("REST request to get all CustomerMiMis");
        return customerMiMiService.findAll();
    }
