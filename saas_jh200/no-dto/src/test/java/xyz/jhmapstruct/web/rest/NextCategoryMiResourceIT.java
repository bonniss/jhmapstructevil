...
class NextCategoryMiResourceIT {
    ...
    void createNextCategoryMi() throws Exception {
        ...
        var returnedNextCategoryMi = om.readValue(
            restNextCategoryMiMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextCategoryMi)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            NextCategoryMi.class
        );
    ...
    void putExistingNextCategoryMi() throws Exception {
        ...
        restNextCategoryMiMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedNextCategoryMi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedNextCategoryMi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingNextCategoryMi() throws Exception {
        ...
        restNextCategoryMiMockMvc
            .perform(
                put(ENTITY_API_URL_ID, nextCategoryMi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(nextCategoryMi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamNextCategoryMi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextCategoryMiMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextCategoryMi)))
    ...
    void patchNonExistingNextCategoryMi() throws Exception {
        ...
        restNextCategoryMiMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, nextCategoryMi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(nextCategoryMi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamNextCategoryMi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextCategoryMiMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(nextCategoryMi)))
            .andExpect(status().isMethodNotAllowed());
