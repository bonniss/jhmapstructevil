...
class NextEmployeeMiMiResourceIT {
    ...
    void createNextEmployeeMiMi() throws Exception {
        ...
        var returnedNextEmployeeMiMi = om.readValue(
            restNextEmployeeMiMiMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextEmployeeMiMi)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            NextEmployeeMiMi.class
        );
    ...
    void putExistingNextEmployeeMiMi() throws Exception {
        ...
        restNextEmployeeMiMiMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedNextEmployeeMiMi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedNextEmployeeMiMi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingNextEmployeeMiMi() throws Exception {
        ...
        restNextEmployeeMiMiMockMvc
            .perform(
                put(ENTITY_API_URL_ID, nextEmployeeMiMi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(nextEmployeeMiMi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamNextEmployeeMiMi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextEmployeeMiMiMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextEmployeeMiMi)))
    ...
    void patchNonExistingNextEmployeeMiMi() throws Exception {
        ...
        restNextEmployeeMiMiMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, nextEmployeeMiMi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(nextEmployeeMiMi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamNextEmployeeMiMi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextEmployeeMiMiMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(nextEmployeeMiMi)))
            .andExpect(status().isMethodNotAllowed());
