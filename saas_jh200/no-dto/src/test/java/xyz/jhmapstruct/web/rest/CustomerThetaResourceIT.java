...
class CustomerThetaResourceIT {
    ...
    void createCustomerTheta() throws Exception {
        ...
        var returnedCustomerTheta = om.readValue(
            restCustomerThetaMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(customerTheta)))
    ...
    void putExistingCustomerTheta() throws Exception {
        ...
        restCustomerThetaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedCustomerTheta.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedCustomerTheta))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingCustomerTheta() throws Exception {
        ...
        restCustomerThetaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, customerTheta.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(customerTheta))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamCustomerTheta() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restCustomerThetaMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(customerTheta)))
    ...
    void patchNonExistingCustomerTheta() throws Exception {
        ...
        restCustomerThetaMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, customerTheta.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(customerTheta))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamCustomerTheta() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restCustomerThetaMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(customerTheta)))
            .andExpect(status().isMethodNotAllowed());
