...
class InvoiceThetaResourceIT {
    ...
    void createInvoiceTheta() throws Exception {
        ...
        var returnedInvoiceTheta = om.readValue(
            restInvoiceThetaMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(invoiceTheta)))
    ...
    void putExistingInvoiceTheta() throws Exception {
        ...
        restInvoiceThetaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedInvoiceTheta.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedInvoiceTheta))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingInvoiceTheta() throws Exception {
        ...
        restInvoiceThetaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, invoiceTheta.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(invoiceTheta))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamInvoiceTheta() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restInvoiceThetaMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(invoiceTheta)))
    ...
    void patchNonExistingInvoiceTheta() throws Exception {
        ...
        restInvoiceThetaMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, invoiceTheta.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(invoiceTheta))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamInvoiceTheta() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restInvoiceThetaMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(invoiceTheta)))
            .andExpect(status().isMethodNotAllowed());
