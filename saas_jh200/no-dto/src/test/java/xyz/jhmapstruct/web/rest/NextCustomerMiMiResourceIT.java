...
class NextCustomerMiMiResourceIT {
    ...
    void createNextCustomerMiMi() throws Exception {
        ...
        var returnedNextCustomerMiMi = om.readValue(
            restNextCustomerMiMiMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextCustomerMiMi)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            NextCustomerMiMi.class
        );
    ...
    void putExistingNextCustomerMiMi() throws Exception {
        ...
        restNextCustomerMiMiMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedNextCustomerMiMi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedNextCustomerMiMi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingNextCustomerMiMi() throws Exception {
        ...
        restNextCustomerMiMiMockMvc
            .perform(
                put(ENTITY_API_URL_ID, nextCustomerMiMi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(nextCustomerMiMi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamNextCustomerMiMi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextCustomerMiMiMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextCustomerMiMi)))
    ...
    void patchNonExistingNextCustomerMiMi() throws Exception {
        ...
        restNextCustomerMiMiMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, nextCustomerMiMi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(nextCustomerMiMi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamNextCustomerMiMi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextCustomerMiMiMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(nextCustomerMiMi)))
            .andExpect(status().isMethodNotAllowed());
