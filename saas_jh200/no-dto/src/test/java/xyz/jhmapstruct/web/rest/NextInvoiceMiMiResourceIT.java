...
class NextInvoiceMiMiResourceIT {
    ...
    void createNextInvoiceMiMi() throws Exception {
        ...
        var returnedNextInvoiceMiMi = om.readValue(
            restNextInvoiceMiMiMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextInvoiceMiMi)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            NextInvoiceMiMi.class
        );
    ...
    void putExistingNextInvoiceMiMi() throws Exception {
        ...
        restNextInvoiceMiMiMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedNextInvoiceMiMi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedNextInvoiceMiMi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingNextInvoiceMiMi() throws Exception {
        ...
        restNextInvoiceMiMiMockMvc
            .perform(
                put(ENTITY_API_URL_ID, nextInvoiceMiMi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(nextInvoiceMiMi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamNextInvoiceMiMi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextInvoiceMiMiMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextInvoiceMiMi)))
    ...
    void patchNonExistingNextInvoiceMiMi() throws Exception {
        ...
        restNextInvoiceMiMiMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, nextInvoiceMiMi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(nextInvoiceMiMi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamNextInvoiceMiMi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextInvoiceMiMiMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(nextInvoiceMiMi)))
            .andExpect(status().isMethodNotAllowed());
