...
class NextSupplierMiMiResourceIT {
    ...
    void createNextSupplierMiMi() throws Exception {
        ...
        var returnedNextSupplierMiMi = om.readValue(
            restNextSupplierMiMiMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextSupplierMiMi)))
    ...
    void putExistingNextSupplierMiMi() throws Exception {
        ...
        restNextSupplierMiMiMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedNextSupplierMiMi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedNextSupplierMiMi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingNextSupplierMiMi() throws Exception {
        ...
        restNextSupplierMiMiMockMvc
            .perform(
                put(ENTITY_API_URL_ID, nextSupplierMiMi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(nextSupplierMiMi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamNextSupplierMiMi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextSupplierMiMiMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextSupplierMiMi)))
    ...
    void patchNonExistingNextSupplierMiMi() throws Exception {
        ...
        restNextSupplierMiMiMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, nextSupplierMiMi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(nextSupplierMiMi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamNextSupplierMiMi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextSupplierMiMiMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(nextSupplierMiMi)))
            .andExpect(status().isMethodNotAllowed());
