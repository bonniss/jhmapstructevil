...
class NextReviewThetaResourceIT {
    ...
    void createNextReviewTheta() throws Exception {
        ...
        var returnedNextReviewTheta = om.readValue(
            restNextReviewThetaMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextReviewTheta)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            NextReviewTheta.class
        );
    ...
    void putExistingNextReviewTheta() throws Exception {
        ...
        restNextReviewThetaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedNextReviewTheta.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedNextReviewTheta))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingNextReviewTheta() throws Exception {
        ...
        restNextReviewThetaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, nextReviewTheta.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(nextReviewTheta))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamNextReviewTheta() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextReviewThetaMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextReviewTheta)))
    ...
    void patchNonExistingNextReviewTheta() throws Exception {
        ...
        restNextReviewThetaMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, nextReviewTheta.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(nextReviewTheta))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamNextReviewTheta() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextReviewThetaMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(nextReviewTheta)))
            .andExpect(status().isMethodNotAllowed());
