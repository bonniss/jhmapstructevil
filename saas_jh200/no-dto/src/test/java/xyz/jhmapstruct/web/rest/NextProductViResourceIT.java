...
class NextProductViResourceIT {
    ...
    void createNextProductVi() throws Exception {
        ...
        var returnedNextProductVi = om.readValue(
            restNextProductViMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextProductVi)))
    ...
    void putExistingNextProductVi() throws Exception {
        ...
        restNextProductViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedNextProductVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedNextProductVi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingNextProductVi() throws Exception {
        ...
        restNextProductViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, nextProductVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(nextProductVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamNextProductVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextProductViMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextProductVi)))
    ...
    void patchNonExistingNextProductVi() throws Exception {
        ...
        restNextProductViMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, nextProductVi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(nextProductVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamNextProductVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextProductViMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(nextProductVi)))
            .andExpect(status().isMethodNotAllowed());
