...
class NextSupplierMiResourceIT {
    ...
    void createNextSupplierMi() throws Exception {
        ...
        var returnedNextSupplierMi = om.readValue(
            restNextSupplierMiMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextSupplierMi)))
    ...
    void putExistingNextSupplierMi() throws Exception {
        ...
        restNextSupplierMiMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedNextSupplierMi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedNextSupplierMi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingNextSupplierMi() throws Exception {
        ...
        restNextSupplierMiMockMvc
            .perform(
                put(ENTITY_API_URL_ID, nextSupplierMi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(nextSupplierMi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamNextSupplierMi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextSupplierMiMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextSupplierMi)))
    ...
    void patchNonExistingNextSupplierMi() throws Exception {
        ...
        restNextSupplierMiMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, nextSupplierMi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(nextSupplierMi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamNextSupplierMi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextSupplierMiMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(nextSupplierMi)))
            .andExpect(status().isMethodNotAllowed());
