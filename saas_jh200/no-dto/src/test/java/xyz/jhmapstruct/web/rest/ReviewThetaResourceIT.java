...
class ReviewThetaResourceIT {
    ...
    void createReviewTheta() throws Exception {
        ...
        var returnedReviewTheta = om.readValue(
            restReviewThetaMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(reviewTheta)))
    ...
    void putExistingReviewTheta() throws Exception {
        ...
        restReviewThetaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedReviewTheta.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedReviewTheta))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingReviewTheta() throws Exception {
        ...
        restReviewThetaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, reviewTheta.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(reviewTheta))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamReviewTheta() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restReviewThetaMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(reviewTheta)))
    ...
    void patchNonExistingReviewTheta() throws Exception {
        ...
        restReviewThetaMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, reviewTheta.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(reviewTheta))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamReviewTheta() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restReviewThetaMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(reviewTheta)))
            .andExpect(status().isMethodNotAllowed());
