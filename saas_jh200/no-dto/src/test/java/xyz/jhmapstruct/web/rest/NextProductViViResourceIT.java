...
class NextProductViViResourceIT {
    ...
    void createNextProductViVi() throws Exception {
        ...
        var returnedNextProductViVi = om.readValue(
            restNextProductViViMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextProductViVi)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            NextProductViVi.class
        );
    ...
    void putExistingNextProductViVi() throws Exception {
        ...
        restNextProductViViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedNextProductViVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedNextProductViVi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingNextProductViVi() throws Exception {
        ...
        restNextProductViViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, nextProductViVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(nextProductViVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamNextProductViVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextProductViViMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextProductViVi)))
    ...
    void patchNonExistingNextProductViVi() throws Exception {
        ...
        restNextProductViViMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, nextProductViVi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(nextProductViVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamNextProductViVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextProductViViMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(nextProductViVi)))
            .andExpect(status().isMethodNotAllowed());
