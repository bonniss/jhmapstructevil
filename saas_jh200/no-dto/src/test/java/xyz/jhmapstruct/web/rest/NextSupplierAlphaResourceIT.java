...
class NextSupplierAlphaResourceIT {
    ...
    void createNextSupplierAlpha() throws Exception {
        ...
        var returnedNextSupplierAlpha = om.readValue(
            restNextSupplierAlphaMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextSupplierAlpha)))
    ...
    void putExistingNextSupplierAlpha() throws Exception {
        ...
        restNextSupplierAlphaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedNextSupplierAlpha.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedNextSupplierAlpha))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingNextSupplierAlpha() throws Exception {
        ...
        restNextSupplierAlphaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, nextSupplierAlpha.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(nextSupplierAlpha))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamNextSupplierAlpha() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextSupplierAlphaMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextSupplierAlpha)))
    ...
    void patchNonExistingNextSupplierAlpha() throws Exception {
        ...
        restNextSupplierAlphaMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, nextSupplierAlpha.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(nextSupplierAlpha))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamNextSupplierAlpha() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextSupplierAlphaMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(nextSupplierAlpha)))
            .andExpect(status().isMethodNotAllowed());
