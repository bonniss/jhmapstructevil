...
class ProductMiMiResourceIT {
    ...
    void createProductMiMi() throws Exception {
        ...
        var returnedProductMiMi = om.readValue(
            restProductMiMiMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(productMiMi)))
    ...
    void putExistingProductMiMi() throws Exception {
        ...
        restProductMiMiMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedProductMiMi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedProductMiMi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingProductMiMi() throws Exception {
        ...
        restProductMiMiMockMvc
            .perform(
                put(ENTITY_API_URL_ID, productMiMi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(productMiMi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamProductMiMi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restProductMiMiMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(productMiMi)))
    ...
    void patchNonExistingProductMiMi() throws Exception {
        ...
        restProductMiMiMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, productMiMi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(productMiMi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamProductMiMi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restProductMiMiMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(productMiMi)))
            .andExpect(status().isMethodNotAllowed());
