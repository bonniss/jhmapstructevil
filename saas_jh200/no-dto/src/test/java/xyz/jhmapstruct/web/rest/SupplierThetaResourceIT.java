...
class SupplierThetaResourceIT {
    ...
    void createSupplierTheta() throws Exception {
        ...
        var returnedSupplierTheta = om.readValue(
            restSupplierThetaMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(supplierTheta)))
    ...
    void putExistingSupplierTheta() throws Exception {
        ...
        restSupplierThetaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedSupplierTheta.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedSupplierTheta))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingSupplierTheta() throws Exception {
        ...
        restSupplierThetaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, supplierTheta.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(supplierTheta))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamSupplierTheta() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restSupplierThetaMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(supplierTheta)))
    ...
    void patchNonExistingSupplierTheta() throws Exception {
        ...
        restSupplierThetaMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, supplierTheta.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(supplierTheta))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamSupplierTheta() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restSupplierThetaMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(supplierTheta)))
            .andExpect(status().isMethodNotAllowed());
