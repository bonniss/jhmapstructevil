...
class NextShipmentViViResourceIT {
    ...
    void createNextShipmentViVi() throws Exception {
        ...
        var returnedNextShipmentViVi = om.readValue(
            restNextShipmentViViMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextShipmentViVi)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            NextShipmentViVi.class
        );
    ...
    void putExistingNextShipmentViVi() throws Exception {
        ...
        restNextShipmentViViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedNextShipmentViVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedNextShipmentViVi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingNextShipmentViVi() throws Exception {
        ...
        restNextShipmentViViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, nextShipmentViVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(nextShipmentViVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamNextShipmentViVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextShipmentViViMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextShipmentViVi)))
    ...
    void patchNonExistingNextShipmentViVi() throws Exception {
        ...
        restNextShipmentViViMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, nextShipmentViVi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(nextShipmentViVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamNextShipmentViVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextShipmentViViMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(nextShipmentViVi)))
            .andExpect(status().isMethodNotAllowed());
