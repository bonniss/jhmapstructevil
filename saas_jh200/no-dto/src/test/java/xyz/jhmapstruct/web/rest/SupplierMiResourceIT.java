...
class SupplierMiResourceIT {
    ...
    void createSupplierMi() throws Exception {
        ...
        var returnedSupplierMi = om.readValue(
            restSupplierMiMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(supplierMi)))
    ...
    void putExistingSupplierMi() throws Exception {
        ...
        restSupplierMiMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedSupplierMi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedSupplierMi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingSupplierMi() throws Exception {
        ...
        restSupplierMiMockMvc
            .perform(
                put(ENTITY_API_URL_ID, supplierMi.getId()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(supplierMi))
            )
            .andExpect(status().isBadRequest());
        ...
        restSupplierMiMockMvc
            .perform(
                put(ENTITY_API_URL_ID, longCount.incrementAndGet())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(supplierMi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamSupplierMi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restSupplierMiMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(supplierMi)))
    ...
    void patchNonExistingSupplierMi() throws Exception {
        ...
        restSupplierMiMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, supplierMi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(supplierMi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamSupplierMi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restSupplierMiMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(supplierMi)))
            .andExpect(status().isMethodNotAllowed());
