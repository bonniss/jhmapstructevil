...
class NextCategoryBetaResourceIT {
    ...
    void createNextCategoryBeta() throws Exception {
        ...
        var returnedNextCategoryBeta = om.readValue(
            restNextCategoryBetaMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextCategoryBeta)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            NextCategoryBeta.class
        );
    ...
    void putExistingNextCategoryBeta() throws Exception {
        ...
        restNextCategoryBetaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedNextCategoryBeta.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedNextCategoryBeta))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingNextCategoryBeta() throws Exception {
        ...
        restNextCategoryBetaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, nextCategoryBeta.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(nextCategoryBeta))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamNextCategoryBeta() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextCategoryBetaMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextCategoryBeta)))
    ...
    void patchNonExistingNextCategoryBeta() throws Exception {
        ...
        restNextCategoryBetaMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, nextCategoryBeta.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(nextCategoryBeta))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamNextCategoryBeta() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextCategoryBetaMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(nextCategoryBeta)))
            .andExpect(status().isMethodNotAllowed());
