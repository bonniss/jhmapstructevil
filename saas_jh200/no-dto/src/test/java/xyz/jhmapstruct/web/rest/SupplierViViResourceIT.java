...
class SupplierViViResourceIT {
    ...
    void createSupplierViVi() throws Exception {
        ...
        var returnedSupplierViVi = om.readValue(
            restSupplierViViMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(supplierViVi)))
    ...
    void putExistingSupplierViVi() throws Exception {
        ...
        restSupplierViViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedSupplierViVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedSupplierViVi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingSupplierViVi() throws Exception {
        ...
        restSupplierViViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, supplierViVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(supplierViVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamSupplierViVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restSupplierViViMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(supplierViVi)))
    ...
    void patchNonExistingSupplierViVi() throws Exception {
        ...
        restSupplierViViMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, supplierViVi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(supplierViVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamSupplierViVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restSupplierViViMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(supplierViVi)))
            .andExpect(status().isMethodNotAllowed());
