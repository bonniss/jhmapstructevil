...
class InvoiceViViResourceIT {
    ...
    void createInvoiceViVi() throws Exception {
        ...
        var returnedInvoiceViVi = om.readValue(
            restInvoiceViViMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(invoiceViVi)))
    ...
    void putExistingInvoiceViVi() throws Exception {
        ...
        restInvoiceViViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedInvoiceViVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedInvoiceViVi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingInvoiceViVi() throws Exception {
        ...
        restInvoiceViViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, invoiceViVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(invoiceViVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamInvoiceViVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restInvoiceViViMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(invoiceViVi)))
    ...
    void patchNonExistingInvoiceViVi() throws Exception {
        ...
        restInvoiceViViMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, invoiceViVi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(invoiceViVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamInvoiceViVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restInvoiceViViMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(invoiceViVi)))
            .andExpect(status().isMethodNotAllowed());
