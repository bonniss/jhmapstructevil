...
class ReviewGammaResourceIT {
    ...
    void createReviewGamma() throws Exception {
        ...
        var returnedReviewGamma = om.readValue(
            restReviewGammaMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(reviewGamma)))
    ...
    void putExistingReviewGamma() throws Exception {
        ...
        restReviewGammaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedReviewGamma.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedReviewGamma))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingReviewGamma() throws Exception {
        ...
        restReviewGammaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, reviewGamma.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(reviewGamma))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamReviewGamma() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restReviewGammaMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(reviewGamma)))
    ...
    void patchNonExistingReviewGamma() throws Exception {
        ...
        restReviewGammaMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, reviewGamma.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(reviewGamma))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamReviewGamma() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restReviewGammaMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(reviewGamma)))
            .andExpect(status().isMethodNotAllowed());
