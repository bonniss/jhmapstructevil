...
class NextReviewViViResourceIT {
    ...
    void createNextReviewViVi() throws Exception {
        ...
        var returnedNextReviewViVi = om.readValue(
            restNextReviewViViMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextReviewViVi)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            NextReviewViVi.class
        );
    ...
    void putExistingNextReviewViVi() throws Exception {
        ...
        restNextReviewViViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedNextReviewViVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedNextReviewViVi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingNextReviewViVi() throws Exception {
        ...
        restNextReviewViViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, nextReviewViVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(nextReviewViVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamNextReviewViVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextReviewViViMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextReviewViVi)))
    ...
    void patchNonExistingNextReviewViVi() throws Exception {
        ...
        restNextReviewViViMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, nextReviewViVi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(nextReviewViVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamNextReviewViVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextReviewViViMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(nextReviewViVi)))
            .andExpect(status().isMethodNotAllowed());
