...
class NextSupplierThetaResourceIT {
    ...
    void createNextSupplierTheta() throws Exception {
        ...
        var returnedNextSupplierTheta = om.readValue(
            restNextSupplierThetaMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextSupplierTheta)))
    ...
    void putExistingNextSupplierTheta() throws Exception {
        ...
        restNextSupplierThetaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedNextSupplierTheta.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedNextSupplierTheta))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingNextSupplierTheta() throws Exception {
        ...
        restNextSupplierThetaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, nextSupplierTheta.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(nextSupplierTheta))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamNextSupplierTheta() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextSupplierThetaMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextSupplierTheta)))
    ...
    void patchNonExistingNextSupplierTheta() throws Exception {
        ...
        restNextSupplierThetaMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, nextSupplierTheta.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(nextSupplierTheta))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamNextSupplierTheta() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextSupplierThetaMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(nextSupplierTheta)))
            .andExpect(status().isMethodNotAllowed());
