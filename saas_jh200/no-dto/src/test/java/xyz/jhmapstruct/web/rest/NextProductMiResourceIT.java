...
class NextProductMiResourceIT {
    ...
    void createNextProductMi() throws Exception {
        ...
        var returnedNextProductMi = om.readValue(
            restNextProductMiMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextProductMi)))
    ...
    void putExistingNextProductMi() throws Exception {
        ...
        restNextProductMiMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedNextProductMi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedNextProductMi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingNextProductMi() throws Exception {
        ...
        restNextProductMiMockMvc
            .perform(
                put(ENTITY_API_URL_ID, nextProductMi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(nextProductMi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamNextProductMi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextProductMiMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextProductMi)))
    ...
    void patchNonExistingNextProductMi() throws Exception {
        ...
        restNextProductMiMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, nextProductMi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(nextProductMi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamNextProductMi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextProductMiMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(nextProductMi)))
            .andExpect(status().isMethodNotAllowed());
