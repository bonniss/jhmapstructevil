...
class CategoryGammaResourceIT {
    ...
    void createCategoryGamma() throws Exception {
        ...
        var returnedCategoryGamma = om.readValue(
            restCategoryGammaMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(categoryGamma)))
    ...
    void putExistingCategoryGamma() throws Exception {
        ...
        restCategoryGammaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedCategoryGamma.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedCategoryGamma))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingCategoryGamma() throws Exception {
        ...
        restCategoryGammaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, categoryGamma.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(categoryGamma))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamCategoryGamma() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restCategoryGammaMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(categoryGamma)))
    ...
    void patchNonExistingCategoryGamma() throws Exception {
        ...
        restCategoryGammaMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, categoryGamma.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(categoryGamma))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamCategoryGamma() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restCategoryGammaMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(categoryGamma)))
            .andExpect(status().isMethodNotAllowed());
