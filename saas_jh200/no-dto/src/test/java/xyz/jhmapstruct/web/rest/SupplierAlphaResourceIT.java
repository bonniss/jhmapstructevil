...
class SupplierAlphaResourceIT {
    ...
    void createSupplierAlpha() throws Exception {
        ...
        var returnedSupplierAlpha = om.readValue(
            restSupplierAlphaMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(supplierAlpha)))
    ...
    void putExistingSupplierAlpha() throws Exception {
        ...
        restSupplierAlphaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedSupplierAlpha.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedSupplierAlpha))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingSupplierAlpha() throws Exception {
        ...
        restSupplierAlphaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, supplierAlpha.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(supplierAlpha))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamSupplierAlpha() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restSupplierAlphaMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(supplierAlpha)))
    ...
    void patchNonExistingSupplierAlpha() throws Exception {
        ...
        restSupplierAlphaMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, supplierAlpha.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(supplierAlpha))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamSupplierAlpha() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restSupplierAlphaMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(supplierAlpha)))
            .andExpect(status().isMethodNotAllowed());
