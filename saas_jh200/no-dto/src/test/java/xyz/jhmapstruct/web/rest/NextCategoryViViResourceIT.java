...
class NextCategoryViViResourceIT {
    ...
    void createNextCategoryViVi() throws Exception {
        ...
        var returnedNextCategoryViVi = om.readValue(
            restNextCategoryViViMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextCategoryViVi)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            NextCategoryViVi.class
        );
    ...
    void putExistingNextCategoryViVi() throws Exception {
        ...
        restNextCategoryViViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedNextCategoryViVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedNextCategoryViVi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingNextCategoryViVi() throws Exception {
        ...
        restNextCategoryViViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, nextCategoryViVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(nextCategoryViVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamNextCategoryViVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextCategoryViViMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextCategoryViVi)))
    ...
    void patchNonExistingNextCategoryViVi() throws Exception {
        ...
        restNextCategoryViViMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, nextCategoryViVi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(nextCategoryViVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamNextCategoryViVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextCategoryViViMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(nextCategoryViVi)))
            .andExpect(status().isMethodNotAllowed());
