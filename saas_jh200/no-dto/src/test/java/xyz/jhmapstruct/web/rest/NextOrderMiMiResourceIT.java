...
class NextOrderMiMiResourceIT {
    ...
    void createNextOrderMiMi() throws Exception {
        ...
        var returnedNextOrderMiMi = om.readValue(
            restNextOrderMiMiMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextOrderMiMi)))
    ...
    void putExistingNextOrderMiMi() throws Exception {
        ...
        restNextOrderMiMiMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedNextOrderMiMi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedNextOrderMiMi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingNextOrderMiMi() throws Exception {
        ...
        restNextOrderMiMiMockMvc
            .perform(
                put(ENTITY_API_URL_ID, nextOrderMiMi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(nextOrderMiMi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamNextOrderMiMi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextOrderMiMiMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextOrderMiMi)))
    ...
    void patchNonExistingNextOrderMiMi() throws Exception {
        ...
        restNextOrderMiMiMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, nextOrderMiMi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(nextOrderMiMi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamNextOrderMiMi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextOrderMiMiMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(nextOrderMiMi)))
            .andExpect(status().isMethodNotAllowed());
