...
class CategoryThetaResourceIT {
    ...
    void createCategoryTheta() throws Exception {
        ...
        var returnedCategoryTheta = om.readValue(
            restCategoryThetaMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(categoryTheta)))
    ...
    void putExistingCategoryTheta() throws Exception {
        ...
        restCategoryThetaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedCategoryTheta.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedCategoryTheta))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingCategoryTheta() throws Exception {
        ...
        restCategoryThetaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, categoryTheta.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(categoryTheta))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamCategoryTheta() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restCategoryThetaMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(categoryTheta)))
    ...
    void patchNonExistingCategoryTheta() throws Exception {
        ...
        restCategoryThetaMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, categoryTheta.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(categoryTheta))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamCategoryTheta() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restCategoryThetaMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(categoryTheta)))
            .andExpect(status().isMethodNotAllowed());
