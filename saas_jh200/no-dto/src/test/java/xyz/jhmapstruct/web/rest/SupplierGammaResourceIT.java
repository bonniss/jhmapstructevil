...
class SupplierGammaResourceIT {
    ...
    void createSupplierGamma() throws Exception {
        ...
        var returnedSupplierGamma = om.readValue(
            restSupplierGammaMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(supplierGamma)))
    ...
    void putExistingSupplierGamma() throws Exception {
        ...
        restSupplierGammaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedSupplierGamma.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedSupplierGamma))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingSupplierGamma() throws Exception {
        ...
        restSupplierGammaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, supplierGamma.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(supplierGamma))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamSupplierGamma() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restSupplierGammaMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(supplierGamma)))
    ...
    void patchNonExistingSupplierGamma() throws Exception {
        ...
        restSupplierGammaMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, supplierGamma.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(supplierGamma))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamSupplierGamma() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restSupplierGammaMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(supplierGamma)))
            .andExpect(status().isMethodNotAllowed());
