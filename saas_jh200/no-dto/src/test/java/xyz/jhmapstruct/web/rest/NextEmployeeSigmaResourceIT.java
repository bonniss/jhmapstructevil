...
class NextEmployeeSigmaResourceIT {
    ...
    void createNextEmployeeSigma() throws Exception {
        ...
        var returnedNextEmployeeSigma = om.readValue(
            restNextEmployeeSigmaMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextEmployeeSigma)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            NextEmployeeSigma.class
        );
    ...
    void putExistingNextEmployeeSigma() throws Exception {
        ...
        restNextEmployeeSigmaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedNextEmployeeSigma.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedNextEmployeeSigma))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingNextEmployeeSigma() throws Exception {
        ...
        restNextEmployeeSigmaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, nextEmployeeSigma.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(nextEmployeeSigma))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamNextEmployeeSigma() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextEmployeeSigmaMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextEmployeeSigma)))
    ...
    void patchNonExistingNextEmployeeSigma() throws Exception {
        ...
        restNextEmployeeSigmaMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, nextEmployeeSigma.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(nextEmployeeSigma))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamNextEmployeeSigma() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextEmployeeSigmaMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(nextEmployeeSigma)))
            .andExpect(status().isMethodNotAllowed());
