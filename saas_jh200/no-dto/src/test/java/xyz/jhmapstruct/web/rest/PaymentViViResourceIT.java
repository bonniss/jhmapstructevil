...
class PaymentViViResourceIT {
    ...
    void createPaymentViVi() throws Exception {
        ...
        var returnedPaymentViVi = om.readValue(
            restPaymentViViMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(paymentViVi)))
    ...
    void putExistingPaymentViVi() throws Exception {
        ...
        restPaymentViViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedPaymentViVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedPaymentViVi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingPaymentViVi() throws Exception {
        ...
        restPaymentViViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, paymentViVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(paymentViVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamPaymentViVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restPaymentViViMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(paymentViVi)))
    ...
    void patchNonExistingPaymentViVi() throws Exception {
        ...
        restPaymentViViMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, paymentViVi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(paymentViVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamPaymentViVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restPaymentViViMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(paymentViVi)))
            .andExpect(status().isMethodNotAllowed());
