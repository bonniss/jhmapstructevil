...
class NextReviewMiResourceIT {
    ...
    void createNextReviewMi() throws Exception {
        ...
        var returnedNextReviewMi = om.readValue(
            restNextReviewMiMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextReviewMi)))
    ...
    void putExistingNextReviewMi() throws Exception {
        ...
        restNextReviewMiMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedNextReviewMi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedNextReviewMi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingNextReviewMi() throws Exception {
        ...
        restNextReviewMiMockMvc
            .perform(
                put(ENTITY_API_URL_ID, nextReviewMi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(nextReviewMi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamNextReviewMi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextReviewMiMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextReviewMi)))
    ...
    void patchNonExistingNextReviewMi() throws Exception {
        ...
        restNextReviewMiMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, nextReviewMi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(nextReviewMi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamNextReviewMi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextReviewMiMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(nextReviewMi)))
            .andExpect(status().isMethodNotAllowed());
