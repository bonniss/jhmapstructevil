...
class EmployeeSigmaResourceIT {
    ...
    void createEmployeeSigma() throws Exception {
        ...
        var returnedEmployeeSigma = om.readValue(
            restEmployeeSigmaMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(employeeSigma)))
    ...
    void putExistingEmployeeSigma() throws Exception {
        ...
        restEmployeeSigmaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedEmployeeSigma.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedEmployeeSigma))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingEmployeeSigma() throws Exception {
        ...
        restEmployeeSigmaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, employeeSigma.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(employeeSigma))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamEmployeeSigma() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restEmployeeSigmaMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(employeeSigma)))
    ...
    void patchNonExistingEmployeeSigma() throws Exception {
        ...
        restEmployeeSigmaMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, employeeSigma.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(employeeSigma))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamEmployeeSigma() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restEmployeeSigmaMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(employeeSigma)))
            .andExpect(status().isMethodNotAllowed());
