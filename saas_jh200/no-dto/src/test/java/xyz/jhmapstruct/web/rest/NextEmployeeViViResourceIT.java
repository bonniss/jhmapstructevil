...
class NextEmployeeViViResourceIT {
    ...
    void createNextEmployeeViVi() throws Exception {
        ...
        var returnedNextEmployeeViVi = om.readValue(
            restNextEmployeeViViMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextEmployeeViVi)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            NextEmployeeViVi.class
        );
    ...
    void putExistingNextEmployeeViVi() throws Exception {
        ...
        restNextEmployeeViViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedNextEmployeeViVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedNextEmployeeViVi))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingNextEmployeeViVi() throws Exception {
        ...
        restNextEmployeeViViMockMvc
            .perform(
                put(ENTITY_API_URL_ID, nextEmployeeViVi.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(nextEmployeeViVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamNextEmployeeViVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextEmployeeViViMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextEmployeeViVi)))
    ...
    void patchNonExistingNextEmployeeViVi() throws Exception {
        ...
        restNextEmployeeViViMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, nextEmployeeViVi.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(nextEmployeeViVi))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamNextEmployeeViVi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextEmployeeViViMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(nextEmployeeViVi)))
            .andExpect(status().isMethodNotAllowed());
