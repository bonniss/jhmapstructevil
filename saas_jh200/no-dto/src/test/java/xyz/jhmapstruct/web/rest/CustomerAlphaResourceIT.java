...
class CustomerAlphaResourceIT {
    ...
    void createCustomerAlpha() throws Exception {
        ...
        var returnedCustomerAlpha = om.readValue(
            restCustomerAlphaMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(customerAlpha)))
    ...
    void putExistingCustomerAlpha() throws Exception {
        ...
        restCustomerAlphaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedCustomerAlpha.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedCustomerAlpha))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingCustomerAlpha() throws Exception {
        ...
        restCustomerAlphaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, customerAlpha.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(customerAlpha))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamCustomerAlpha() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restCustomerAlphaMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(customerAlpha)))
    ...
    void patchNonExistingCustomerAlpha() throws Exception {
        ...
        restCustomerAlphaMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, customerAlpha.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(customerAlpha))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamCustomerAlpha() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restCustomerAlphaMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(customerAlpha)))
            .andExpect(status().isMethodNotAllowed());
