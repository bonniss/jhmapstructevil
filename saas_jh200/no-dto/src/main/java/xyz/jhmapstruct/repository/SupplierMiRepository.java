 ...
 */
@Repository
public interface SupplierMiRepository
    extends SupplierMiRepositoryWithBagRelationships, JpaRepository<SupplierMi, Long>, JpaSpecificationExecutor<SupplierMi> {
