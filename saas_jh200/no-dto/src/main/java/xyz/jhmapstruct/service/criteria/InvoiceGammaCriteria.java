...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.InvoiceGamma} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.InvoiceGammaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /invoice-gammas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class InvoiceGammaCriteria implements Serializable, Criteria {
    ...
    public InvoiceGammaCriteria() {}

    public InvoiceGammaCriteria(InvoiceGammaCriteria other) {
    ...
    @Override
    public InvoiceGammaCriteria copy() {
        return new InvoiceGammaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final InvoiceGammaCriteria that = (InvoiceGammaCriteria) o;
        return (
