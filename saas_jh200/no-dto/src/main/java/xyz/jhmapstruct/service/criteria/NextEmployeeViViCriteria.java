...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextEmployeeViVi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextEmployeeViViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-employee-vi-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextEmployeeViViCriteria implements Serializable, Criteria {
    ...
    public NextEmployeeViViCriteria() {}

    public NextEmployeeViViCriteria(NextEmployeeViViCriteria other) {
    ...
    @Override
    public NextEmployeeViViCriteria copy() {
        return new NextEmployeeViViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextEmployeeViViCriteria that = (NextEmployeeViViCriteria) o;
        return (
    ...
    public String toString() {
        return "NextEmployeeViViCriteria{" +
