...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextShipmentTheta} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextShipmentThetaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-shipment-thetas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextShipmentThetaCriteria implements Serializable, Criteria {
    ...
    public NextShipmentThetaCriteria() {}

    public NextShipmentThetaCriteria(NextShipmentThetaCriteria other) {
    ...
    @Override
    public NextShipmentThetaCriteria copy() {
        return new NextShipmentThetaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextShipmentThetaCriteria that = (NextShipmentThetaCriteria) o;
        return (
    ...
    public String toString() {
        return "NextShipmentThetaCriteria{" +
