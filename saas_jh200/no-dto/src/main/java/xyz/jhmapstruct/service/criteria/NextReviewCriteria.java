...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextReview} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextReviewResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-reviews?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextReviewCriteria implements Serializable, Criteria {
    ...
    public NextReviewCriteria() {}

    public NextReviewCriteria(NextReviewCriteria other) {
    ...
    @Override
    public NextReviewCriteria copy() {
        return new NextReviewCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextReviewCriteria that = (NextReviewCriteria) o;
        return (
