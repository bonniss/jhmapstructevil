...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextReviewSigma} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextReviewSigmaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-review-sigmas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextReviewSigmaCriteria implements Serializable, Criteria {
    ...
    public NextReviewSigmaCriteria() {}

    public NextReviewSigmaCriteria(NextReviewSigmaCriteria other) {
    ...
    @Override
    public NextReviewSigmaCriteria copy() {
        return new NextReviewSigmaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextReviewSigmaCriteria that = (NextReviewSigmaCriteria) o;
        return (
    ...
    public String toString() {
        return "NextReviewSigmaCriteria{" +
