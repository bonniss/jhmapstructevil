...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextSupplierGamma} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextSupplierGammaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-supplier-gammas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextSupplierGammaCriteria implements Serializable, Criteria {
    ...
    public NextSupplierGammaCriteria() {}

    public NextSupplierGammaCriteria(NextSupplierGammaCriteria other) {
    ...
    @Override
    public NextSupplierGammaCriteria copy() {
        return new NextSupplierGammaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextSupplierGammaCriteria that = (NextSupplierGammaCriteria) o;
        return (
    ...
    public String toString() {
        return "NextSupplierGammaCriteria{" +
