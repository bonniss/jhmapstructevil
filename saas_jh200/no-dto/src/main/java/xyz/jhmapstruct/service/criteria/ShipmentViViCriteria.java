...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.ShipmentViVi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.ShipmentViViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /shipment-vi-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ShipmentViViCriteria implements Serializable, Criteria {
    ...
    public ShipmentViViCriteria() {}

    public ShipmentViViCriteria(ShipmentViViCriteria other) {
    ...
    @Override
    public ShipmentViViCriteria copy() {
        return new ShipmentViViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ShipmentViViCriteria that = (ShipmentViViCriteria) o;
        return (
