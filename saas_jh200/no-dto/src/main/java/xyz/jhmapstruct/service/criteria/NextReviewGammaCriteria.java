...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextReviewGamma} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextReviewGammaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-review-gammas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextReviewGammaCriteria implements Serializable, Criteria {
    ...
    public NextReviewGammaCriteria() {}

    public NextReviewGammaCriteria(NextReviewGammaCriteria other) {
    ...
    @Override
    public NextReviewGammaCriteria copy() {
        return new NextReviewGammaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextReviewGammaCriteria that = (NextReviewGammaCriteria) o;
        return (
    ...
    public String toString() {
        return "NextReviewGammaCriteria{" +
