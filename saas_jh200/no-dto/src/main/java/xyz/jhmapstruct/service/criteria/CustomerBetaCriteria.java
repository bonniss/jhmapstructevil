...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.CustomerBeta} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.CustomerBetaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /customer-betas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class CustomerBetaCriteria implements Serializable, Criteria {
    ...
    public CustomerBetaCriteria() {}

    public CustomerBetaCriteria(CustomerBetaCriteria other) {
    ...
    @Override
    public CustomerBetaCriteria copy() {
        return new CustomerBetaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CustomerBetaCriteria that = (CustomerBetaCriteria) o;
        return (
