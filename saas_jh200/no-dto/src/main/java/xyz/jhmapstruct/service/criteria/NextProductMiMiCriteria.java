...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextProductMiMi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextProductMiMiResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-product-mi-mis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextProductMiMiCriteria implements Serializable, Criteria {
    ...
    public NextProductMiMiCriteria() {}

    public NextProductMiMiCriteria(NextProductMiMiCriteria other) {
    ...
    @Override
    public NextProductMiMiCriteria copy() {
        return new NextProductMiMiCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextProductMiMiCriteria that = (NextProductMiMiCriteria) o;
        return (
    ...
    public String toString() {
        return "NextProductMiMiCriteria{" +
