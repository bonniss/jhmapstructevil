...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextSupplierAlpha} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextSupplierAlphaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-supplier-alphas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextSupplierAlphaCriteria implements Serializable, Criteria {
    ...
    public NextSupplierAlphaCriteria() {}

    public NextSupplierAlphaCriteria(NextSupplierAlphaCriteria other) {
    ...
    @Override
    public NextSupplierAlphaCriteria copy() {
        return new NextSupplierAlphaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextSupplierAlphaCriteria that = (NextSupplierAlphaCriteria) o;
        return (
    ...
    public String toString() {
        return "NextSupplierAlphaCriteria{" +
