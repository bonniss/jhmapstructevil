...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.ReviewTheta} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.ReviewThetaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /review-thetas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ReviewThetaCriteria implements Serializable, Criteria {
    ...
    public ReviewThetaCriteria() {}

    public ReviewThetaCriteria(ReviewThetaCriteria other) {
    ...
    @Override
    public ReviewThetaCriteria copy() {
        return new ReviewThetaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ReviewThetaCriteria that = (ReviewThetaCriteria) o;
        return (
