...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextShipmentViVi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextShipmentViViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-shipment-vi-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextShipmentViViCriteria implements Serializable, Criteria {
    ...
    public NextShipmentViViCriteria() {}

    public NextShipmentViViCriteria(NextShipmentViViCriteria other) {
    ...
    @Override
    public NextShipmentViViCriteria copy() {
        return new NextShipmentViViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextShipmentViViCriteria that = (NextShipmentViViCriteria) o;
        return (
    ...
    public String toString() {
        return "NextShipmentViViCriteria{" +
