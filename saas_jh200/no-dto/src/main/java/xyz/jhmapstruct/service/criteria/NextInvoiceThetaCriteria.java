...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextInvoiceTheta} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextInvoiceThetaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-invoice-thetas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextInvoiceThetaCriteria implements Serializable, Criteria {
    ...
    public NextInvoiceThetaCriteria() {}

    public NextInvoiceThetaCriteria(NextInvoiceThetaCriteria other) {
    ...
    @Override
    public NextInvoiceThetaCriteria copy() {
        return new NextInvoiceThetaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextInvoiceThetaCriteria that = (NextInvoiceThetaCriteria) o;
        return (
    ...
    public String toString() {
        return "NextInvoiceThetaCriteria{" +
