...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.ReviewGamma} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.ReviewGammaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /review-gammas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ReviewGammaCriteria implements Serializable, Criteria {
    ...
    public ReviewGammaCriteria() {}

    public ReviewGammaCriteria(ReviewGammaCriteria other) {
    ...
    @Override
    public ReviewGammaCriteria copy() {
        return new ReviewGammaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ReviewGammaCriteria that = (ReviewGammaCriteria) o;
        return (
