...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.ShipmentVi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.ShipmentViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /shipment-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ShipmentViCriteria implements Serializable, Criteria {
    ...
    public ShipmentViCriteria() {}

    public ShipmentViCriteria(ShipmentViCriteria other) {
    ...
    @Override
    public ShipmentViCriteria copy() {
        return new ShipmentViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ShipmentViCriteria that = (ShipmentViCriteria) o;
        return (
