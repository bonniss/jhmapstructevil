...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.ProductVi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.ProductViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /product-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ProductViCriteria implements Serializable, Criteria {
    ...
    public ProductViCriteria() {}

    public ProductViCriteria(ProductViCriteria other) {
    ...
    @Override
    public ProductViCriteria copy() {
        return new ProductViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ProductViCriteria that = (ProductViCriteria) o;
        return (
