...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.SupplierBeta} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.SupplierBetaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /supplier-betas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class SupplierBetaCriteria implements Serializable, Criteria {
    ...
    public SupplierBetaCriteria() {}

    public SupplierBetaCriteria(SupplierBetaCriteria other) {
    ...
    @Override
    public SupplierBetaCriteria copy() {
        return new SupplierBetaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final SupplierBetaCriteria that = (SupplierBetaCriteria) o;
        return (
