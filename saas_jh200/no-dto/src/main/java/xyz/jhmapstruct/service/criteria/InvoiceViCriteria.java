...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.InvoiceVi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.InvoiceViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /invoice-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class InvoiceViCriteria implements Serializable, Criteria {
    ...
    public InvoiceViCriteria() {}

    public InvoiceViCriteria(InvoiceViCriteria other) {
    ...
    @Override
    public InvoiceViCriteria copy() {
        return new InvoiceViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final InvoiceViCriteria that = (InvoiceViCriteria) o;
        return (
