...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.InvoiceMi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.InvoiceMiResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /invoice-mis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class InvoiceMiCriteria implements Serializable, Criteria {
    ...
    public InvoiceMiCriteria() {}

    public InvoiceMiCriteria(InvoiceMiCriteria other) {
    ...
    @Override
    public InvoiceMiCriteria copy() {
        return new InvoiceMiCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final InvoiceMiCriteria that = (InvoiceMiCriteria) o;
        return (
