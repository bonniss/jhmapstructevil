...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextSupplierBeta} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextSupplierBetaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-supplier-betas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextSupplierBetaCriteria implements Serializable, Criteria {
    ...
    public NextSupplierBetaCriteria() {}

    public NextSupplierBetaCriteria(NextSupplierBetaCriteria other) {
    ...
    @Override
    public NextSupplierBetaCriteria copy() {
        return new NextSupplierBetaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextSupplierBetaCriteria that = (NextSupplierBetaCriteria) o;
        return (
    ...
    public String toString() {
        return "NextSupplierBetaCriteria{" +
