...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextOrderViVi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextOrderViViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-order-vi-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextOrderViViCriteria implements Serializable, Criteria {

    /**
     * Class for filtering OrderViViStatus
     */
    public static class OrderViViStatusFilter extends Filter<OrderViViStatus> {

        public OrderViViStatusFilter() {}

        public OrderViViStatusFilter(OrderViViStatusFilter filter) {
            super(filter);
        }

        @Override
        public OrderViViStatusFilter copy() {
            return new OrderViViStatusFilter(this);
        }
    }
    ...
    private OrderViViStatusFilter status;
    ...
    public NextOrderViViCriteria() {}

    public NextOrderViViCriteria(NextOrderViViCriteria other) {
        ...
        this.status = other.optionalStatus().map(OrderViViStatusFilter::copy).orElse(null);
    ...
    @Override
    public NextOrderViViCriteria copy() {
        return new NextOrderViViCriteria(this);
    }
    ...
    public OrderViViStatusFilter getStatus() {
        return status;
    }

    public Optional<OrderViViStatusFilter> optionalStatus() {
        return Optional.ofNullable(status);
    }

    public OrderViViStatusFilter status() {
        if (status == null) {
            setStatus(new OrderViViStatusFilter());
        }
        return status;
    }

    public void setStatus(OrderViViStatusFilter status) {
        this.status = status;
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextOrderViViCriteria that = (NextOrderViViCriteria) o;
        return (
