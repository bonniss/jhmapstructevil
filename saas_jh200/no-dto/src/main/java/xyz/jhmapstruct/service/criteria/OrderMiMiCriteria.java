...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.OrderMiMi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.OrderMiMiResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /order-mi-mis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class OrderMiMiCriteria implements Serializable, Criteria {
    ...
    public OrderMiMiCriteria() {}

    public OrderMiMiCriteria(OrderMiMiCriteria other) {
    ...
    @Override
    public OrderMiMiCriteria copy() {
        return new OrderMiMiCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final OrderMiMiCriteria that = (OrderMiMiCriteria) o;
        return (
