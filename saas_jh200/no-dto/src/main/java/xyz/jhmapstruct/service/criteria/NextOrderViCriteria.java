...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextOrderVi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextOrderViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-order-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextOrderViCriteria implements Serializable, Criteria {

    /**
     * Class for filtering OrderViStatus
     */
    public static class OrderViStatusFilter extends Filter<OrderViStatus> {

        public OrderViStatusFilter() {}

        public OrderViStatusFilter(OrderViStatusFilter filter) {
            super(filter);
        }

        @Override
        public OrderViStatusFilter copy() {
            return new OrderViStatusFilter(this);
        }
    }
    ...
    private OrderViStatusFilter status;
    ...
    public NextOrderViCriteria() {}

    public NextOrderViCriteria(NextOrderViCriteria other) {
        ...
        this.status = other.optionalStatus().map(OrderViStatusFilter::copy).orElse(null);
    ...
    @Override
    public NextOrderViCriteria copy() {
        return new NextOrderViCriteria(this);
    }
    ...
    public OrderViStatusFilter getStatus() {
        return status;
    }

    public Optional<OrderViStatusFilter> optionalStatus() {
        return Optional.ofNullable(status);
    }

    public OrderViStatusFilter status() {
        if (status == null) {
            setStatus(new OrderViStatusFilter());
        }
        return status;
    }

    public void setStatus(OrderViStatusFilter status) {
        this.status = status;
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextOrderViCriteria that = (NextOrderViCriteria) o;
        return (
