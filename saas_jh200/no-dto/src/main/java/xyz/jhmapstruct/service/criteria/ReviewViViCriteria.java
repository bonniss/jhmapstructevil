...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.ReviewViVi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.ReviewViViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /review-vi-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ReviewViViCriteria implements Serializable, Criteria {
    ...
    public ReviewViViCriteria() {}

    public ReviewViViCriteria(ReviewViViCriteria other) {
    ...
    @Override
    public ReviewViViCriteria copy() {
        return new ReviewViViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ReviewViViCriteria that = (ReviewViViCriteria) o;
        return (
