...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextProductAlpha} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextProductAlphaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-product-alphas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextProductAlphaCriteria implements Serializable, Criteria {
    ...
    public NextProductAlphaCriteria() {}

    public NextProductAlphaCriteria(NextProductAlphaCriteria other) {
    ...
    @Override
    public NextProductAlphaCriteria copy() {
        return new NextProductAlphaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextProductAlphaCriteria that = (NextProductAlphaCriteria) o;
        return (
    ...
    public String toString() {
        return "NextProductAlphaCriteria{" +
