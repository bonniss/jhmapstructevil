...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.OrderViVi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.OrderViViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /order-vi-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class OrderViViCriteria implements Serializable, Criteria {
    ...
    public OrderViViCriteria() {}

    public OrderViViCriteria(OrderViViCriteria other) {
    ...
    @Override
    public OrderViViCriteria copy() {
        return new OrderViViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final OrderViViCriteria that = (OrderViViCriteria) o;
        return (
