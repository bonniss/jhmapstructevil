...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextEmployeeMi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextEmployeeMiResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-employee-mis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextEmployeeMiCriteria implements Serializable, Criteria {
    ...
    public NextEmployeeMiCriteria() {}

    public NextEmployeeMiCriteria(NextEmployeeMiCriteria other) {
    ...
    @Override
    public NextEmployeeMiCriteria copy() {
        return new NextEmployeeMiCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextEmployeeMiCriteria that = (NextEmployeeMiCriteria) o;
        return (
