...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextCustomerGamma} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextCustomerGammaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-customer-gammas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextCustomerGammaCriteria implements Serializable, Criteria {
    ...
    public NextCustomerGammaCriteria() {}

    public NextCustomerGammaCriteria(NextCustomerGammaCriteria other) {
    ...
    @Override
    public NextCustomerGammaCriteria copy() {
        return new NextCustomerGammaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextCustomerGammaCriteria that = (NextCustomerGammaCriteria) o;
        return (
    ...
    public String toString() {
        return "NextCustomerGammaCriteria{" +
