...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.EmployeeViVi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.EmployeeViViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /employee-vi-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class EmployeeViViCriteria implements Serializable, Criteria {
    ...
    public EmployeeViViCriteria() {}

    public EmployeeViViCriteria(EmployeeViViCriteria other) {
    ...
    @Override
    public EmployeeViViCriteria copy() {
        return new EmployeeViViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final EmployeeViViCriteria that = (EmployeeViViCriteria) o;
        return (
