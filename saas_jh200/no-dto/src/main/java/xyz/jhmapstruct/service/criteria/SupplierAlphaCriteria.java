...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.SupplierAlpha} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.SupplierAlphaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /supplier-alphas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class SupplierAlphaCriteria implements Serializable, Criteria {
    ...
    public SupplierAlphaCriteria() {}

    public SupplierAlphaCriteria(SupplierAlphaCriteria other) {
    ...
    @Override
    public SupplierAlphaCriteria copy() {
        return new SupplierAlphaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final SupplierAlphaCriteria that = (SupplierAlphaCriteria) o;
        return (
