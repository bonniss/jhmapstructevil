...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextInvoiceMi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextInvoiceMiResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-invoice-mis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextInvoiceMiCriteria implements Serializable, Criteria {
    ...
    public NextInvoiceMiCriteria() {}

    public NextInvoiceMiCriteria(NextInvoiceMiCriteria other) {
    ...
    @Override
    public NextInvoiceMiCriteria copy() {
        return new NextInvoiceMiCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextInvoiceMiCriteria that = (NextInvoiceMiCriteria) o;
        return (
