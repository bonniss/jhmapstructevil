...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.EmployeeBeta} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.EmployeeBetaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /employee-betas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class EmployeeBetaCriteria implements Serializable, Criteria {
    ...
    public EmployeeBetaCriteria() {}

    public EmployeeBetaCriteria(EmployeeBetaCriteria other) {
    ...
    @Override
    public EmployeeBetaCriteria copy() {
        return new EmployeeBetaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final EmployeeBetaCriteria that = (EmployeeBetaCriteria) o;
        return (
