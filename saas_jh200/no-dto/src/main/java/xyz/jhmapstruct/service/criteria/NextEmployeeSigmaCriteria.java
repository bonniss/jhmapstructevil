...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextEmployeeSigma} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextEmployeeSigmaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-employee-sigmas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextEmployeeSigmaCriteria implements Serializable, Criteria {
    ...
    public NextEmployeeSigmaCriteria() {}

    public NextEmployeeSigmaCriteria(NextEmployeeSigmaCriteria other) {
    ...
    @Override
    public NextEmployeeSigmaCriteria copy() {
        return new NextEmployeeSigmaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextEmployeeSigmaCriteria that = (NextEmployeeSigmaCriteria) o;
        return (
    ...
    public String toString() {
        return "NextEmployeeSigmaCriteria{" +
