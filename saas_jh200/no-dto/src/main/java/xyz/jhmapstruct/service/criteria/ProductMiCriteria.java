...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.ProductMi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.ProductMiResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /product-mis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ProductMiCriteria implements Serializable, Criteria {
    ...
    public ProductMiCriteria() {}

    public ProductMiCriteria(ProductMiCriteria other) {
    ...
    @Override
    public ProductMiCriteria copy() {
        return new ProductMiCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ProductMiCriteria that = (ProductMiCriteria) o;
        return (
