...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextCustomerBeta} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextCustomerBetaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-customer-betas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextCustomerBetaCriteria implements Serializable, Criteria {
    ...
    public NextCustomerBetaCriteria() {}

    public NextCustomerBetaCriteria(NextCustomerBetaCriteria other) {
    ...
    @Override
    public NextCustomerBetaCriteria copy() {
        return new NextCustomerBetaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextCustomerBetaCriteria that = (NextCustomerBetaCriteria) o;
        return (
    ...
    public String toString() {
        return "NextCustomerBetaCriteria{" +
