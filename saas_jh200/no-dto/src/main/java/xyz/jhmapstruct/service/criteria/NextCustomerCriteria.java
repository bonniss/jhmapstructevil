...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextCustomer} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextCustomerResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-customers?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextCustomerCriteria implements Serializable, Criteria {
    ...
    public NextCustomerCriteria() {}

    public NextCustomerCriteria(NextCustomerCriteria other) {
    ...
    @Override
    public NextCustomerCriteria copy() {
        return new NextCustomerCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextCustomerCriteria that = (NextCustomerCriteria) o;
        return (
