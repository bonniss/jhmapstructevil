...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.SupplierMiMi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.SupplierMiMiResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /supplier-mi-mis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class SupplierMiMiCriteria implements Serializable, Criteria {
    ...
    public SupplierMiMiCriteria() {}

    public SupplierMiMiCriteria(SupplierMiMiCriteria other) {
    ...
    @Override
    public SupplierMiMiCriteria copy() {
        return new SupplierMiMiCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final SupplierMiMiCriteria that = (SupplierMiMiCriteria) o;
        return (
