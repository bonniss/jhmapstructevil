...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.CustomerSigma} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.CustomerSigmaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /customer-sigmas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class CustomerSigmaCriteria implements Serializable, Criteria {
    ...
    public CustomerSigmaCriteria() {}

    public CustomerSigmaCriteria(CustomerSigmaCriteria other) {
    ...
    @Override
    public CustomerSigmaCriteria copy() {
        return new CustomerSigmaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CustomerSigmaCriteria that = (CustomerSigmaCriteria) o;
        return (
