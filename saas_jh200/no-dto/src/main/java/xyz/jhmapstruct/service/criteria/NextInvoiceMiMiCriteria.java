...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextInvoiceMiMi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextInvoiceMiMiResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-invoice-mi-mis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextInvoiceMiMiCriteria implements Serializable, Criteria {
    ...
    public NextInvoiceMiMiCriteria() {}

    public NextInvoiceMiMiCriteria(NextInvoiceMiMiCriteria other) {
    ...
    @Override
    public NextInvoiceMiMiCriteria copy() {
        return new NextInvoiceMiMiCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextInvoiceMiMiCriteria that = (NextInvoiceMiMiCriteria) o;
        return (
    ...
    public String toString() {
        return "NextInvoiceMiMiCriteria{" +
