...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.ProductAlpha} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.ProductAlphaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /product-alphas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ProductAlphaCriteria implements Serializable, Criteria {
    ...
    public ProductAlphaCriteria() {}

    public ProductAlphaCriteria(ProductAlphaCriteria other) {
    ...
    @Override
    public ProductAlphaCriteria copy() {
        return new ProductAlphaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ProductAlphaCriteria that = (ProductAlphaCriteria) o;
        return (
