...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.CustomerGamma} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.CustomerGammaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /customer-gammas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class CustomerGammaCriteria implements Serializable, Criteria {
    ...
    public CustomerGammaCriteria() {}

    public CustomerGammaCriteria(CustomerGammaCriteria other) {
    ...
    @Override
    public CustomerGammaCriteria copy() {
        return new CustomerGammaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CustomerGammaCriteria that = (CustomerGammaCriteria) o;
        return (
