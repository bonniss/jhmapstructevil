...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextShipment} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextShipmentResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-shipments?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextShipmentCriteria implements Serializable, Criteria {
    ...
    public NextShipmentCriteria() {}

    public NextShipmentCriteria(NextShipmentCriteria other) {
    ...
    @Override
    public NextShipmentCriteria copy() {
        return new NextShipmentCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextShipmentCriteria that = (NextShipmentCriteria) o;
        return (
