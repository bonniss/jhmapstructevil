...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.InvoiceTheta} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.InvoiceThetaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /invoice-thetas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class InvoiceThetaCriteria implements Serializable, Criteria {
    ...
    public InvoiceThetaCriteria() {}

    public InvoiceThetaCriteria(InvoiceThetaCriteria other) {
    ...
    @Override
    public InvoiceThetaCriteria copy() {
        return new InvoiceThetaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final InvoiceThetaCriteria that = (InvoiceThetaCriteria) o;
        return (
