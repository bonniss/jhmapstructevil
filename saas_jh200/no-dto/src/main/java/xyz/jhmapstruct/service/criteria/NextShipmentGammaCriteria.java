...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextShipmentGamma} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextShipmentGammaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-shipment-gammas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextShipmentGammaCriteria implements Serializable, Criteria {
    ...
    public NextShipmentGammaCriteria() {}

    public NextShipmentGammaCriteria(NextShipmentGammaCriteria other) {
    ...
    @Override
    public NextShipmentGammaCriteria copy() {
        return new NextShipmentGammaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextShipmentGammaCriteria that = (NextShipmentGammaCriteria) o;
        return (
    ...
    public String toString() {
        return "NextShipmentGammaCriteria{" +
