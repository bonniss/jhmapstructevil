...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.CustomerAlpha} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.CustomerAlphaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /customer-alphas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class CustomerAlphaCriteria implements Serializable, Criteria {
    ...
    public CustomerAlphaCriteria() {}

    public CustomerAlphaCriteria(CustomerAlphaCriteria other) {
    ...
    @Override
    public CustomerAlphaCriteria copy() {
        return new CustomerAlphaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CustomerAlphaCriteria that = (CustomerAlphaCriteria) o;
        return (
