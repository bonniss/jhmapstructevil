...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.SupplierGamma} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.SupplierGammaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /supplier-gammas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class SupplierGammaCriteria implements Serializable, Criteria {
    ...
    public SupplierGammaCriteria() {}

    public SupplierGammaCriteria(SupplierGammaCriteria other) {
    ...
    @Override
    public SupplierGammaCriteria copy() {
        return new SupplierGammaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final SupplierGammaCriteria that = (SupplierGammaCriteria) o;
        return (
