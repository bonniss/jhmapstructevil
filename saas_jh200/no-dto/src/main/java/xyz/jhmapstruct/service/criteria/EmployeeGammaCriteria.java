...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.EmployeeGamma} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.EmployeeGammaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /employee-gammas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class EmployeeGammaCriteria implements Serializable, Criteria {
    ...
    public EmployeeGammaCriteria() {}

    public EmployeeGammaCriteria(EmployeeGammaCriteria other) {
    ...
    @Override
    public EmployeeGammaCriteria copy() {
        return new EmployeeGammaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final EmployeeGammaCriteria that = (EmployeeGammaCriteria) o;
        return (
