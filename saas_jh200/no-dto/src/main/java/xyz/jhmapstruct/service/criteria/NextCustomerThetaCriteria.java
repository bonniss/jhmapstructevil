...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextCustomerTheta} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextCustomerThetaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-customer-thetas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextCustomerThetaCriteria implements Serializable, Criteria {
    ...
    public NextCustomerThetaCriteria() {}

    public NextCustomerThetaCriteria(NextCustomerThetaCriteria other) {
    ...
    @Override
    public NextCustomerThetaCriteria copy() {
        return new NextCustomerThetaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextCustomerThetaCriteria that = (NextCustomerThetaCriteria) o;
        return (
    ...
    public String toString() {
        return "NextCustomerThetaCriteria{" +
