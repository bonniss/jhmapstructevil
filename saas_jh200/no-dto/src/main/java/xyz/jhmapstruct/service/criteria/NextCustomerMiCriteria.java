...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextCustomerMi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextCustomerMiResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-customer-mis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextCustomerMiCriteria implements Serializable, Criteria {
    ...
    public NextCustomerMiCriteria() {}

    public NextCustomerMiCriteria(NextCustomerMiCriteria other) {
    ...
    @Override
    public NextCustomerMiCriteria copy() {
        return new NextCustomerMiCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextCustomerMiCriteria that = (NextCustomerMiCriteria) o;
        return (
