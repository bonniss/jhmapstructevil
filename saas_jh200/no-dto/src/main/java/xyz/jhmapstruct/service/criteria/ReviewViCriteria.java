...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.ReviewVi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.ReviewViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /review-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ReviewViCriteria implements Serializable, Criteria {
    ...
    public ReviewViCriteria() {}

    public ReviewViCriteria(ReviewViCriteria other) {
    ...
    @Override
    public ReviewViCriteria copy() {
        return new ReviewViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ReviewViCriteria that = (ReviewViCriteria) o;
        return (
