...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextInvoiceGamma} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextInvoiceGammaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-invoice-gammas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextInvoiceGammaCriteria implements Serializable, Criteria {
    ...
    public NextInvoiceGammaCriteria() {}

    public NextInvoiceGammaCriteria(NextInvoiceGammaCriteria other) {
    ...
    @Override
    public NextInvoiceGammaCriteria copy() {
        return new NextInvoiceGammaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextInvoiceGammaCriteria that = (NextInvoiceGammaCriteria) o;
        return (
    ...
    public String toString() {
        return "NextInvoiceGammaCriteria{" +
