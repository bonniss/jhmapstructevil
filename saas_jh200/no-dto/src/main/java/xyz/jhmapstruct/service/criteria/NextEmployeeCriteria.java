...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextEmployee} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextEmployeeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-employees?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextEmployeeCriteria implements Serializable, Criteria {
    ...
    public NextEmployeeCriteria() {}

    public NextEmployeeCriteria(NextEmployeeCriteria other) {
    ...
    @Override
    public NextEmployeeCriteria copy() {
        return new NextEmployeeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextEmployeeCriteria that = (NextEmployeeCriteria) o;
        return (
