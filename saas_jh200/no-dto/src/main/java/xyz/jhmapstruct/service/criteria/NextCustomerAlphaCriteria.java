...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextCustomerAlpha} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextCustomerAlphaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-customer-alphas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextCustomerAlphaCriteria implements Serializable, Criteria {
    ...
    public NextCustomerAlphaCriteria() {}

    public NextCustomerAlphaCriteria(NextCustomerAlphaCriteria other) {
    ...
    @Override
    public NextCustomerAlphaCriteria copy() {
        return new NextCustomerAlphaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextCustomerAlphaCriteria that = (NextCustomerAlphaCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, firstName, lastName, email, phoneNumber, ordersId, tenantId, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "NextCustomerAlphaCriteria{" +
