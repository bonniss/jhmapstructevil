...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.OrderTheta} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.OrderThetaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /order-thetas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class OrderThetaCriteria implements Serializable, Criteria {
    ...
    public OrderThetaCriteria() {}

    public OrderThetaCriteria(OrderThetaCriteria other) {
    ...
    @Override
    public OrderThetaCriteria copy() {
        return new OrderThetaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final OrderThetaCriteria that = (OrderThetaCriteria) o;
        return (
