...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextCustomerSigma} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextCustomerSigmaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-customer-sigmas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextCustomerSigmaCriteria implements Serializable, Criteria {
    ...
    public NextCustomerSigmaCriteria() {}

    public NextCustomerSigmaCriteria(NextCustomerSigmaCriteria other) {
    ...
    @Override
    public NextCustomerSigmaCriteria copy() {
        return new NextCustomerSigmaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextCustomerSigmaCriteria that = (NextCustomerSigmaCriteria) o;
        return (
    ...
    public String toString() {
        return "NextCustomerSigmaCriteria{" +
