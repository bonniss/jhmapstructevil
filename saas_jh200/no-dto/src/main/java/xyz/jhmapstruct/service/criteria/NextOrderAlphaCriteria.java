...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextOrderAlpha} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextOrderAlphaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-order-alphas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextOrderAlphaCriteria implements Serializable, Criteria {

    /**
     * Class for filtering OrderAlphaStatus
     */
    public static class OrderAlphaStatusFilter extends Filter<OrderAlphaStatus> {

        public OrderAlphaStatusFilter() {}

        public OrderAlphaStatusFilter(OrderAlphaStatusFilter filter) {
            super(filter);
        }

        @Override
        public OrderAlphaStatusFilter copy() {
            return new OrderAlphaStatusFilter(this);
        }
    }
    ...
    private OrderAlphaStatusFilter status;
    ...
    public NextOrderAlphaCriteria() {}

    public NextOrderAlphaCriteria(NextOrderAlphaCriteria other) {
        ...
        this.status = other.optionalStatus().map(OrderAlphaStatusFilter::copy).orElse(null);
    ...
    @Override
    public NextOrderAlphaCriteria copy() {
        return new NextOrderAlphaCriteria(this);
    }
    ...
    public OrderAlphaStatusFilter getStatus() {
        return status;
    }

    public Optional<OrderAlphaStatusFilter> optionalStatus() {
        return Optional.ofNullable(status);
    }

    public OrderAlphaStatusFilter status() {
        if (status == null) {
            setStatus(new OrderAlphaStatusFilter());
        }
        return status;
    }

    public void setStatus(OrderAlphaStatusFilter status) {
        this.status = status;
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextOrderAlphaCriteria that = (NextOrderAlphaCriteria) o;
        return (
