...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextSupplierTheta} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextSupplierThetaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-supplier-thetas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextSupplierThetaCriteria implements Serializable, Criteria {
    ...
    public NextSupplierThetaCriteria() {}

    public NextSupplierThetaCriteria(NextSupplierThetaCriteria other) {
    ...
    @Override
    public NextSupplierThetaCriteria copy() {
        return new NextSupplierThetaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextSupplierThetaCriteria that = (NextSupplierThetaCriteria) o;
        return (
    ...
    public String toString() {
        return "NextSupplierThetaCriteria{" +
