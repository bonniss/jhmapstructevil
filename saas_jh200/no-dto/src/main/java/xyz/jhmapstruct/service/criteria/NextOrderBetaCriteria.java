...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextOrderBeta} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextOrderBetaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-order-betas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextOrderBetaCriteria implements Serializable, Criteria {
    ...
    public NextOrderBetaCriteria() {}

    public NextOrderBetaCriteria(NextOrderBetaCriteria other) {
    ...
    @Override
    public NextOrderBetaCriteria copy() {
        return new NextOrderBetaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextOrderBetaCriteria that = (NextOrderBetaCriteria) o;
        return (
