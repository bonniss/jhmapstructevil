...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextInvoiceBeta} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextInvoiceBetaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-invoice-betas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextInvoiceBetaCriteria implements Serializable, Criteria {
    ...
    public NextInvoiceBetaCriteria() {}

    public NextInvoiceBetaCriteria(NextInvoiceBetaCriteria other) {
    ...
    @Override
    public NextInvoiceBetaCriteria copy() {
        return new NextInvoiceBetaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextInvoiceBetaCriteria that = (NextInvoiceBetaCriteria) o;
        return (
    ...
    public String toString() {
        return "NextInvoiceBetaCriteria{" +
