...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextEmployeeBeta} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextEmployeeBetaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-employee-betas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextEmployeeBetaCriteria implements Serializable, Criteria {
    ...
    public NextEmployeeBetaCriteria() {}

    public NextEmployeeBetaCriteria(NextEmployeeBetaCriteria other) {
    ...
    @Override
    public NextEmployeeBetaCriteria copy() {
        return new NextEmployeeBetaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextEmployeeBetaCriteria that = (NextEmployeeBetaCriteria) o;
        return (
    ...
    public String toString() {
        return "NextEmployeeBetaCriteria{" +
