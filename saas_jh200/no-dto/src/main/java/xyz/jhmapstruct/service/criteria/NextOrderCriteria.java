...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextOrder} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextOrderResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-orders?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextOrderCriteria implements Serializable, Criteria {
    ...
    public NextOrderCriteria() {}

    public NextOrderCriteria(NextOrderCriteria other) {
    ...
    @Override
    public NextOrderCriteria copy() {
        return new NextOrderCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextOrderCriteria that = (NextOrderCriteria) o;
        return (
