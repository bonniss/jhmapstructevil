...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextShipmentMiMi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextShipmentMiMiResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-shipment-mi-mis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextShipmentMiMiCriteria implements Serializable, Criteria {
    ...
    public NextShipmentMiMiCriteria() {}

    public NextShipmentMiMiCriteria(NextShipmentMiMiCriteria other) {
    ...
    @Override
    public NextShipmentMiMiCriteria copy() {
        return new NextShipmentMiMiCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextShipmentMiMiCriteria that = (NextShipmentMiMiCriteria) o;
        return (
    ...
    public String toString() {
        return "NextShipmentMiMiCriteria{" +
