...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.SupplierViVi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.SupplierViViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /supplier-vi-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class SupplierViViCriteria implements Serializable, Criteria {
    ...
    public SupplierViViCriteria() {}

    public SupplierViViCriteria(SupplierViViCriteria other) {
    ...
    @Override
    public SupplierViViCriteria copy() {
        return new SupplierViViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final SupplierViViCriteria that = (SupplierViViCriteria) o;
        return (
