...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextShipmentVi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextShipmentViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-shipment-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextShipmentViCriteria implements Serializable, Criteria {
    ...
    public NextShipmentViCriteria() {}

    public NextShipmentViCriteria(NextShipmentViCriteria other) {
    ...
    @Override
    public NextShipmentViCriteria copy() {
        return new NextShipmentViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextShipmentViCriteria that = (NextShipmentViCriteria) o;
        return (
