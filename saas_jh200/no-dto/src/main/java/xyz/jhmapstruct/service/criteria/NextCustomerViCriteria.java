...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextCustomerVi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextCustomerViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-customer-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextCustomerViCriteria implements Serializable, Criteria {
    ...
    public NextCustomerViCriteria() {}

    public NextCustomerViCriteria(NextCustomerViCriteria other) {
    ...
    @Override
    public NextCustomerViCriteria copy() {
        return new NextCustomerViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextCustomerViCriteria that = (NextCustomerViCriteria) o;
        return (
