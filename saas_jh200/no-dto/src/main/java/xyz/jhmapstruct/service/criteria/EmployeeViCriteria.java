...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.EmployeeVi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.EmployeeViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /employee-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class EmployeeViCriteria implements Serializable, Criteria {
    ...
    public EmployeeViCriteria() {}

    public EmployeeViCriteria(EmployeeViCriteria other) {
    ...
    @Override
    public EmployeeViCriteria copy() {
        return new EmployeeViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final EmployeeViCriteria that = (EmployeeViCriteria) o;
        return (
