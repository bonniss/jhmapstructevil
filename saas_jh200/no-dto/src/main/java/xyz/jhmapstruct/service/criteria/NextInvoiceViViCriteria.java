...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextInvoiceViVi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextInvoiceViViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-invoice-vi-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextInvoiceViViCriteria implements Serializable, Criteria {
    ...
    public NextInvoiceViViCriteria() {}

    public NextInvoiceViViCriteria(NextInvoiceViViCriteria other) {
    ...
    @Override
    public NextInvoiceViViCriteria copy() {
        return new NextInvoiceViViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextInvoiceViViCriteria that = (NextInvoiceViViCriteria) o;
        return (
    ...
    public String toString() {
        return "NextInvoiceViViCriteria{" +
