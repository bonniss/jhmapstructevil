...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.OrderGamma} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.OrderGammaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /order-gammas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class OrderGammaCriteria implements Serializable, Criteria {
    ...
    public OrderGammaCriteria() {}

    public OrderGammaCriteria(OrderGammaCriteria other) {
    ...
    @Override
    public OrderGammaCriteria copy() {
        return new OrderGammaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final OrderGammaCriteria that = (OrderGammaCriteria) o;
        return (
