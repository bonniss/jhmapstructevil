...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextEmployeeAlpha} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextEmployeeAlphaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-employee-alphas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextEmployeeAlphaCriteria implements Serializable, Criteria {
    ...
    public NextEmployeeAlphaCriteria() {}

    public NextEmployeeAlphaCriteria(NextEmployeeAlphaCriteria other) {
    ...
    @Override
    public NextEmployeeAlphaCriteria copy() {
        return new NextEmployeeAlphaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextEmployeeAlphaCriteria that = (NextEmployeeAlphaCriteria) o;
        return (
    ...
    public String toString() {
        return "NextEmployeeAlphaCriteria{" +
