...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextReviewTheta} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextReviewThetaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-review-thetas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextReviewThetaCriteria implements Serializable, Criteria {
    ...
    public NextReviewThetaCriteria() {}

    public NextReviewThetaCriteria(NextReviewThetaCriteria other) {
    ...
    @Override
    public NextReviewThetaCriteria copy() {
        return new NextReviewThetaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextReviewThetaCriteria that = (NextReviewThetaCriteria) o;
        return (
    ...
    public String toString() {
        return "NextReviewThetaCriteria{" +
