...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextProductTheta} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextProductThetaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-product-thetas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextProductThetaCriteria implements Serializable, Criteria {
    ...
    public NextProductThetaCriteria() {}

    public NextProductThetaCriteria(NextProductThetaCriteria other) {
    ...
    @Override
    public NextProductThetaCriteria copy() {
        return new NextProductThetaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextProductThetaCriteria that = (NextProductThetaCriteria) o;
        return (
    ...
    public String toString() {
        return "NextProductThetaCriteria{" +
