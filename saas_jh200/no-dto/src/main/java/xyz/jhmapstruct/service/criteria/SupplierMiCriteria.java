...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.SupplierMi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.SupplierMiResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /supplier-mis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class SupplierMiCriteria implements Serializable, Criteria {
    ...
    public SupplierMiCriteria() {}

    public SupplierMiCriteria(SupplierMiCriteria other) {
    ...
    @Override
    public SupplierMiCriteria copy() {
        return new SupplierMiCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final SupplierMiCriteria that = (SupplierMiCriteria) o;
        return (
