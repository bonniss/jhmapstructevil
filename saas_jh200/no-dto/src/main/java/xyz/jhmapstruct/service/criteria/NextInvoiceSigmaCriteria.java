...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextInvoiceSigma} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextInvoiceSigmaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-invoice-sigmas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextInvoiceSigmaCriteria implements Serializable, Criteria {
    ...
    public NextInvoiceSigmaCriteria() {}

    public NextInvoiceSigmaCriteria(NextInvoiceSigmaCriteria other) {
    ...
    @Override
    public NextInvoiceSigmaCriteria copy() {
        return new NextInvoiceSigmaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextInvoiceSigmaCriteria that = (NextInvoiceSigmaCriteria) o;
        return (
    ...
    public String toString() {
        return "NextInvoiceSigmaCriteria{" +
