...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.InvoiceSigma} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.InvoiceSigmaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /invoice-sigmas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class InvoiceSigmaCriteria implements Serializable, Criteria {
    ...
    public InvoiceSigmaCriteria() {}

    public InvoiceSigmaCriteria(InvoiceSigmaCriteria other) {
    ...
    @Override
    public InvoiceSigmaCriteria copy() {
        return new InvoiceSigmaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final InvoiceSigmaCriteria that = (InvoiceSigmaCriteria) o;
        return (
