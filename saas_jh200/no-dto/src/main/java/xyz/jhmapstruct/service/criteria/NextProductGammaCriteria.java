...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextProductGamma} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextProductGammaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-product-gammas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextProductGammaCriteria implements Serializable, Criteria {
    ...
    public NextProductGammaCriteria() {}

    public NextProductGammaCriteria(NextProductGammaCriteria other) {
    ...
    @Override
    public NextProductGammaCriteria copy() {
        return new NextProductGammaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextProductGammaCriteria that = (NextProductGammaCriteria) o;
        return (
    ...
    public String toString() {
        return "NextProductGammaCriteria{" +
