...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextReviewViVi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextReviewViViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-review-vi-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextReviewViViCriteria implements Serializable, Criteria {
    ...
    public NextReviewViViCriteria() {}

    public NextReviewViViCriteria(NextReviewViViCriteria other) {
    ...
    @Override
    public NextReviewViViCriteria copy() {
        return new NextReviewViViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextReviewViViCriteria that = (NextReviewViViCriteria) o;
        return (
