...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextReviewMi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextReviewMiResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-review-mis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextReviewMiCriteria implements Serializable, Criteria {
    ...
    public NextReviewMiCriteria() {}

    public NextReviewMiCriteria(NextReviewMiCriteria other) {
    ...
    @Override
    public NextReviewMiCriteria copy() {
        return new NextReviewMiCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextReviewMiCriteria that = (NextReviewMiCriteria) o;
        return (
