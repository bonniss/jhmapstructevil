...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextOrderGamma} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextOrderGammaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-order-gammas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextOrderGammaCriteria implements Serializable, Criteria {

    /**
     * Class for filtering OrderGammaStatus
     */
    public static class OrderGammaStatusFilter extends Filter<OrderGammaStatus> {

        public OrderGammaStatusFilter() {}

        public OrderGammaStatusFilter(OrderGammaStatusFilter filter) {
            super(filter);
        }

        @Override
        public OrderGammaStatusFilter copy() {
            return new OrderGammaStatusFilter(this);
        }
    }
    ...
    private OrderGammaStatusFilter status;
    ...
    public NextOrderGammaCriteria() {}

    public NextOrderGammaCriteria(NextOrderGammaCriteria other) {
        ...
        this.status = other.optionalStatus().map(OrderGammaStatusFilter::copy).orElse(null);
    ...
    @Override
    public NextOrderGammaCriteria copy() {
        return new NextOrderGammaCriteria(this);
    }
    ...
    public OrderGammaStatusFilter getStatus() {
        return status;
    }

    public Optional<OrderGammaStatusFilter> optionalStatus() {
        return Optional.ofNullable(status);
    }

    public OrderGammaStatusFilter status() {
        if (status == null) {
            setStatus(new OrderGammaStatusFilter());
        }
        return status;
    }

    public void setStatus(OrderGammaStatusFilter status) {
        this.status = status;
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextOrderGammaCriteria that = (NextOrderGammaCriteria) o;
        return (
