...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextReviewAlpha} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextReviewAlphaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-review-alphas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextReviewAlphaCriteria implements Serializable, Criteria {
    ...
    public NextReviewAlphaCriteria() {}

    public NextReviewAlphaCriteria(NextReviewAlphaCriteria other) {
    ...
    @Override
    public NextReviewAlphaCriteria copy() {
        return new NextReviewAlphaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextReviewAlphaCriteria that = (NextReviewAlphaCriteria) o;
        return (
    ...
    public String toString() {
        return "NextReviewAlphaCriteria{" +
