...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.SupplierTheta} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.SupplierThetaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /supplier-thetas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class SupplierThetaCriteria implements Serializable, Criteria {
    ...
    public SupplierThetaCriteria() {}

    public SupplierThetaCriteria(SupplierThetaCriteria other) {
    ...
    @Override
    public SupplierThetaCriteria copy() {
        return new SupplierThetaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final SupplierThetaCriteria that = (SupplierThetaCriteria) o;
        return (
