...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.ShipmentBeta} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.ShipmentBetaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /shipment-betas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ShipmentBetaCriteria implements Serializable, Criteria {
    ...
    public ShipmentBetaCriteria() {}

    public ShipmentBetaCriteria(ShipmentBetaCriteria other) {
    ...
    @Override
    public ShipmentBetaCriteria copy() {
        return new ShipmentBetaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ShipmentBetaCriteria that = (ShipmentBetaCriteria) o;
        return (
