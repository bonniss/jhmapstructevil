...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextSupplier} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextSupplierResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-suppliers?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextSupplierCriteria implements Serializable, Criteria {
    ...
    public NextSupplierCriteria() {}

    public NextSupplierCriteria(NextSupplierCriteria other) {
    ...
    @Override
    public NextSupplierCriteria copy() {
        return new NextSupplierCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextSupplierCriteria that = (NextSupplierCriteria) o;
        return (
