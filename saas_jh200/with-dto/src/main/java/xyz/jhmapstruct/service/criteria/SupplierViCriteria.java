...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.SupplierVi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.SupplierViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /supplier-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class SupplierViCriteria implements Serializable, Criteria {
    ...
    public SupplierViCriteria() {}

    public SupplierViCriteria(SupplierViCriteria other) {
    ...
    @Override
    public SupplierViCriteria copy() {
        return new SupplierViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final SupplierViCriteria that = (SupplierViCriteria) o;
        return (
