...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.ReviewAlpha} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.ReviewAlphaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /review-alphas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ReviewAlphaCriteria implements Serializable, Criteria {
    ...
    public ReviewAlphaCriteria() {}

    public ReviewAlphaCriteria(ReviewAlphaCriteria other) {
    ...
    @Override
    public ReviewAlphaCriteria copy() {
        return new ReviewAlphaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ReviewAlphaCriteria that = (ReviewAlphaCriteria) o;
        return (
