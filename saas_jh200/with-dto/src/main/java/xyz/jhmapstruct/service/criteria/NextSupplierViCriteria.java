...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextSupplierVi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextSupplierViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-supplier-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextSupplierViCriteria implements Serializable, Criteria {
    ...
    public NextSupplierViCriteria() {}

    public NextSupplierViCriteria(NextSupplierViCriteria other) {
    ...
    @Override
    public NextSupplierViCriteria copy() {
        return new NextSupplierViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextSupplierViCriteria that = (NextSupplierViCriteria) o;
        return (
