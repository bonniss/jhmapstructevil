...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextReviewMiMi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextReviewMiMiResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-review-mi-mis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextReviewMiMiCriteria implements Serializable, Criteria {
    ...
    public NextReviewMiMiCriteria() {}

    public NextReviewMiMiCriteria(NextReviewMiMiCriteria other) {
    ...
    @Override
    public NextReviewMiMiCriteria copy() {
        return new NextReviewMiMiCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextReviewMiMiCriteria that = (NextReviewMiMiCriteria) o;
        return (
