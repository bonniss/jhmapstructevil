...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextEmployeeGamma} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextEmployeeGammaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-employee-gammas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextEmployeeGammaCriteria implements Serializable, Criteria {
    ...
    public NextEmployeeGammaCriteria() {}

    public NextEmployeeGammaCriteria(NextEmployeeGammaCriteria other) {
    ...
    @Override
    public NextEmployeeGammaCriteria copy() {
        return new NextEmployeeGammaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextEmployeeGammaCriteria that = (NextEmployeeGammaCriteria) o;
        return (
    ...
    public String toString() {
        return "NextEmployeeGammaCriteria{" +
