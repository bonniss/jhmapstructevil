...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextShipmentSigma} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextShipmentSigmaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-shipment-sigmas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextShipmentSigmaCriteria implements Serializable, Criteria {
    ...
    public NextShipmentSigmaCriteria() {}

    public NextShipmentSigmaCriteria(NextShipmentSigmaCriteria other) {
    ...
    @Override
    public NextShipmentSigmaCriteria copy() {
        return new NextShipmentSigmaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextShipmentSigmaCriteria that = (NextShipmentSigmaCriteria) o;
        return (
    ...
    public String toString() {
        return "NextShipmentSigmaCriteria{" +
