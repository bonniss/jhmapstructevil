...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextOrderMiMi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextOrderMiMiResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-order-mi-mis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextOrderMiMiCriteria implements Serializable, Criteria {

    /**
     * Class for filtering OrderMiMiStatus
     */
    public static class OrderMiMiStatusFilter extends Filter<OrderMiMiStatus> {

        public OrderMiMiStatusFilter() {}

        public OrderMiMiStatusFilter(OrderMiMiStatusFilter filter) {
            super(filter);
        }

        @Override
        public OrderMiMiStatusFilter copy() {
            return new OrderMiMiStatusFilter(this);
        }
    }
    ...
    private OrderMiMiStatusFilter status;
    ...
    public NextOrderMiMiCriteria() {}

    public NextOrderMiMiCriteria(NextOrderMiMiCriteria other) {
        ...
        this.status = other.optionalStatus().map(OrderMiMiStatusFilter::copy).orElse(null);
    ...
    @Override
    public NextOrderMiMiCriteria copy() {
        return new NextOrderMiMiCriteria(this);
    }
    ...
    public OrderMiMiStatusFilter getStatus() {
        return status;
    }

    public Optional<OrderMiMiStatusFilter> optionalStatus() {
        return Optional.ofNullable(status);
    }

    public OrderMiMiStatusFilter status() {
        if (status == null) {
            setStatus(new OrderMiMiStatusFilter());
        }
        return status;
    }

    public void setStatus(OrderMiMiStatusFilter status) {
        this.status = status;
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextOrderMiMiCriteria that = (NextOrderMiMiCriteria) o;
        return (
