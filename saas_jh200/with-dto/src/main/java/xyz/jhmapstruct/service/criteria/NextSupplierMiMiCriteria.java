...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextSupplierMiMi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextSupplierMiMiResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-supplier-mi-mis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextSupplierMiMiCriteria implements Serializable, Criteria {
    ...
    public NextSupplierMiMiCriteria() {}

    public NextSupplierMiMiCriteria(NextSupplierMiMiCriteria other) {
    ...
    @Override
    public NextSupplierMiMiCriteria copy() {
        return new NextSupplierMiMiCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextSupplierMiMiCriteria that = (NextSupplierMiMiCriteria) o;
        return (
    ...
    public String toString() {
        return "NextSupplierMiMiCriteria{" +
