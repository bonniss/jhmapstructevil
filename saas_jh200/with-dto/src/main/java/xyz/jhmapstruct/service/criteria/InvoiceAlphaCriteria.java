...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.InvoiceAlpha} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.InvoiceAlphaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /invoice-alphas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class InvoiceAlphaCriteria implements Serializable, Criteria {
    ...
    public InvoiceAlphaCriteria() {}

    public InvoiceAlphaCriteria(InvoiceAlphaCriteria other) {
    ...
    @Override
    public InvoiceAlphaCriteria copy() {
        return new InvoiceAlphaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final InvoiceAlphaCriteria that = (InvoiceAlphaCriteria) o;
        return (
