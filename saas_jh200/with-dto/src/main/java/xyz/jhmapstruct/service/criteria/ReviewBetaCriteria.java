...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.ReviewBeta} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.ReviewBetaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /review-betas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ReviewBetaCriteria implements Serializable, Criteria {
    ...
    public ReviewBetaCriteria() {}

    public ReviewBetaCriteria(ReviewBetaCriteria other) {
    ...
    @Override
    public ReviewBetaCriteria copy() {
        return new ReviewBetaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ReviewBetaCriteria that = (ReviewBetaCriteria) o;
        return (
