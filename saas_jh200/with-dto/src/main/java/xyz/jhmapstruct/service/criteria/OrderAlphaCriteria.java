...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.OrderAlpha} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.OrderAlphaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /order-alphas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class OrderAlphaCriteria implements Serializable, Criteria {
    ...
    public OrderAlphaCriteria() {}

    public OrderAlphaCriteria(OrderAlphaCriteria other) {
    ...
    @Override
    public OrderAlphaCriteria copy() {
        return new OrderAlphaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final OrderAlphaCriteria that = (OrderAlphaCriteria) o;
        return (
