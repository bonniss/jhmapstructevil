...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.InvoiceMiMi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.InvoiceMiMiResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /invoice-mi-mis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class InvoiceMiMiCriteria implements Serializable, Criteria {
    ...
    public InvoiceMiMiCriteria() {}

    public InvoiceMiMiCriteria(InvoiceMiMiCriteria other) {
    ...
    @Override
    public InvoiceMiMiCriteria copy() {
        return new InvoiceMiMiCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final InvoiceMiMiCriteria that = (InvoiceMiMiCriteria) o;
        return (
