...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.ProductSigma} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.ProductSigmaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /product-sigmas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ProductSigmaCriteria implements Serializable, Criteria {
    ...
    public ProductSigmaCriteria() {}

    public ProductSigmaCriteria(ProductSigmaCriteria other) {
    ...
    @Override
    public ProductSigmaCriteria copy() {
        return new ProductSigmaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ProductSigmaCriteria that = (ProductSigmaCriteria) o;
        return (
