...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.EmployeeTheta} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.EmployeeThetaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /employee-thetas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class EmployeeThetaCriteria implements Serializable, Criteria {
    ...
    public EmployeeThetaCriteria() {}

    public EmployeeThetaCriteria(EmployeeThetaCriteria other) {
    ...
    @Override
    public EmployeeThetaCriteria copy() {
        return new EmployeeThetaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final EmployeeThetaCriteria that = (EmployeeThetaCriteria) o;
        return (
