...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.ShipmentGamma} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.ShipmentGammaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /shipment-gammas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ShipmentGammaCriteria implements Serializable, Criteria {
    ...
    public ShipmentGammaCriteria() {}

    public ShipmentGammaCriteria(ShipmentGammaCriteria other) {
    ...
    @Override
    public ShipmentGammaCriteria copy() {
        return new ShipmentGammaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ShipmentGammaCriteria that = (ShipmentGammaCriteria) o;
        return (
