...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextProductSigma} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextProductSigmaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-product-sigmas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextProductSigmaCriteria implements Serializable, Criteria {
    ...
    public NextProductSigmaCriteria() {}

    public NextProductSigmaCriteria(NextProductSigmaCriteria other) {
    ...
    @Override
    public NextProductSigmaCriteria copy() {
        return new NextProductSigmaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextProductSigmaCriteria that = (NextProductSigmaCriteria) o;
        return (
    ...
    public String toString() {
        return "NextProductSigmaCriteria{" +
