...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.CustomerMi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.CustomerMiResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /customer-mis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class CustomerMiCriteria implements Serializable, Criteria {
    ...
    public CustomerMiCriteria() {}

    public CustomerMiCriteria(CustomerMiCriteria other) {
    ...
    @Override
    public CustomerMiCriteria copy() {
        return new CustomerMiCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CustomerMiCriteria that = (CustomerMiCriteria) o;
        return (
