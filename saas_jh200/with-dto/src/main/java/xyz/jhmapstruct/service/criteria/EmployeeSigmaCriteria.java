...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.EmployeeSigma} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.EmployeeSigmaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /employee-sigmas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class EmployeeSigmaCriteria implements Serializable, Criteria {
    ...
    public EmployeeSigmaCriteria() {}

    public EmployeeSigmaCriteria(EmployeeSigmaCriteria other) {
    ...
    @Override
    public EmployeeSigmaCriteria copy() {
        return new EmployeeSigmaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final EmployeeSigmaCriteria that = (EmployeeSigmaCriteria) o;
        return (
