...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.EmployeeAlpha} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.EmployeeAlphaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /employee-alphas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class EmployeeAlphaCriteria implements Serializable, Criteria {
    ...
    public EmployeeAlphaCriteria() {}

    public EmployeeAlphaCriteria(EmployeeAlphaCriteria other) {
    ...
    @Override
    public EmployeeAlphaCriteria copy() {
        return new EmployeeAlphaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final EmployeeAlphaCriteria that = (EmployeeAlphaCriteria) o;
        return (
