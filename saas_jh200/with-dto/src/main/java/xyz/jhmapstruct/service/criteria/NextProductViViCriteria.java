...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextProductViVi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextProductViViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-product-vi-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextProductViViCriteria implements Serializable, Criteria {
    ...
    public NextProductViViCriteria() {}

    public NextProductViViCriteria(NextProductViViCriteria other) {
    ...
    @Override
    public NextProductViViCriteria copy() {
        return new NextProductViViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextProductViViCriteria that = (NextProductViViCriteria) o;
        return (
    ...
    public String toString() {
        return "NextProductViViCriteria{" +
