...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.OrderSigma} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.OrderSigmaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /order-sigmas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class OrderSigmaCriteria implements Serializable, Criteria {
    ...
    public OrderSigmaCriteria() {}

    public OrderSigmaCriteria(OrderSigmaCriteria other) {
    ...
    @Override
    public OrderSigmaCriteria copy() {
        return new OrderSigmaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final OrderSigmaCriteria that = (OrderSigmaCriteria) o;
        return (
