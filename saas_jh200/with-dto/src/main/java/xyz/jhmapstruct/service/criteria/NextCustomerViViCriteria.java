...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextCustomerViVi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextCustomerViViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-customer-vi-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextCustomerViViCriteria implements Serializable, Criteria {
    ...
    public NextCustomerViViCriteria() {}

    public NextCustomerViViCriteria(NextCustomerViViCriteria other) {
    ...
    @Override
    public NextCustomerViViCriteria copy() {
        return new NextCustomerViViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextCustomerViViCriteria that = (NextCustomerViViCriteria) o;
        return (
    ...
    public String toString() {
        return "NextCustomerViViCriteria{" +
