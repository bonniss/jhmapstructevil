...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.ProductBeta} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.ProductBetaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /product-betas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ProductBetaCriteria implements Serializable, Criteria {
    ...
    public ProductBetaCriteria() {}

    public ProductBetaCriteria(ProductBetaCriteria other) {
    ...
    @Override
    public ProductBetaCriteria copy() {
        return new ProductBetaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ProductBetaCriteria that = (ProductBetaCriteria) o;
        return (
