...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.ProductGamma} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.ProductGammaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /product-gammas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ProductGammaCriteria implements Serializable, Criteria {
    ...
    public ProductGammaCriteria() {}

    public ProductGammaCriteria(ProductGammaCriteria other) {
    ...
    @Override
    public ProductGammaCriteria copy() {
        return new ProductGammaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ProductGammaCriteria that = (ProductGammaCriteria) o;
        return (
