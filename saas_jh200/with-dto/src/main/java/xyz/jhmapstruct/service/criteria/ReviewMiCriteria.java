...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.ReviewMi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.ReviewMiResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /review-mis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ReviewMiCriteria implements Serializable, Criteria {
    ...
    public ReviewMiCriteria() {}

    public ReviewMiCriteria(ReviewMiCriteria other) {
    ...
    @Override
    public ReviewMiCriteria copy() {
        return new ReviewMiCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ReviewMiCriteria that = (ReviewMiCriteria) o;
        return (
