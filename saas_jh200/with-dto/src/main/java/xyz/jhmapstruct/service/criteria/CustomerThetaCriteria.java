...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.CustomerTheta} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.CustomerThetaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /customer-thetas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class CustomerThetaCriteria implements Serializable, Criteria {
    ...
    public CustomerThetaCriteria() {}

    public CustomerThetaCriteria(CustomerThetaCriteria other) {
    ...
    @Override
    public CustomerThetaCriteria copy() {
        return new CustomerThetaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CustomerThetaCriteria that = (CustomerThetaCriteria) o;
        return (
