...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.EmployeeMiMi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.EmployeeMiMiResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /employee-mi-mis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class EmployeeMiMiCriteria implements Serializable, Criteria {
    ...
    public EmployeeMiMiCriteria() {}

    public EmployeeMiMiCriteria(EmployeeMiMiCriteria other) {
    ...
    @Override
    public EmployeeMiMiCriteria copy() {
        return new EmployeeMiMiCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final EmployeeMiMiCriteria that = (EmployeeMiMiCriteria) o;
        return (
