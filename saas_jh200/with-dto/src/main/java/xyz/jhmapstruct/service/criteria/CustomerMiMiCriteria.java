...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.CustomerMiMi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.CustomerMiMiResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /customer-mi-mis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class CustomerMiMiCriteria implements Serializable, Criteria {
    ...
    public CustomerMiMiCriteria() {}

    public CustomerMiMiCriteria(CustomerMiMiCriteria other) {
    ...
    @Override
    public CustomerMiMiCriteria copy() {
        return new CustomerMiMiCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CustomerMiMiCriteria that = (CustomerMiMiCriteria) o;
        return (
