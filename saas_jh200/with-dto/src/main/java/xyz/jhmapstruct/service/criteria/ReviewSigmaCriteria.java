...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.ReviewSigma} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.ReviewSigmaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /review-sigmas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ReviewSigmaCriteria implements Serializable, Criteria {
    ...
    public ReviewSigmaCriteria() {}

    public ReviewSigmaCriteria(ReviewSigmaCriteria other) {
    ...
    @Override
    public ReviewSigmaCriteria copy() {
        return new ReviewSigmaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ReviewSigmaCriteria that = (ReviewSigmaCriteria) o;
        return (
