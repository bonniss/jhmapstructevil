...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.ShipmentMi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.ShipmentMiResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /shipment-mis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ShipmentMiCriteria implements Serializable, Criteria {
    ...
    public ShipmentMiCriteria() {}

    public ShipmentMiCriteria(ShipmentMiCriteria other) {
    ...
    @Override
    public ShipmentMiCriteria copy() {
        return new ShipmentMiCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ShipmentMiCriteria that = (ShipmentMiCriteria) o;
        return (
