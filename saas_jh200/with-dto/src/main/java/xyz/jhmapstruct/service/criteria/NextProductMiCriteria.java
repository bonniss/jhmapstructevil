...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextProductMi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextProductMiResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-product-mis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextProductMiCriteria implements Serializable, Criteria {
    ...
    public NextProductMiCriteria() {}

    public NextProductMiCriteria(NextProductMiCriteria other) {
    ...
    @Override
    public NextProductMiCriteria copy() {
        return new NextProductMiCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextProductMiCriteria that = (NextProductMiCriteria) o;
        return (
