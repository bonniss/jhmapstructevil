...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.ShipmentSigma} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.ShipmentSigmaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /shipment-sigmas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ShipmentSigmaCriteria implements Serializable, Criteria {
    ...
    public ShipmentSigmaCriteria() {}

    public ShipmentSigmaCriteria(ShipmentSigmaCriteria other) {
    ...
    @Override
    public ShipmentSigmaCriteria copy() {
        return new ShipmentSigmaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ShipmentSigmaCriteria that = (ShipmentSigmaCriteria) o;
        return (
