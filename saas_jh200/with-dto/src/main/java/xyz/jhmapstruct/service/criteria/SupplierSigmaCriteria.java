...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.SupplierSigma} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.SupplierSigmaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /supplier-sigmas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class SupplierSigmaCriteria implements Serializable, Criteria {
    ...
    public SupplierSigmaCriteria() {}

    public SupplierSigmaCriteria(SupplierSigmaCriteria other) {
    ...
    @Override
    public SupplierSigmaCriteria copy() {
        return new SupplierSigmaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final SupplierSigmaCriteria that = (SupplierSigmaCriteria) o;
        return (
