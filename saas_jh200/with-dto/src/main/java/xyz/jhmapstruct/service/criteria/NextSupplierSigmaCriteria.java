...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextSupplierSigma} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextSupplierSigmaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-supplier-sigmas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextSupplierSigmaCriteria implements Serializable, Criteria {
    ...
    public NextSupplierSigmaCriteria() {}

    public NextSupplierSigmaCriteria(NextSupplierSigmaCriteria other) {
    ...
    @Override
    public NextSupplierSigmaCriteria copy() {
        return new NextSupplierSigmaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextSupplierSigmaCriteria that = (NextSupplierSigmaCriteria) o;
        return (
    ...
    public String toString() {
        return "NextSupplierSigmaCriteria{" +
