...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.CustomerVi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.CustomerViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /customer-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class CustomerViCriteria implements Serializable, Criteria {
    ...
    public CustomerViCriteria() {}

    public CustomerViCriteria(CustomerViCriteria other) {
    ...
    @Override
    public CustomerViCriteria copy() {
        return new CustomerViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CustomerViCriteria that = (CustomerViCriteria) o;
        return (
