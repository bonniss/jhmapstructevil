...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.ProductViVi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.ProductViViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /product-vi-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ProductViViCriteria implements Serializable, Criteria {
    ...
    public ProductViViCriteria() {}

    public ProductViViCriteria(ProductViViCriteria other) {
    ...
    @Override
    public ProductViViCriteria copy() {
        return new ProductViViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ProductViViCriteria that = (ProductViViCriteria) o;
        return (
