...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextShipmentBeta} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextShipmentBetaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-shipment-betas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextShipmentBetaCriteria implements Serializable, Criteria {
    ...
    public NextShipmentBetaCriteria() {}

    public NextShipmentBetaCriteria(NextShipmentBetaCriteria other) {
    ...
    @Override
    public NextShipmentBetaCriteria copy() {
        return new NextShipmentBetaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextShipmentBetaCriteria that = (NextShipmentBetaCriteria) o;
        return (
    ...
    public String toString() {
        return "NextShipmentBetaCriteria{" +
