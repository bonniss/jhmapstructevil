...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextOrderSigma} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextOrderSigmaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-order-sigmas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextOrderSigmaCriteria implements Serializable, Criteria {

    /**
     * Class for filtering OrderSigmaStatus
     */
    public static class OrderSigmaStatusFilter extends Filter<OrderSigmaStatus> {

        public OrderSigmaStatusFilter() {}

        public OrderSigmaStatusFilter(OrderSigmaStatusFilter filter) {
            super(filter);
        }

        @Override
        public OrderSigmaStatusFilter copy() {
            return new OrderSigmaStatusFilter(this);
        }
    }
    ...
    private OrderSigmaStatusFilter status;
    ...
    public NextOrderSigmaCriteria() {}

    public NextOrderSigmaCriteria(NextOrderSigmaCriteria other) {
        ...
        this.status = other.optionalStatus().map(OrderSigmaStatusFilter::copy).orElse(null);
    ...
    @Override
    public NextOrderSigmaCriteria copy() {
        return new NextOrderSigmaCriteria(this);
    }
    ...
    public OrderSigmaStatusFilter getStatus() {
        return status;
    }

    public Optional<OrderSigmaStatusFilter> optionalStatus() {
        return Optional.ofNullable(status);
    }

    public OrderSigmaStatusFilter status() {
        if (status == null) {
            setStatus(new OrderSigmaStatusFilter());
        }
        return status;
    }

    public void setStatus(OrderSigmaStatusFilter status) {
        this.status = status;
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextOrderSigmaCriteria that = (NextOrderSigmaCriteria) o;
        return (
