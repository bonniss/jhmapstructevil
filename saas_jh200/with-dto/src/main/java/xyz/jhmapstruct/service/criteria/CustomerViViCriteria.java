...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.CustomerViVi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.CustomerViViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /customer-vi-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class CustomerViViCriteria implements Serializable, Criteria {
    ...
    public CustomerViViCriteria() {}

    public CustomerViViCriteria(CustomerViViCriteria other) {
    ...
    @Override
    public CustomerViViCriteria copy() {
        return new CustomerViViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CustomerViViCriteria that = (CustomerViViCriteria) o;
        return (
