...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.OrderMi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.OrderMiResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /order-mis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class OrderMiCriteria implements Serializable, Criteria {
    ...
    public OrderMiCriteria() {}

    public OrderMiCriteria(OrderMiCriteria other) {
    ...
    @Override
    public OrderMiCriteria copy() {
        return new OrderMiCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final OrderMiCriteria that = (OrderMiCriteria) o;
        return (
