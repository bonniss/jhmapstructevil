...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextEmployeeMiMi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextEmployeeMiMiResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-employee-mi-mis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextEmployeeMiMiCriteria implements Serializable, Criteria {
    ...
    public NextEmployeeMiMiCriteria() {}

    public NextEmployeeMiMiCriteria(NextEmployeeMiMiCriteria other) {
    ...
    @Override
    public NextEmployeeMiMiCriteria copy() {
        return new NextEmployeeMiMiCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextEmployeeMiMiCriteria that = (NextEmployeeMiMiCriteria) o;
        return (
    ...
    public String toString() {
        return "NextEmployeeMiMiCriteria{" +
