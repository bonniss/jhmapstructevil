...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextInvoiceAlpha} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextInvoiceAlphaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-invoice-alphas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextInvoiceAlphaCriteria implements Serializable, Criteria {
    ...
    public NextInvoiceAlphaCriteria() {}

    public NextInvoiceAlphaCriteria(NextInvoiceAlphaCriteria other) {
    ...
    @Override
    public NextInvoiceAlphaCriteria copy() {
        return new NextInvoiceAlphaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextInvoiceAlphaCriteria that = (NextInvoiceAlphaCriteria) o;
        return (
    ...
    public String toString() {
        return "NextInvoiceAlphaCriteria{" +
