...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.ShipmentAlpha} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.ShipmentAlphaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /shipment-alphas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ShipmentAlphaCriteria implements Serializable, Criteria {
    ...
    public ShipmentAlphaCriteria() {}

    public ShipmentAlphaCriteria(ShipmentAlphaCriteria other) {
    ...
    @Override
    public ShipmentAlphaCriteria copy() {
        return new ShipmentAlphaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ShipmentAlphaCriteria that = (ShipmentAlphaCriteria) o;
        return (
