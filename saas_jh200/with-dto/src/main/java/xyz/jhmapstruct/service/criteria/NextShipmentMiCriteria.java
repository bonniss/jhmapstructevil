...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextShipmentMi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextShipmentMiResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-shipment-mis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextShipmentMiCriteria implements Serializable, Criteria {
    ...
    public NextShipmentMiCriteria() {}

    public NextShipmentMiCriteria(NextShipmentMiCriteria other) {
    ...
    @Override
    public NextShipmentMiCriteria copy() {
        return new NextShipmentMiCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextShipmentMiCriteria that = (NextShipmentMiCriteria) o;
        return (
