...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.ShipmentTheta} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.ShipmentThetaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /shipment-thetas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ShipmentThetaCriteria implements Serializable, Criteria {
    ...
    public ShipmentThetaCriteria() {}

    public ShipmentThetaCriteria(ShipmentThetaCriteria other) {
    ...
    @Override
    public ShipmentThetaCriteria copy() {
        return new ShipmentThetaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ShipmentThetaCriteria that = (ShipmentThetaCriteria) o;
        return (
