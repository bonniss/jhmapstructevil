...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.InvoiceBeta} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.InvoiceBetaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /invoice-betas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class InvoiceBetaCriteria implements Serializable, Criteria {
    ...
    public InvoiceBetaCriteria() {}

    public InvoiceBetaCriteria(InvoiceBetaCriteria other) {
    ...
    @Override
    public InvoiceBetaCriteria copy() {
        return new InvoiceBetaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final InvoiceBetaCriteria that = (InvoiceBetaCriteria) o;
        return (
