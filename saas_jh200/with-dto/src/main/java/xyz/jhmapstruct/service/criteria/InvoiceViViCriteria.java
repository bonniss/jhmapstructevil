...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.InvoiceViVi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.InvoiceViViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /invoice-vi-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class InvoiceViViCriteria implements Serializable, Criteria {
    ...
    public InvoiceViViCriteria() {}

    public InvoiceViViCriteria(InvoiceViViCriteria other) {
    ...
    @Override
    public InvoiceViViCriteria copy() {
        return new InvoiceViViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final InvoiceViViCriteria that = (InvoiceViViCriteria) o;
        return (
