...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextReviewBeta} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextReviewBetaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-review-betas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextReviewBetaCriteria implements Serializable, Criteria {
    ...
    public NextReviewBetaCriteria() {}

    public NextReviewBetaCriteria(NextReviewBetaCriteria other) {
    ...
    @Override
    public NextReviewBetaCriteria copy() {
        return new NextReviewBetaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextReviewBetaCriteria that = (NextReviewBetaCriteria) o;
        return (
