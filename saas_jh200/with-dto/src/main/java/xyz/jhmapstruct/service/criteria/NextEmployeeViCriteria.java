...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextEmployeeVi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextEmployeeViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-employee-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextEmployeeViCriteria implements Serializable, Criteria {
    ...
    public NextEmployeeViCriteria() {}

    public NextEmployeeViCriteria(NextEmployeeViCriteria other) {
    ...
    @Override
    public NextEmployeeViCriteria copy() {
        return new NextEmployeeViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextEmployeeViCriteria that = (NextEmployeeViCriteria) o;
        return (
