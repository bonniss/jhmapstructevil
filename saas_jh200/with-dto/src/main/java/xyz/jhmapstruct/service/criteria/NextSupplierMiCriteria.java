...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextSupplierMi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextSupplierMiResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-supplier-mis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextSupplierMiCriteria implements Serializable, Criteria {
    ...
    public NextSupplierMiCriteria() {}

    public NextSupplierMiCriteria(NextSupplierMiCriteria other) {
    ...
    @Override
    public NextSupplierMiCriteria copy() {
        return new NextSupplierMiCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextSupplierMiCriteria that = (NextSupplierMiCriteria) o;
        return (
