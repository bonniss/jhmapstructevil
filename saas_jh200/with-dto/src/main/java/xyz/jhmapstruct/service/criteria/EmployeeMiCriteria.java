...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.EmployeeMi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.EmployeeMiResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /employee-mis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class EmployeeMiCriteria implements Serializable, Criteria {
    ...
    public EmployeeMiCriteria() {}

    public EmployeeMiCriteria(EmployeeMiCriteria other) {
    ...
    @Override
    public EmployeeMiCriteria copy() {
        return new EmployeeMiCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final EmployeeMiCriteria that = (EmployeeMiCriteria) o;
        return (
