...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextProductVi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextProductViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-product-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextProductViCriteria implements Serializable, Criteria {
    ...
    public NextProductViCriteria() {}

    public NextProductViCriteria(NextProductViCriteria other) {
    ...
    @Override
    public NextProductViCriteria copy() {
        return new NextProductViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextProductViCriteria that = (NextProductViCriteria) o;
        return (
