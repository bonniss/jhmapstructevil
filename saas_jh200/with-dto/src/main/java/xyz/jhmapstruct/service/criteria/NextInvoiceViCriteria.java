...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextInvoiceVi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextInvoiceViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-invoice-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextInvoiceViCriteria implements Serializable, Criteria {
    ...
    public NextInvoiceViCriteria() {}

    public NextInvoiceViCriteria(NextInvoiceViCriteria other) {
    ...
    @Override
    public NextInvoiceViCriteria copy() {
        return new NextInvoiceViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextInvoiceViCriteria that = (NextInvoiceViCriteria) o;
        return (
