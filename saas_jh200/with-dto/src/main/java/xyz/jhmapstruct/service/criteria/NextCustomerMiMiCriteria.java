...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextCustomerMiMi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextCustomerMiMiResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-customer-mi-mis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextCustomerMiMiCriteria implements Serializable, Criteria {
    ...
    public NextCustomerMiMiCriteria() {}

    public NextCustomerMiMiCriteria(NextCustomerMiMiCriteria other) {
    ...
    @Override
    public NextCustomerMiMiCriteria copy() {
        return new NextCustomerMiMiCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextCustomerMiMiCriteria that = (NextCustomerMiMiCriteria) o;
        return (
    ...
    public String toString() {
        return "NextCustomerMiMiCriteria{" +
