...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.ProductTheta} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.ProductThetaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /product-thetas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ProductThetaCriteria implements Serializable, Criteria {
    ...
    public ProductThetaCriteria() {}

    public ProductThetaCriteria(ProductThetaCriteria other) {
    ...
    @Override
    public ProductThetaCriteria copy() {
        return new ProductThetaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ProductThetaCriteria that = (ProductThetaCriteria) o;
        return (
