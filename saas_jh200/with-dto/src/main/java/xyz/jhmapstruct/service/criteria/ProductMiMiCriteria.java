...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.ProductMiMi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.ProductMiMiResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /product-mi-mis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ProductMiMiCriteria implements Serializable, Criteria {
    ...
    public ProductMiMiCriteria() {}

    public ProductMiMiCriteria(ProductMiMiCriteria other) {
    ...
    @Override
    public ProductMiMiCriteria copy() {
        return new ProductMiMiCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ProductMiMiCriteria that = (ProductMiMiCriteria) o;
        return (
