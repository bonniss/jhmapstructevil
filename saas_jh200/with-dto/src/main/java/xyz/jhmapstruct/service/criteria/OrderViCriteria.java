...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.OrderVi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.OrderViResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /order-vis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class OrderViCriteria implements Serializable, Criteria {
    ...
    public OrderViCriteria() {}

    public OrderViCriteria(OrderViCriteria other) {
    ...
    @Override
    public OrderViCriteria copy() {
        return new OrderViCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final OrderViCriteria that = (OrderViCriteria) o;
        return (
