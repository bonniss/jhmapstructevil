...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextProduct} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextProductResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-products?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextProductCriteria implements Serializable, Criteria {
    ...
    public NextProductCriteria() {}

    public NextProductCriteria(NextProductCriteria other) {
    ...
    @Override
    public NextProductCriteria copy() {
        return new NextProductCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextProductCriteria that = (NextProductCriteria) o;
        return (
