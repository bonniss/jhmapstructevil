...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextShipmentAlpha} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextShipmentAlphaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-shipment-alphas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextShipmentAlphaCriteria implements Serializable, Criteria {
    ...
    public NextShipmentAlphaCriteria() {}

    public NextShipmentAlphaCriteria(NextShipmentAlphaCriteria other) {
    ...
    @Override
    public NextShipmentAlphaCriteria copy() {
        return new NextShipmentAlphaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextShipmentAlphaCriteria that = (NextShipmentAlphaCriteria) o;
        return (
    ...
    public String toString() {
        return "NextShipmentAlphaCriteria{" +
