...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.NextInvoice} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.NextInvoiceResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /next-invoices?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NextInvoiceCriteria implements Serializable, Criteria {
    ...
    public NextInvoiceCriteria() {}

    public NextInvoiceCriteria(NextInvoiceCriteria other) {
    ...
    @Override
    public NextInvoiceCriteria copy() {
        return new NextInvoiceCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NextInvoiceCriteria that = (NextInvoiceCriteria) o;
        return (
