...
/**
 * Criteria class for the {@link xyz.jhmapstruct.domain.ReviewMiMi} entity. This class is used
 * in {@link xyz.jhmapstruct.web.rest.ReviewMiMiResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /review-mi-mis?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ReviewMiMiCriteria implements Serializable, Criteria {
    ...
    public ReviewMiMiCriteria() {}

    public ReviewMiMiCriteria(ReviewMiMiCriteria other) {
    ...
    @Override
    public ReviewMiMiCriteria copy() {
        return new ReviewMiMiCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ReviewMiMiCriteria that = (ReviewMiMiCriteria) o;
        return (
