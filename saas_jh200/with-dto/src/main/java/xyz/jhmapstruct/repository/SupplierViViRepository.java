 ...
 */
@Repository
public interface SupplierViViRepository
    extends SupplierViViRepositoryWithBagRelationships, JpaRepository<SupplierViVi, Long>, JpaSpecificationExecutor<SupplierViVi> {
