...
import xyz.jhmapstruct.service.SupplierMiMiQueryService;
...
public class SupplierMiMiResource {
    ...
    private final SupplierMiMiQueryService supplierMiMiQueryService;

    public SupplierMiMiResource(
        SupplierMiMiService supplierMiMiService,
        SupplierMiMiRepository supplierMiMiRepository,
        SupplierMiMiQueryService supplierMiMiQueryService
    ) {
        this.supplierMiMiService = supplierMiMiService;
        this.supplierMiMiRepository = supplierMiMiRepository;
        this.supplierMiMiQueryService = supplierMiMiQueryService;
    }
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<SupplierMiMiDTO>> getAllSupplierMiMis(
        SupplierMiMiCriteria criteria,
        @org.springdoc.core.annotations.ParameterObject Pageable pageable
    ) {
        LOG.debug("REST request to get SupplierMiMis by criteria: {}", criteria);

        Page<SupplierMiMiDTO> page = supplierMiMiQueryService.findByCriteria(criteria, pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(ServletUriComponentsBuilder.fromCurrentRequest(), page);
        return ResponseEntity.ok().headers(headers).body(page.getContent());
    }

    /**
     * {@code GET  /supplier-mi-mis/count} : count all the supplierMiMis.
     *
     * @param criteria the criteria which the requested entities should match.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the count in body.
     */
    @GetMapping("/count")
    public ResponseEntity<Long> countSupplierMiMis(SupplierMiMiCriteria criteria) {
        LOG.debug("REST request to count SupplierMiMis by criteria: {}", criteria);
        return ResponseEntity.ok().body(supplierMiMiQueryService.countByCriteria(criteria));
    }
