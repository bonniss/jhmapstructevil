...
class OrderMiMiTest {
    ...
    void tenantTest() {
        ...
        orderMiMi.setTenant(masterTenantBack);
        assertThat(orderMiMi.getTenant()).isEqualTo(masterTenantBack);

        orderMiMi.tenant(null);
        assertThat(orderMiMi.getTenant()).isNull();
    }
