...
class NextShipmentMiMiResourceIT {
    ...
    void createNextShipmentMiMi() throws Exception {
        ...
        NextShipmentMiMiDTO nextShipmentMiMiDTO = nextShipmentMiMiMapper.toDto(nextShipmentMiMi);
        var returnedNextShipmentMiMiDTO = om.readValue(
            restNextShipmentMiMiMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextShipmentMiMiDTO)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            NextShipmentMiMiDTO.class
        );

        // Validate the NextShipmentMiMi in the database
        assertIncrementedRepositoryCount(databaseSizeBeforeCreate);
        var returnedNextShipmentMiMi = nextShipmentMiMiMapper.toEntity(returnedNextShipmentMiMiDTO);
    ...
    void putExistingNextShipmentMiMi() throws Exception {
        ...
        updatedNextShipmentMiMi
            ...
            .shippedDate(UPDATED_SHIPPED_DATE)
            .deliveryDate(UPDATED_DELIVERY_DATE);
        NextShipmentMiMiDTO nextShipmentMiMiDTO = nextShipmentMiMiMapper.toDto(updatedNextShipmentMiMi);

        restNextShipmentMiMiMockMvc
            .perform(
                put(ENTITY_API_URL_ID, nextShipmentMiMiDTO.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(nextShipmentMiMiDTO))
            )
            .andExpect(status().isOk());
    ...
    void putWithMissingIdPathParamNextShipmentMiMi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextShipmentMiMiMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextShipmentMiMiDTO)))
    ...
    void patchNonExistingNextShipmentMiMi() throws Exception {
        ...
        restNextShipmentMiMiMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, nextShipmentMiMiDTO.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(nextShipmentMiMiDTO))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamNextShipmentMiMi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextShipmentMiMiMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(nextShipmentMiMiDTO)))
            .andExpect(status().isMethodNotAllowed());
