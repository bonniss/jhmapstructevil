...
class NextReviewMiMiResourceIT {
    ...
    void createNextReviewMiMi() throws Exception {
        ...
        NextReviewMiMiDTO nextReviewMiMiDTO = nextReviewMiMiMapper.toDto(nextReviewMiMi);
        var returnedNextReviewMiMiDTO = om.readValue(
            restNextReviewMiMiMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextReviewMiMiDTO)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            NextReviewMiMiDTO.class
        );

        // Validate the NextReviewMiMi in the database
        assertIncrementedRepositoryCount(databaseSizeBeforeCreate);
        var returnedNextReviewMiMi = nextReviewMiMiMapper.toEntity(returnedNextReviewMiMiDTO);
    ...
    void putExistingNextReviewMiMi() throws Exception {
        ...
        NextReviewMiMiDTO nextReviewMiMiDTO = nextReviewMiMiMapper.toDto(updatedNextReviewMiMi);

        restNextReviewMiMiMockMvc
            .perform(
                put(ENTITY_API_URL_ID, nextReviewMiMiDTO.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(nextReviewMiMiDTO))
            )
            .andExpect(status().isOk());
    ...
    void putWithMissingIdPathParamNextReviewMiMi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextReviewMiMiMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(nextReviewMiMiDTO)))
    ...
    void patchNonExistingNextReviewMiMi() throws Exception {
        ...
        restNextReviewMiMiMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, nextReviewMiMiDTO.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(nextReviewMiMiDTO))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamNextReviewMiMi() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNextReviewMiMiMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(nextReviewMiMiDTO)))
            .andExpect(status().isMethodNotAllowed());
