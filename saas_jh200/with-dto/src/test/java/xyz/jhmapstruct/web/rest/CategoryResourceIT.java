...
import static xyz.jhmapstruct.domain.CategoryAsserts.*;
...
import xyz.jhmapstruct.service.mapper.CategoryMapper;
...
class CategoryResourceIT {
    ...
    @Test
    @Transactional
    void getAllCategoriesByTenantIsEqualToSomething() throws Exception {
        MasterTenant tenant;
        ...
        // Get all the categoryList where tenant equals to tenantId
        defaultCategoryShouldBeFound("tenantId.equals=" + tenantId);

        // Get all the categoryList where tenant equals to (tenantId + 1)
        defaultCategoryShouldNotBeFound("tenantId.equals=" + (tenantId + 1));
    }
