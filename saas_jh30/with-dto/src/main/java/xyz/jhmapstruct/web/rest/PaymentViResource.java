...
public class PaymentViResource {
    ...
    public PaymentViResource(PaymentViService paymentViService, PaymentViRepository paymentViRepository) {
     ...
     */
    @GetMapping("")
    public List<PaymentViDTO> getAllPaymentVis() {
        LOG.debug("REST request to get all PaymentVis");
        return paymentViService.findAll();
    }
